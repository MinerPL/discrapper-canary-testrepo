...
let l = ''.concat(location.protocol, '//').concat(window.GLOBAL_ENV.CDN_HOST, '/role-icons'),
	...
	E = (e, t) => {
		...
		let s = a.$k ? 'webp' : 'png',
			d = '',
			_ = 'quality=lossless';
		return (null != t && ((d = 'size=' + (0, i.oO)(t * (0, i.x_)())), (_ = c ? '' : '&' + _)),
		null != window.GLOBAL_ENV.CDN_HOST)
			? ''.concat(l, '/').concat(n, '/').concat(r, '.').concat(s, '?').concat(d).concat(_)
			: ''.concat(u).concat(o.ANM.ROLE_ICON(n, r), '?').concat(d);
	},
	f = (e) => e.startsWith(l) || (e.startsWith(''.concat(u, '/roles')) && e.includes('/icons/')),
	h = (e, t) => {
		var n;
		return (
			(null == t ? void 0 : null === (n = t.tags) || void 0 === n ? void 0 : n.subscription_listing_id) != null ||
			e.features.has(o.oNc.ROLE_ICONS)
		);
	};
