...
function v(e, t, i) {
	(r = r || n(827664)),
		...
		(this.highWaterMark = _(this, e, 'writableHighWaterMark', i)),
		(this.finalCalled = !1),
		(this.needDrain = !1),
		(this.ending = !1),
		(this.ended = !1),
			...
			(function (e, t) {
				...
				if ((((n = u).writing = !1), (n.writecb = null), (n.length -= n.writelen), (n.writelen = 0), t)) {
					(r = e),
						...
						--i.pendingcb,
						s
							? (a.nextTick(l, o), a.nextTick(b, r, i), (r._writableState.errorEmitted = !0), A(r, o))
							: (l(o), (r._writableState.errorEmitted = !0), A(r, o), b(r, i));
				} else {
					var _ = D(u) || e.destroyed;
					!_ && !u.corked && !u.bufferProcessing && u.bufferedRequest && y(e, u),
						c ? a.nextTick(C, e, u, _, d) : C(e, u, _, d);
				}
			})(t, e);
		}),
		(this.writecb = null),
...
(O.prototype.write = function (e, t, n) {
	...
	if (
		...
		if (
			...
			null === E
				? (p = new T())
				: 'string' != typeof E && !_.objectMode && (p = new f('chunk', ['string', 'Buffer'], E)),
			!p || (A(d, p), a.nextTick(h, p), 0))
		)
			I.pendingcb++,
					...
					if (!n) {
						var s,
							...
							c =
								...
								(o = r),
								(l = i),
								!s.objectMode && !1 !== s.decodeStrings && 'string' == typeof o && (o = u.from(o, l)),
								o);
...
function R(e, t, n, r, i, a, s) {
	(t.writelen = r),
		...
		(t.writing = !0),
		(t.sync = !0),
		t.destroyed ? t.onwrite(new m('write')) : n ? e._writev(i, t.onwrite) : e._write(i, a, t.onwrite),
		(t.sync = !1);
}
function C(e, t, n, r) {
	!n &&
...
function b(e, t) {
	...
	if (i) {
		if (
			...
			(r = t).prefinished ||
				r.finalCalled ||
				('function' != typeof n._final || r.destroyed
					? ((r.prefinished = !0), n.emit('prefinish'))
					: (r.pendingcb++, (r.finalCalled = !0), a.nextTick(L, n, r))),
