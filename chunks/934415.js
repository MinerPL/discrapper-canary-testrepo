...
function D(e, t, n) {
	...
	h =
		e.type === A
			? null != a && (t.hasVideo(e.id) || (0, s.a)(d)) && u > 0 && c >= u
			: null != a && t.hasVideo(e.id) && l > 0 && c >= l + (E ? 1 : 0);
...
function L(e, t) {
	return t.isGuildStageVoice()
		...
		: null == e
			? I.eWB
			: Math.max(
					e.hasFeature(I.oNc.VIP_REGIONS) ? m.HO[I.Eu4.TIER_3].limits.bitrate : I.eWB,
					m.HO[e.premiumTier].limits.bitrate
				);
}
function b(e) {
