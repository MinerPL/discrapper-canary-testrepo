...
function y(e, t) {
	...
	return (
		...
		R(t) - R(n) ||
			((r = e), C(t) - C(r)) ||
			((i = e),
			(null !== (a = t.created_at) && void 0 !== a ? a : 0) - (null !== (s = i.created_at) && void 0 !== s ? s : 0))
	);
}
function D(e) {
	if ((delete S[e], delete A[e], delete N[e], null == g[e])) return;
	let [t] = c().sortBy(g[e], (e) => -e.timestamp);
	t.status !== m.Skl.OFFLINE
		? ((S[e] = t.status), (A[e] = t.activities), null != t.clientStatus && (N[e] = t.clientStatus))
		: c().every(g[e], (e) => e.status === m.Skl.OFFLINE) && delete g[e];
}
function L(e) {
	let t = g[e];
	if (null == t) return;
	...
	n.status !== m.Skl.OFFLINE &&
		((S[e] = n.status), (A[e] = n.activities), null != n.clientStatus && (N[e] = n.clientStatus));
}
function b(e) {
