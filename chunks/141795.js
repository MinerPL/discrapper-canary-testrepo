...
class O {
	constructor() {
		A(this, 'numChunks', void 0),
			A(this, 'totalRequestCount', void 0),
			A(this, 'timing', {}),
...
class R extends T.ZP {
	...
	async prepareChunkUploadItem() {
		...
		if (this.item.platform === T.ow.REACT_NATIVE) {
			let r = this.item;
			if (
				((e = null != r.mimeType && '' !== r.mimeType ? r.mimeType : 'application/octet-stream'),
				null == r.size || 0 === r.size || isNaN(r.size))
			)
				try {
					t = await (0, m.Fm)(r.uri);
				} catch (e) {
					N.warn(
						'Failed to peek content length for file id '.concat(this.id, ', reading whole file instead: ').concat(e)
					),
						(t = (n = await (0, m.Lc)(r.uri)).size);
				}
			else t = r.size;
	...
	async getChunk(e, t, n) {
		return this.item.platform !== T.ow.REACT_NATIVE
			...
			: null != n
				? n.slice(e, t)
				: await (0, m.U4)(this.item.uri, e, t);
	}
	async uploadChunk(e) {
		let t = {
		...
		for (let r = 1; r <= 3; r++) {
			var n;
			(this.uploadAnalytics.totalRequestCount =
				(null !== (n = this.uploadAnalytics.totalRequestCount) && void 0 !== n ? n : 0) + 1),
				N.log(
					'Attempt '
	...
	async upload() {
		...
		if (null == r.filename || '' === r.filename || 0 === this.currentSize) {
			N.error('File does not have a filename or size is 0.', JSON.stringify(r)),
		...
		try {
			...
			let e =
				null !== (n = null == r ? void 0 : null === (t = r.body) || void 0 === t ? void 0 : t.code) && void 0 !== n
					? n
					: r.status;
		...
		try {
			...
			(e =
				t.enabled && t.chunkSize > 0
					? await this.trackTime('uploadTimeMs', async () => await this.uploadFileToCloudAsChunks(t.chunkSize))
			...
			'CANCELED' === this.status
				? this.handleComplete(e)
				: (N.info('Error: status '.concat(e.status, ' for ').concat(this.id)), this.handleError(e));
		}
	}
	async reactNativeCompressAndExtractData() {
		...
		if (!0 === this.reactNativeFilePrepped)
			return (
				...
				N.log('reactNativeCompressAndExtractData() file already prepped - '.concat(this.id)),
				this
			);
		...
		if (
			((0, T.rG)(t.file) &&
				((this.uploadAnalytics.imageCompressionQuality = t.file.imageCompressionQuality),
				(this.uploadAnalytics.videoCompressionQuality = t.file.videoCompressionQuality),
				(this.uploadAnalytics.convertedMimeType = t.file.type),
				void 0 !== t.file.videoMetadata &&
					((this.uploadAnalytics.sourceMediaWidth = t.file.videoMetadata.width),
					(this.uploadAnalytics.sourceMediaHeight = t.file.videoMetadata.height),
					(this.uploadAnalytics.sourceMediaFormat = t.file.videoMetadata.format),
					(this.uploadAnalytics.sourceVideoBitrate = t.file.videoMetadata.bitrate))),
			(this.filename = r),
	...
	trackUploadFinished(e) {
		...
		f.default.track(S.rMx.ATTACHMENT_UPLOAD_FINISHED, {
			...
			video_compression_quality:
				null !== (a = this.uploadAnalytics.videoCompressionQuality) && void 0 !== a ? a : 'unknown',
	...
	constructor(e, t, n, r) {
		var i, a, s, o;
		super(e, n),
			A(this, 'RESUME_INCOMPLETE_CODES', [308]),
			...
			A(this, 'uploadAnalytics', new O()),
			A(this, '_abortController', void 0),
			A(this, '_xhr', void 0),
			A(this, '_aborted', !1),
			(this.channelId = t),
			(this.preCompressionSize =
				null !== (s = null === (i = e.file) || void 0 === i ? void 0 : i.size) && void 0 !== s ? s : 0),
			(this.currentSize =
				null !== (o = null === (a = e.file) || void 0 === a ? void 0 : a.size) && void 0 !== o ? o : 0),
