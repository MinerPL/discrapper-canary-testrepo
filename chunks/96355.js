	...
	(function (e) {
		...
		function i(e) {
			...
			if (
				('m' === n &&
					r.length > 2 &&
					(e.result.push([t, r[0], r[1]]), (r = r.slice(2)), (n = 'l'), (t = 'm' === t ? 'l' : 'L')),
				'r' === n)
			)
		...
		function u(e, t, n, r, i, a, s, o) {
			(this.a = {
				...
				null != s && null != o
					? ((this.getArcLength = I), (this.getPoint = f), (this.getDerivative = d))
					: ((this.getArcLength = h), (this.getPoint = E), (this.getDerivative = c)),
				this.init();
		}
		function c(e, t, n) {
			return {
		...
		function h(e, t, n) {
			...
			return (
				...
				(u * Math.sqrt(u * u + c) -
					l * Math.sqrt(l * l + c) +
					c * Math.log(Math.abs((u + Math.sqrt(u * u + c)) / (l + Math.sqrt(l * l + c)))))
			);
		}
		function p(e, t, n) {
			var r,
								...
								if (
									(t = (function (e, t) {
										...
										for (r = n.next; r !== u; )
											i >= r.x &&
												r.x >= c &&
												k(a < d ? i : s, a, c, d, a < d ? s : i, a, r.x, r.y) &&
												((l = Math.abs(a - r.y) / (i - r.x)) < _ || (l === _ && r.x > n.x)) &&
												H(r, e) &&
												((n = r), (_ = l)),
												(r = r.next);
										return n;
					...
					if (
						...
						a
							? (function (e, t, n, r) {
									...
									for (
										var s = i.x < e.x ? (i.x < a.x ? i.x : a.x) : e.x < a.x ? e.x : a.x,
										...
										if (
											_ !== e.prev &&
											_ !== e.next &&
											k(i.x, i.y, e.x, e.y, a.x, a.y, _.x, _.y) &&
											B(_.prev, _, _.next) >= 0
										)
											return !1;
										_ = _.nextZ;
										...
										(e = (function (e, t, n) {
											...
											do {
												...
												!F(i, a) &&
													...
													H(i, a) &&
													H(a, i) &&
													(t.push(i.i / n), t.push(r.i / n), t.push(a.i / n), j(r), j(r.next), (r = e = a)),
													(r = r.next);
											} while (r !== e);
											return r;
										})(e, t, n)),
		...
		function V(e, t, n, r) {
			return (
				...
				(B(e, t, n) > 0 != B(e, t, r) > 0 && B(n, r, e) > 0 != B(n, r, t) > 0)
			);
		}
		function H(e, t) {
			return 0 > B(e.prev, e, e.next)
				? B(e, t, e.next) >= 0 && B(e, e.prev, t) >= 0
				: 0 > B(e, t, e.prev) || 0 > B(e, e.next, t);
		}
		function Z(e, t) {
				...
				(function (e, t, n) {
					return function (r) {
						...
						return r.map(function (i, l) {
							...
							return (
								l && (o += S(i, r[l - 1])),
								[Math.cos((u = s + 2 * Math.PI * (a ? o / a : l / r.length))) * n + e, Math.sin(u) * n + t]
							);
						});
					};
				})(e, t, n),
							...
							for (o = s; o > 0; o--) {
								if (
									((function (e) {
										...
										if (
											((43 !== (n = e.path.charCodeAt(i)) && 45 !== n) || (n = ++i < a ? e.path.charCodeAt(i) : 0),
											!t(n) && 46 !== n)
										)
										...
										if (101 === n || 69 === n) {
											if (
												(u && !o && !l) ||
												((43 !== (n = ++i < a ? e.path.charCodeAt(i) : 0) && 45 !== n) || i++,
												!(i < a && t(e.path.charCodeAt(i))))
											)
								...
								e.data.push(e.param),
									r(e),
									(a = !1),
									e.index < l && 44 === e.path.charCodeAt(e.index) && (e.index++, r(e), (a = !0));
							}
							if (!a) {
					...
					a.err.length
						...
						: a.result.length &&
							(0 > 'mM'.indexOf(a.result[0][0])
								? ((a.err = 'SvgPath: string should start with `M` or `m`'), (a.result = []))
								: (a.result[0][0] = 'M')),
					{
						err: a.err,
						segments: a.result
			...
			(a.prototype.calc = function (e, t, n) {
				...
				return this.queue.length
					? (this.cache || (this.cache = this.toArray()),
						[e * (r = this.cache)[0] + t * r[2] + (n ? 0 : r[4]), e * r[1] + t * r[3] + (n ? 0 : r[5])])
					: [e, t];
			});
		var eo = {
				matrix: !0,
			...
			e_ = function (e, t, n, r, i, a, o, l, u) {
				...
				var k =
						...
						(N = I * I),
						(v = g * g),
						(R = A * N - A * (O = S * S) - N * v) < 0 && (R = 0),
						(R /= A * O + N * v),
						(C = (((R = Math.sqrt(R) * (f === h ? -1 : 1)) * p) / I) * S),
						(y = (-(R * I) / p) * g),
						(b = s(1, 0, (D = (g - C) / p), (L = (S - y) / I))),
						(M = s(D, L, (-g - C) / p, (-S - y) / I)),
						0 === h && M > 0 && (M -= ed),
						1 === h && M < 0 && (M += ed),
						[T * C - m * y + (c + _) / 2, m * C + T * y + (d + E) / 2, b, M]),
					B = [],
					F = k[2],
					V = k[3],
		...
		(o.prototype.transform = function (e) {
			...
			return (
				(this.ax =
					1e-10 > Math.abs(l) && 1e-10 > Math.abs(u - a)
						? 90
						: (180 * Math.atan(Math.abs(l) > Math.abs(u - a) ? (u - i) / l : l / (u - a))) / Math.PI),
				this.ax >= 0
					? ((this.rx = Math.sqrt(u)), (this.ry = Math.sqrt(c)))
					: ((this.ax += 90), (this.rx = Math.sqrt(c)), (this.ry = Math.sqrt(u))),
				this
			);
		}),
		...
		(l.prototype.__matrix = function (e) {
				...
				this.iterate(function (r, i, a, s) {
					...
					switch (r[0]) {
						...
						case 'A':
							...
							if (
								(_[0] * _[3] - _[1] * _[2] < 0 && (r[5] = r[5] ? '0' : '1'),
								(l = e.calc(r[6], r[7], 'a' === r[0])),
								('A' === r[0] && r[6] === a && r[7] === s) || ('a' === r[0] && 0 === r[6] && 0 === r[7]))
							) {
								u = ['a' === r[0] ? 'l' : 'L', l[0], l[1]];
								break;
							}
							u = E.isDegenerate()
								? ['a' === r[0] ? 'l' : 'L', l[0], l[1]]
								: [r[0], E.rx, E.ry, E.ax, r[4], r[5], l[0], l[1]];
							break;
						case 'm':
			...
			(l.prototype.toString = function () {
				...
				for (var r = 0; r < this.segments.length; r++)
					(t = this.segments[r][0]),
						(e = r > 0 && 'm' !== t && 'M' !== t && t === this.segments[r - 1][0]),
						(n = n.concat(e ? this.segments[r].slice(1) : this.segments[r]));
				return n
					.join(' ')
				...
				return (
					e.replace(ep, function (e, n, r) {
						var i,
							a = n.toLowerCase();
						for (
							r = (i = r.match(em)) ? i.map(Number) : [],
								'm' === a &&
									r.length > 2 &&
									(t.push([n].concat(r.splice(0, 2))), (a = 'l'), (n = 'm' === n ? 'l' : 'L'));
							r.length >= 0;
		...
		var eg = [
			...
			ev = function (e, t, n, r, i, a, s, o, l) {
				...
				var k =
						...
						(R = A * N - A * (O = S * S) - N * v) < 0 && (R = 0),
						(R /= A * O + N * v),
						(C = (((R = Math.sqrt(R) * (E === f ? -1 : 1)) * h) / p) * S),
						(y = (-(R * p) / h) * g),
						(b = m(1, 0, (D = (g - C) / h), (L = (S - y) / p))),
						(M = m(D, L, (-g - C) / h, (-S - y) / p)),
						0 === f && M > 0 && (M -= eN),
						1 === f && M < 0 && (M += eN),
						[T * C - I * y + (u + d) / 2, I * C + T * y + (c + _) / 2, b, M]),
					B = [],
					F = k[2],
					V = k[3],
		...
		var eC = function (e) {
				function t(e) {
					if (!e) return null;
					for (var a, s = eI(e), o = [0, 0], l = [0, 0], u = 0; u < s.length; u++)
						'M' === s[u][0]
							? ((o = [s[u][1], s[u][2]]), i.push(null))
							: 'm' === s[u][0]
								? ((o = [s[u][1] + o[0], s[u][2] + o[1]]), i.push(null))
								: 'L' === s[u][0]
									? ((n += Math.sqrt(Math.pow(o[0] - s[u][1], 2) + Math.pow(o[1] - s[u][2], 2))),
										i.push(new eR(o[0], s[u][1], o[1], s[u][2])),
										(o = [s[u][1], s[u][2]]))
									: 'l' === s[u][0]
										? ((n += Math.sqrt(Math.pow(s[u][1], 2) + Math.pow(s[u][2], 2))),
											i.push(new eR(o[0], s[u][1] + o[0], o[1], s[u][2] + o[1])),
											(o = [s[u][1] + o[0], s[u][2] + o[1]]))
										: 'H' === s[u][0]
											? ((n += Math.abs(o[0] - s[u][1])), i.push(new eR(o[0], s[u][1], o[1], o[1])), (o[0] = s[u][1]))
											: 'h' === s[u][0]
												? ((n += Math.abs(s[u][1])),
													i.push(new eR(o[0], o[0] + s[u][1], o[1], o[1])),
													(o[0] = s[u][1] + o[0]))
												: 'V' === s[u][0]
													? ((n += Math.abs(o[1] - s[u][1])),
														i.push(new eR(o[0], o[0], o[1], s[u][1])),
														(o[1] = s[u][1]))
													: 'v' === s[u][0]
														? ((n += Math.abs(s[u][1])),
															i.push(new eR(o[0], o[0], o[1], o[1] + s[u][1])),
															(o[1] = s[u][1] + o[1]))
														: 'z' === s[u][0] || 'Z' === s[u][0]
															? ((n += Math.sqrt(Math.pow(s[0][1] - o[0], 2) + Math.pow(s[0][2] - o[1], 2))),
																i.push(new eR(o[0], s[0][1], o[1], s[0][2])),
																(o = [s[0][1], s[0][2]]))
															: 'C' === s[u][0]
																? ((a = new eT(o[0], o[1], s[u][1], s[u][2], s[u][3], s[u][4], s[u][5], s[u][6])),
																	(n += a.getTotalLength()),
																	(o = [s[u][5], s[u][6]]),
																	i.push(a))
																: 'c' === s[u][0]
																		...
																		? ((a =
																				u > 0 && ['C', 'c', 'S', 's'].indexOf(s[u - 1][0]) > -1
																					? new eT(
																							o[0],
																							o[1],
																							2 * o[0] - s[u - 1][s[u - 1].length - 4],
																							2 * o[1] - s[u - 1][s[u - 1].length - 3],
																							s[u][1],
																							s[u][2],
																							s[u][3],
																							s[u][4]
																						)
																					: new eT(o[0], o[1], o[0], o[1], s[u][1], s[u][2], s[u][3], s[u][4])),
																			(n += a.getTotalLength()),
																			(o = [s[u][3], s[u][4]]),
																			i.push(a))
																		: 's' === s[u][0]
																			? ((a =
																				...
																				(n += a.getTotalLength()),
																				(o = [s[u][3] + o[0], s[u][4] + o[1]]),
																				i.push(a))
																			: 'Q' === s[u][0]
																				? ((a = new eT(o[0], o[1], s[u][1], s[u][2], s[u][3], s[u][4])),
																					(n += a.getTotalLength()),
																					i.push(a),
																					(o = [s[u][3], s[u][4]]),
																					(l = [s[u][1], s[u][2]]))
																					...
																					: 'T' === s[u][0]
																						? ((a =
																								u > 0 && ['Q', 'q', 'T', 't'].indexOf(s[u - 1][0]) > -1
																									...
																									: new eR(o[0], s[u][1], o[1], s[u][2])),
																							i.push(a),
																							(n += a.getTotalLength()),
																							(l = [2 * o[0] - l[0], 2 * o[1] - l[1]]),
																							(o = [s[u][1], s[u][2]]))
																						: 't' === s[u][0]
																							? ((a =
																									u > 0 && ['Q', 'q', 'T', 't'].indexOf(s[u - 1][0]) > -1
																										...
																										: new eR(o[0], o[0] + s[u][1], o[1], o[1] + s[u][2])),
																								(n += a.getTotalLength()),
																								(l = [2 * o[0] - l[0], 2 * o[1] - l[1]]),
																								(o = [s[u][1] + o[0], s[u][2] + o[0]]),
																								i.push(a))
																							: 'A' === s[u][0]
																								? ((a = new eO(
																										o[0],
					...
					for (var o = r[s], l = o.length, u = 0; u < l; ++u)
						for (var c = u + 1; c < l; ++c) {
							var d,
								_ = o[u],
								E = o[c];
							(d = i[_])[(s = eG(d, E))] !== E && d.splice(s, 0, E),
								(d = i[E])[(s = eG(d, _))] !== _ && d.splice(s, 0, _);
						}
				return i;
			},
			eB = function (e, t) {
					...
					return (function (e, t) {
						for (
							...
							!(function () {
								...
								(s.area = t.area + a.area),
									(s.type = 'Polygon'),
									(s.arcs = s.arcs[0]),
									n.splice(i, 1),
									n.shift(),
									n.splice(r(n, s.area), 0, s);
							})();
				...
				return (
					...
					(function e(t, n, r) {
						...
						for (var o = 0; o < t.length; o++) {
							var l = t.splice(o, 1),
								u = i[l[0]][n.length];
							r + u < a && (t.length ? e(t.slice(), n.concat(l), r + u) : ((a = r + u), (s = n.concat(l)))),
								t.length && t.splice(o, 0, l[0]);
						}
					})(
