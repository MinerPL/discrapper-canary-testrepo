	...
	__OVERLAY__
		...
		: {
				...
				RPC_SERVER_READY: function (e) {
					...
					n.append('build_id', '581a03129d4f57367d289f61f9c01200a3830780'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), (r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString()));
				},
