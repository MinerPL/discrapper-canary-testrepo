...
n.append('build_id', 'b22dee189a38f986b6fd34ca034ec2ba8c819cad'), n.append('rpc', String(t)), n.append('rpc_auth_token', K), r = ''.concat(location.protocol, '//').concat(location.host, '/overlay?').concat(n.toString());
  },
