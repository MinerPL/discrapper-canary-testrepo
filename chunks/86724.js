				...
				let e =
					null != _
						? {
								...
								icon: _.icon,
								name:
									null !== (i = null === (r = _.bot) || void 0 === r ? void 0 : r.username) && void 0 !== i
										? i
										: _.name,
								application: _
							}
						...
						return (function (e) {
							...
							if (
								(!d &&
									(null == v
										? void 0
										: null === (t = v.integration_types) || void 0 === t
											? void 0
											: t.includes(r.Y.GUILD_INSTALL))) ||
								(E &&
									(null == v ? void 0 : v.inputType) !== u.iw.BUILT_IN_TEXT &&
									(null == v ? void 0 : v.inputType) !== u.iw.BUILT_IN_INTEGRATION)
							)
							...
							if (null != I) {
								...
								if (
									null == A ||
									!A.startsWith(e) ||
									(0 === p.cu(s).length && (A.length < e.length + 1 || ' ' !== A[e.length]))
								)
								...
								if (null != v && f) {
									let e = (function (e, t, n) {
											...
											let d =
													(null !== (a = null === (r = c.options) || void 0 === r ? void 0 : r.length) && void 0 !== a
														? a
														: 0) > 0
														? p.zb(e, c)
														: null,
											...
											f.startsWith(h) && f.length > h.length
												? (E = _.substring(h.length).trim())
												: f.startsWith(I) && f.length > I.length && (E = _.substring(I.length).trim());
											let A = [],
												v = null,
												R = null;
											if (null != c.options) {
												...
												for (let r of c.options)
													if (!e.has(r.name) && (r.required || null != u[r.name])) {
														let e, i;
														E.length > 0 && !O.has(r.type)
															? ((e = E), (E = ''))
															: (e = null != (i = P(n, t, r.name)) ? i : '');
														let a = {
															type: 'applicationCommandOption',
															optionName: r.name,
															optionDisplayName: r.displayName,
											...
											(l =
												E.length > 0
													? ''.concat(N.GI).concat(c.displayName, ' ').concat(E.replace(/\r|\n/g, ' '))
													: 0 === A.length
														? ''.concat(N.GI).concat(c.displayName, ' ')
														: ''.concat(N.GI).concat(c.displayName)),
												A.unshift({ text: l });
											let C = {
											...
											return (
												null != v
													? (T.Q.selectCommandOption(e, v.optionName), (y = v.optionName))
													: null != R
														? (T.Q.selectCommandOption(e, R.optionName, !1), (y = R.optionName))
														: T.Q.resetSelectionToEnd(e),
												null == R && D(e, c),
												y
											);
										})(s, c, l),
								...
								if (R.has(e.type) && g.LC.isText(t)) {
									let e = (function (e, t) {
										...
										let s = n.text.trim(),
											l = s + ' ',
											c = r.filter(
												(e) => e.inputType !== u.iw.PLACEHOLDER && (e.displayName === s || e.displayName.startsWith(l))
											);
							...
							commandChanged:
								(null === (l = s.activeCommand) || void 0 === l ? void 0 : l.id) !== (null == k ? void 0 : k.id),
	...
	for (let e of r.options) {
		...
		let r = f[e.name],
			a =
				u ||
				(e.name === _ && _ !== i) ||
				((null == r ? void 0 : null === (p = r.lastValidationResult) || void 0 === p ? void 0 : p.success) === !1 &&
		...
		(null == r ||
			...
			(a && (null === (I = r.lastValidationResult) || void 0 === I ? void 0 : I.success) === !1)) &&
			((E[e.name] = l), (h = !0));
	}
	h && a.g7(n, E);
}
...
function P(e, t, n) {
	var r, a, s, o;
	let l =
			null === (a = e.activeCommand) || void 0 === a
				? void 0
	...
	return l.type === i.jw.CHANNEL || (l.type === i.jw.MENTIONABLE && null != E.Z.getChannel(c))
		? '<#'.concat(c, '>\t')
		: l.type === i.jw.USER || (l.type === i.jw.MENTIONABLE && null != h.default.getUser(c))
			? '<@'.concat(c, '>')
			: l.type === i.jw.ROLE || (l.type === i.jw.MENTIONABLE && null != f.Z.getRole(t.guild_id, null != c ? c : A.lds))
				? '<@&'.concat(c, '>')
				: c;
}
