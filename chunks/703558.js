...
((a = r || (r = {}))[(a.ChannelMessage = 0)] = 'ChannelMessage'),
	(a[(a.ThreadSettings = 1)] = 'ThreadSettings'),
	(a[(a.FirstThreadMessage = 2)] = 'FirstThreadMessage'),
	(a[(a.ApplicationLauncherCommand = 3)] = 'ApplicationLauncherCommand'),
	(a[(a.Poll = 4)] = 'Poll'),
	(a[(a.SlashCommand = 5)] = 'SlashCommand');
let I = {};
function m(e) {
	let t = I[e];
...
function T(e) {
	...
	if (null != s && null != r && '' !== r) {
		...
		if (
			(null == t && (t = e[n] = {}),
			(l = r).length > p && (l = l.substr(0, p)),
			(r = l) === (null === (o = t[i]) || void 0 === o ? void 0 : o.draft))
		)
			return !1;
		t[i] = {
			timestamp: Date.now(),
