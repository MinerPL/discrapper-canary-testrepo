...
(l.prototype._update = function (e) {
	...
	for (var Z = 0; Z < 160; Z += 2) {
		...
		var eu = ((X = m), ($ = T), (J = g) ^ (X & ($ ^ J))),
			ec = (S + ea) | 0,
			ed = (c + ei + E(ec, S)) | 0;
		(ed = (ed + el + E((ec = (ec + eu) | 0), eu)) | 0),
			(ed = (ed + es + E((ec = (ec + eo) | 0), eo)) | 0),
			(ed = (ed + H + E((ec = (ec + V) | 0), V)) | 0);
		var e_ = (er + et) | 0,
			eE = (en + ee + E(e_, er)) | 0;
		(c = u),
			(S = g),
	...
	(this._al = (this._al + f) | 0),
		...
		(this._ah = (this._ah + n + E(this._al, f)) | 0),
		(this._bh = (this._bh + r + E(this._bl, h)) | 0),
		(this._ch = (this._ch + i + E(this._cl, p)) | 0),
		(this._dh = (this._dh + a + E(this._dl, I)) | 0),
		(this._eh = (this._eh + o + E(this._el, m)) | 0),
		(this._fh = (this._fh + l + E(this._fl, T)) | 0),
		(this._gh = (this._gh + u + E(this._gl, g)) | 0),
		(this._hh = (this._hh + c + E(this._hl, S)) | 0);
}),
