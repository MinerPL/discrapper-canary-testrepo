...
var r,
	...
	l = n(495852),
	u = n(835913);
((i = r || (r = {}))[(i.UNSPECIFIED_DISCLOSURE = 0)] = 'UNSPECIFIED_DISCLOSURE'),
...
class c extends l.C {
	...
	internalBinaryWrite(e, t, n) {
		for (let n of Object.keys(e.metadata))
			t.tag(1, a.TD.LengthDelimited)
				.fork()
				.tag(1, a.TD.LengthDelimited)
				.string(n)
				.tag(2, a.TD.LengthDelimited)
				.string(e.metadata[n])
				.join();
		'' !== e.platformName && t.tag(2, a.TD.LengthDelimited).string(e.platformName),
			'' !== e.platformUsername && t.tag(3, a.TD.LengthDelimited).string(e.platformUsername),
			'0' !== e.version && t.tag(4, a.TD.Bit64).fixed64(e.version);
...
class d extends l.C {
	...
	internalBinaryWrite(e, t, n) {
		0 !== e.disclosureType && t.tag(1, a.TD.Varint).int32(e.disclosureType),
			e.ackedAt && u.E.internalBinaryWrite(e.ackedAt, t.tag(2, a.TD.LengthDelimited).fork(), n).join();
		let r = n.writeUnknownFields;
		return !1 !== r && (!0 == r ? a.z.onWrite : r)(this.typeName, e, t), t;
	}
	constructor() {
