	...
	if (
			...
			case C.Xh.PREMIUM_MONTH_TIER_1:
				(r = R.Z.Messages.BILLING_SWITCH_PLAN_CONFIRM_TIER_1),
					E.X7u.has(null != I ? I : E.HeQ.UNKNOWN) &&
						(r = R.Z.Messages.BILLING_SWITCH_PLAN_DELAYED_CONFIRMATION_TIER_1.format());
				break;
			case C.Xh.PREMIUM_MONTH_TIER_2:
				(r = R.Z.Messages.BILLING_SWITCH_PLAN_CONFIRM_UPGRADE_TIER_2_MONTH),
					E.X7u.has(null != I ? I : E.HeQ.UNKNOWN) &&
						(r = R.Z.Messages.BILLING_SWITCH_PLAN_DELAYED_CONFIRMATION_TIER_2.format());
				break;
			case C.Xh.PREMIUM_YEAR_TIER_1:
				(r = R.Z.Messages.BILLING_SWITCH_PLAN_CONFIRM_UPGRADE_TIER_1_YEAR),
					E.X7u.has(null != I ? I : E.HeQ.UNKNOWN) &&
						(r = R.Z.Messages.BILLING_SWITCH_PLAN_DELAYED_CONFIRMATION_UPGRADE_TIER_1_YEAR.format());
				break;
			case C.Xh.PREMIUM_YEAR_TIER_2:
				(r = R.Z.Messages.BILLING_SWITCH_PLAN_CONFIRM_UPGRADE_TIER_2_YEAR.format({ numFreeGuildSubscriptions: C.cb })),
					E.X7u.has(null != I ? I : E.HeQ.UNKNOWN) &&
						(r = R.Z.Messages.BILLING_SWITCH_PLAN_DELAYED_CONFIRMATION_UPGRADE_TIER_2_YEAR.format({
		...
		switch (c.skuId) {
			...
			case C.Si.TIER_2:
				r =
					1 !== l.intervalCount
						? R.Z.Messages.BILLING_SWITCH_PLAN_CONFIRM_TIER_2_GENERIC_TO_MONTH
						: R.Z.Messages.BILLING_SWITCH_PLAN_CONFIRM_TIER_2_YEAR_TO_MONTH;
				break;
			default:
...
function L(e) {
	...
	return (
		...
		(a =
			null != P
				? R.Z.Messages.PREMIUM_PAYMENT_CONFIRMATION_BUTTON_IAP.format({ skuName: P.name })
				: m
