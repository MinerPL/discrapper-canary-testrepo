	...
	getPacketStats() {
		let e = i().reduce(
			...
			(e, t) => (
				...
				null != e.fecPacketsReceived && (e.fecPacketsReceived += t.fecPacketsReceived),
				null != e.fecPacketsDiscarded && (e.fecPacketsDiscarded += t.fecPacketsDiscarded),
				e
			),
			{
				packetsReceived: 0,
	...
	getFrameOpStats() {
		let e = i().reduce(
			...
			(e, t) => (
				...
				null != t.frameOpStats.preemptiveExpanded && (e.preemptiveExpanded += t.frameOpStats.preemptiveExpanded),
	...
	getE2EEStats() {
		let e = i().reduce(
			...
			(e, t) => {
				var n, r, i, a, s;
				return (
					(e.passthroughCount += null !== (n = t.passthroughCount) && void 0 !== n ? n : 0),
					(e.decryptSuccessCount += null !== (r = t.decryptSuccessCount) && void 0 !== r ? r : 0),
					(e.decryptFailureCount += null !== (i = t.decryptFailureCount) && void 0 !== i ? i : 0),
					(e.decryptDuration += null !== (a = t.decryptDuration) && void 0 !== a ? a : 0),
					(e.decryptAttempts += null !== (s = t.decryptAttempts) && void 0 !== s ? s : 0),
					e
				);
			},
			{
			...
			if (void 0 !== g && T > g) {
				...
				let A = T - g,
					N = {
						...
						expanded:
							null !== (l = m.expanded) && void 0 !== l ? l : 0 - (null !== (o = I.expanded) && void 0 !== o ? o : 0),
						accelerated:
							null !== (c = m.accelerated) && void 0 !== c
								? c
								: 0 - (null !== (u = I.accelerated) && void 0 !== u ? u : 0),
						preemptiveExpanded:
							null !== (_ = m.preemptiveExpanded) && void 0 !== _
								? _
								: 0 - (null !== (d = I.preemptiveExpanded) && void 0 !== d ? d : 0),
		...
		u(this, 'connection', void 0),
			...
			(this.sampleStats = (e) => {
				...
				this.outboundStats.packetsSent > t && ((r = !0), this.duration.speaking++),
					i().reduce(this.inboundStats, (e, t) => ((e.packetsReceived += t.packetsReceived), e), { packetsReceived: 0 })
