...
t.Z = (e) => {
	let { className: t, channelId: n } = e,
		a = (0, m.Go)(),
		{ enableDecoupledGameClipping: g } = d.Z.useExperiment(
	...
	return (0, l.e7)([h.Z, c.Z, p.Z, u.ZP], () => {
		...
		return (
			(null != t && !!p.Z.getSettings().clipsEnabled && !!a) ||
			(null != i && !!p.Z.getSettings().decoupledClipsEnabled && !!g) ||
			c.Z.getParticipants(n).some((e) => e.type === _.fO.USER && p.Z.isClipsEnabledForUser(e.user.id))
		);
	})
