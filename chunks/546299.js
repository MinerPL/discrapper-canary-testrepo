			...
			for (var r = 0, i = 0; i < e.length; i++) {
				...
				if (o < 128) n[r++] = o;
					...
					if (
						((a = e),
						(s = i),
						(64512 & a.charCodeAt(s)) != 55296 || s < 0 || s + 1 >= a.length
							? 1
							: (64512 & a.charCodeAt(s + 1)) != 56320)
					)
...
t.split32 = function (e, t) {
	for (var n = Array(4 * e.length), r = 0, i = 0; r < e.length; r++, i += 4) {
		var a = e[r];
		'big' === t
			? ((n[i] = a >>> 24), (n[i + 1] = (a >>> 16) & 255), (n[i + 2] = (a >>> 8) & 255), (n[i + 3] = 255 & a))
			: ((n[i + 3] = a >>> 24), (n[i + 2] = (a >>> 16) & 255), (n[i + 1] = (a >>> 8) & 255), (n[i] = 255 & a));
	}
	return n;
};
