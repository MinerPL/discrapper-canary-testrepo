...
t.Z = {
	async handleVoiceConnect(e) {
		...
		t.isThread() &&
			(await u.Z.unarchiveThreadIfNecessary(t.id), !l.Z.hasJoined(t.id) && (await u.Z.joinThread(t, 'Join Voice')));
		let S = s.Z.getRemoteSessionId(),
			A = _.Z.getVoiceStateForSession(c.default.getId(), S),
			N =
				(null == A ? void 0 : A.channelId) === t.id ||
				d.Z.getChannelId() === _.Z.getCurrentClientVoiceChannelId(t.guild_id);
		return !T && !I && (0, E._)(t)
			? new Promise((e) => {
