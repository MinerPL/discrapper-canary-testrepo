			...
			if (n.current && !e.isDisabled && t.values.every((e, n) => !t.isThumbDragging(n))) {
				...
				(e =
					0 === E
						...
						: -1 === E
							? t.values.length - 1
							: Math.abs(t.values[E - 1] - _) < Math.abs(t.values[E] - _)
								? E - 1
								: E) >= 0 && t.isThumbEditable(e)
					? (r.preventDefault(),
						(m.current = e),
						t.setFocusedThumb(e),
						(A.current = i),
						t.setThumbDragging(m.current, !0),
						t.setThumbValue(e, _),
						p(window, 'mouseup', v, !1),
						p(window, 'touchend', v, !1),
						p(window, 'pointerup', v, !1))
					: (m.current = null);
			}
		},
		v = (e) => {
			...
			(null !== (r = e.pointerId) && void 0 !== r
				...
				: null === (n = e.changedTouches) || void 0 === n
					? void 0
					: n[0].identifier) === A.current &&
				(null != m.current && (t.setThumbDragging(m.current, !1), (m.current = null)),
				I(window, 'mouseup', v, !1),
				I(window, 'touchend', v, !1),
				I(window, 'pointerup', v, !1));
		};
	return (
		'htmlFor' in _ &&
			_.htmlFor &&
			...
			trackProps: (0, r.dG)(
				{
					...
					onPointerDown(e) {
						('mouse' !== e.pointerType || (0 === e.button && !e.altKey && !e.ctrlKey && !e.metaKey)) &&
							N(e, e.pointerId, e.clientX, e.clientY);
					},
					onTouchStart(e) {
...
function E(e, t) {
	...
	let { focusableProps: w } = (0, u.kc)(
		...
		G = (e) => {
			D(),
				(x.current = e),
				t.setThumbDragging(_, !0),
				N(window, 'mouseup', k, !1),
				N(window, 'touchend', k, !1),
				N(window, 'pointerup', k, !1);
		},
		k = (e) => {
			var n, r;
			(null !== (r = e.pointerId) && void 0 !== r
				...
				: null === (n = e.changedTouches) || void 0 === n
					? void 0
					: n[0].identifier) === x.current &&
				(D(),
				t.setThumbDragging(_, !1),
				v(window, 'mouseup', k, !1),
				v(window, 'touchend', k, !1),
				v(window, 'pointerup', k, !1));
		},
