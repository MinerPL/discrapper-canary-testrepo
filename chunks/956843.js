...
t.Z = class e {
	...
	render(e, t) {
		e.beginPath(),
			...
			e.arc(this.x, this.y, this.size, 0, i.uo, !0),
			(e.fillStyle = this.color),
			e.fill(),
			(e.globalAlpha = 1);
	}
	constructor() {
		a(this, 'size', (0, r.M)(2, 3)),
			a(this, 'depth', (0, r.M)(1, 4)),
			a(this, 'positionMultiplier', this.depth / 4),
			a(this, 'color', s[4 - this.depth]),
			a(this, 'offscreenX', i.pg + this.size),
			a(this, 'offscreenY', i.pg + this.size),
			a(this, 'x', (0, r.M)(-this.size, this.offscreenX)),
			a(this, 'y', (0, r.M)(-this.size, this.offscreenY));
	}
};
