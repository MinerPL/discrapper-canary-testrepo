...
function s(e) {
	...
	(null == t ? void 0 : t.name) !== r && '' !== r.trim() && (d.name = r),
		(null !== (n = null == t ? void 0 : t.description) && void 0 !== n ? n : '') !== o && (d.description = o),
		(null == t ? void 0 : t.price_tier) !== i && null != i && (d.priceTier = i),
		null != s && '' !== s.name.trim() ? (d.createNewRole = !0) : null === s && (d.unlinkRole = !0),
		l.startsWith('data:') &&
