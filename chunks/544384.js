...
function S(e) {
	var t;
	let { channel: n, currentUser: a, activeStreams: l, hideSelfOptions: _ = !1, showReportOption: f = !1, handleGoLive: h, onClose: S, onSelect: A, appContext: N = m.IlC.APP } = e,
		v = E.Z.supports(I.AN.DESKTOP_CAPTURE_APPLICATIONS),
