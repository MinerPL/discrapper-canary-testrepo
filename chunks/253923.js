	...
	return {
		...
		[I.Pl.USE_EXTERNAL_APPS.toString()]: {
			...
			description: S.externalAppsEnabled
				...
				: ''
						.concat(E.ROLE_PERMISSIONS_USE_EXTERNAL_APPS_GUILD_DESCRIPTION, ' ')
						.concat(E.ROLE_PERMISSIONS_USE_EXTERNAL_APPS_GUILD_DESCRIPTION_NOT_ENABLED_YET),
		...
		[I.Pl.PRIORITY_SPEAKER.toString()]: {
			...
			description:
				(null == S ? void 0 : S.PRIORITY_SPEAKER_DESCRIPTION) || E.ROLE_PERMISSIONS_PRIORITY_SPEAKER_DESCRIPTION,
	...
	return {
		...
		permissions: R(
			(null == _ ? void 0 : _.showManageWebhooks)
				? [I.Pl.VIEW_CHANNEL, I.Pl.MANAGE_CHANNELS, I.Pl.MANAGE_ROLES, I.Pl.MANAGE_WEBHOOKS]
...
function l(E, S, _) {
	return {
		...
		permissions: R(
			_
				? [I.Pl.CONNECT, I.Pl.STREAM, I.Pl.MUTE_MEMBERS, I.Pl.MOVE_MEMBERS]
