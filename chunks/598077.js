...
class E extends i.Z {
	...
	constructor(e) {
		...
		super(),
			_(this, 'id', void 0),
			_(this, 'username', void 0),
			_(this, 'discriminator', void 0),
			_(this, 'avatar', void 0),
			_(this, 'avatarDecorationData', void 0),
			_(this, 'banner', void 0),
			_(this, 'email', void 0),
			_(this, 'verified', void 0),
			_(this, 'bot', void 0),
			_(this, 'system', void 0),
			_(this, 'mfaEnabled', void 0),
			_(this, 'mobile', void 0),
			_(this, 'desktop', void 0),
			_(this, 'premiumType', void 0),
			_(this, 'flags', void 0),
			_(this, 'publicFlags', void 0),
			_(this, 'purchasedFlags', void 0),
			_(this, 'premiumUsageFlags', void 0),
			_(this, 'phone', void 0),
			_(this, 'nsfwAllowed', void 0),
			_(this, 'guildMemberAvatars', void 0),
			_(this, 'hasBouncedEmail', void 0),
			_(this, 'personalConnectionId', void 0),
			_(this, 'globalName', void 0),
			_(this, 'clan', void 0),
			_(this, 'hasFlag', (e) => !1),
			_(this, 'isStaff', () => !1),
			_(this, 'isStaffPersonal', () => !1),
			_(this, 'hasAnyStaffLevel', () => !1);
		...
		(this.id = e.id),
			...
			(this.mfaEnabled =
				null !== (p = null !== (h = e.mfa_enabled) && void 0 !== h ? h : e.mfaEnabled) && void 0 !== p && p),
			...
			(this.publicFlags =
				null !== (S = null !== (g = e.public_flags) && void 0 !== g ? g : e.publicFlags) && void 0 !== S ? S : 0),
			(this.purchasedFlags =
				null !== (N = null !== (A = e.purchased_flags) && void 0 !== A ? A : e.purchasedFlags) && void 0 !== N ? N : 0),
			(this.premiumUsageFlags =
				null !== (O = null !== (v = e.premium_usage_flags) && void 0 !== v ? v : e.premiumUsageFlags) && void 0 !== O
					? O
					: 0),
			...
			(this.hasBouncedEmail =
				null !== (L = null !== (D = e.has_bounced_email) && void 0 !== D ? D : e.hasBouncedEmail) && void 0 !== L && L),
			(this.personalConnectionId =
				null !== (M = null !== (b = e.personal_connection_id) && void 0 !== b ? b : e.personalConnectionId) &&
				void 0 !== M
					? M
					: null),
			...
			Object.defineProperties(this, {
				...
				hasAnyStaffLevel: {
					...
					configurable: !1,
					value: () =>
						this.hasFlag(l.xW$.STAFF) || this.hasFlag(l.xW$.COLLABORATOR) || this.hasFlag(l.xW$.RESTRICTED_COLLABORATOR)
				}
			}),
