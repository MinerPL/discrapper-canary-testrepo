			...
			((n = (function (e, t, n, r) {
				...
				return (a > r && (a = r), 0 === a)
					...
					: ((e.avail_in -= a),
						...
						1 === e.state.wrap
							? (e.adler = s(e.adler, t, a, n))
							: 2 === e.state.wrap && (e.adler = o(e.adler, t, a, n)),
						(e.next_in += a),
						(e.total_in += a),
						a);
...
function S(e, t) {
	for (var n, r; ; ) {
		...
		if (
			...
			0 !== n && e.strstart - n <= e.w_size - d && (e.match_length = T(e, n)),
			e.match_length >= 3)
		) {
			if (
				((r = a._tr_tally(e, e.strstart - e.match_start, e.match_length - 3)),
...
function A(e, t) {
	for (var n, r, i; ; ) {
		...
		if (
			...
			if (
				((r = a._tr_tally(e, 0, e.window[e.strstart - 1])) && p(e, !1),
				e.strstart++,
				e.lookahead--,
				0 === e.strm.avail_out)
			)
	...
	if (
		(e.match_available && ((r = a._tr_tally(e, 0, e.window[e.strstart - 1])), (e.match_available = 0)),
		...
		for (65535 > e.pending_buf_size - 5 && (n = e.pending_buf_size - 5); ; ) {
			...
			if (
				((0 === e.strstart || e.strstart >= r) &&
					((e.lookahead = e.strstart - r), (e.strstart = r), p(e, !1), 0 === e.strm.avail_out)) ||
				(e.strstart - e.block_start >= e.w_size - d && (p(e, !1), 0 === e.strm.avail_out))
			)
				return 1;
		}
...
function v() {
	(this.strm = null),
		...
		(this.heap = new i.Buf16(2 * u + 1)),
		f(this.heap),
		(this.heap_len = 0),
		(this.heap_max = 0),
		(this.depth = new i.Buf16(2 * u + 1)),
		f(this.depth),
		(this.l_buf = 0),
		(this.lit_bufsize = 0),
		(this.last_lit = 0),
...
function C(e, t, n, r, a, s) {
	...
	if (
		...
		a < 1 || a > 9 || 8 !== n || r < 8 || r > 15 || t < 0 || t > 9 || s < 0 || s > 4)
	)
		return _(e, -2);
	8 === r && (r = 9);
	var l = new v();
...
(t.deflateInit = function (e, t) {
	...
	(t.deflate = function (e, t) {
		...
		if (((i.strm = e), (n = i.last_flush), (i.last_flush = t), 42 === i.status)) {
			if (2 === i.wrap)
				(e.adler = 0),
					...
					i.gzhead
						? (I(
							...
							I(i, 9 === i.level ? 2 : i.strategy >= 2 || i.level < 2 ? 4 : 0),
							I(i, 255 & i.gzhead.os),
							i.gzhead.extra &&
								i.gzhead.extra.length &&
								(I(i, 255 & i.gzhead.extra.length), I(i, (i.gzhead.extra.length >> 8) & 255)),
				...
				var n,
					...
					u = (8 + ((i.w_bits - 8) << 4)) << 8,
					c = -1;
				(u |= (c = i.strategy >= 2 || i.level < 2 ? 0 : i.level < 6 ? 1 : 6 === i.level ? 2 : 3) << 6),
					0 !== i.strstart && (u |= 32),
					(u += 31 - (u % 31)),
					(i.status = 113),
					m(i, u),
		...
		if (
			(103 === i.status &&
				(i.gzhead.hcrc
					? (i.pending + 2 > i.pending_buf_size && h(e),
						i.pending + 2 <= i.pending_buf_size &&
							(I(i, 255 & e.adler), I(i, (e.adler >> 8) & 255), (e.adler = 0), (i.status = 113)))
					: (i.status = 113)),
			0 !== i.pending)
		) {
			...
			if (
				...
				(1 === t
					...
					: 5 !== t &&
						...
						3 === t && (f(i.head), 0 === i.lookahead && ((i.strstart = 0), (i.block_start = 0), (i.insert = 0)))),
				h(e),
				0 === e.avail_out)
			)
	...
	(t.deflateSetDictionary = function (e, t) {
		...
		for (
			1 === o && (e.adler = s(e.adler, t, _, 0)),
				n.wrap = 0,
				_ >= n.w_size &&
					(0 === o && (f(n.head), (n.strstart = 0), (n.block_start = 0), (n.insert = 0)),
