	...
	return (
		e.reverse().forEach((e) => {
			...
			if (e.action_type === U.rsA.MEMBER_PRUNE) {
				let _ =
						null != e && null != e.options && null != e.options.delete_member_days ? e.options.delete_member_days : 1,
					E = new l.ms(U.zUn.PRUNE_DELETE_DAYS, null, _);
				n.push(E);
			}
			e.action_type === U.rsA.AUTO_MODERATION_BLOCK_MESSAGE &&
				(null === (T = e.options) || void 0 === T ? void 0 : T.auto_moderation_rule_name) != null &&
				n.push(new l.ms(U.zUn.AUTO_MODERATION_TRIGGERED_RULE_NAME, null, e.options.auto_moderation_rule_name)),
				e.action_type === U.rsA.VOICE_CHANNEL_STATUS_CREATE &&
					(null === (s = e.options) || void 0 === s ? void 0 : s.status) != null &&
					n.push(new l.ms(U.zUn.STATUS, null, e.options.status));
			let N = new l.ZP({
					id: e.id,
			...
			if (N.actionType === U.vB8.DELETE && (null != t || null != r)) {
				...
				(N.targetType === U.KFR.CHANNEL || N.targetType === U.KFR.CHANNEL_OVERWRITE) &&
					null !== a &&
					(0, L.r8)(a.oldValue) &&
					(e = '#'.concat(e)),
					null == v[N.targetType] ? (v[N.targetType] = { [N.targetId]: e }) : (v[N.targetType][N.targetId] = e);
			}
			(E = 0), _.unshift(N);
		}),
		_
