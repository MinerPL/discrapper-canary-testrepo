...
((i = r || (r = {}))[(i.AUDIO_BITRATE = 0)] = 'AUDIO_BITRATE'),
	(i[(i.VIDEO_RESOLUTION_SCALE = 1)] = 'VIDEO_RESOLUTION_SCALE'),
	(i[(i.VIDEO_BITRATE = 2)] = 'VIDEO_BITRATE'),
	(i[(i.VIDEO_FRAMERATE = 3)] = 'VIDEO_FRAMERATE');
class m extends u.Z {
	interact() {
	...
	updateVideoQualityCore(e, t) {
		...
		this.logger.info(
			'BaseWebRTCConnection.updateVideoQuality: resolutionScaleFactor: '.concat(n, ', ') +
				...
				'encodingVideoMaxBitRate: '.concat(e.encodingVideoMaxBitRate, ', localWant: ').concat(this.getLocalWant())
		),
			...
			((n = new _.Z(e, this.audioContext)).mute = this.selfDeaf || this.localMutes[e]),
				...
				n.on(_.X.Video, (t) => {
					...
					return this.emitUnsafe(
						...
						null !== (n = this.videoStreamParameters[0].rtxSsrc) && void 0 !== n ? n : 0,
		...
		super(e, t),
			...
			I(this, 'handleVideo', (e) => {
				...
				return this.emit(
					...
					this.audioSSRC,
					this.videoStreamParameters[0].ssrc,
					null !== (t = this.videoStreamParameters[0].rtxSsrc) && void 0 !== t ? t : 0,
					this.videoStreamParameters
				);
			}),
			...
			I(this, 'handleAudioContextStateChange', () => {
				!this.interacted &&
					...
					(this.interact(), this.emit(c.Sh.InteractionRequired, !1));
			}),
			I(this, 'handleStats', (e) => {
				...
				null != e &&
					...
					(this.stats = e),
					Date.now() - this.lastPingTime >= h.$B &&
						(this.emit(c.Sh.Ping, e.transport.ping), (this.lastPingTime = Date.now())));
			}),
