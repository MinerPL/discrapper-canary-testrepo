...
var u = function (e, t) {
	...
	d = n(413135).Buffer,
	_ =
		(void 0 !== n.g ? n.g : 'undefined' != typeof window ? window : 'undefined' != typeof self ? self : {})
			.Uint8Array || function () {},
	E = n(260907);
...
function v(e, t, i) {
	(r = r || n(827664)),
		...
		(this.decoder = null),
		(this.encoding = null),
		e.encoding && (!a && (a = n(2682).StringDecoder), (this.decoder = new a(e.encoding)), (this.encoding = e.encoding));
}
function O(e) {
...
function R(e, t, n, r, a) {
	...
	if (null === t)
		(l.reading = !1),
			(function (e, t) {
				if ((i('onEofChunk'), !t.ended)) {
					...
					(t.ended = !0),
						t.sync ? D(e) : ((t.needReadable = !1), !t.emittedReadable && ((t.emittedReadable = !0), L(e)));
				}
			})(e, l);
	else if (
		(!a &&
		...
		if (r) l.endEmitted ? A(e, new S()) : C(e, l, t, !0);
			...
			(l.reading = !1),
				l.decoder && !n
					? ((t = l.decoder.write(t)), l.objectMode || 0 !== t.length ? C(e, l, t, !1) : b(e, l))
					: C(e, l, t, !1);
		}
...
function C(e, t, n, r) {
	t.flowing && 0 === t.length && !t.sync
		...
		: ((t.length += t.objectMode ? 1 : n.length), r ? t.buffer.unshift(n) : t.buffer.push(n), t.needReadable && D(e)),
		b(e, t);
}
	...
	(O.prototype.push = function (e, t) {
		...
		return (
			r.objectMode
				? (n = !0)
				: 'string' == typeof e &&
					((t = t || r.defaultEncoding) !== r.encoding && ((e = d.from(e, t)), (t = '')), (n = !0)),
			R(this, e, t, !1, n)
		);
	}),
	...
	return (
		...
		n.ended || n.reading
			...
			: a &&
				...
				(n.sync = !1),
				!n.reading && (e = y(r, n))),
		null === (t = e > 0 ? G(e, n) : null)
			? ((n.needReadable = n.length <= n.highWaterMark), (e = 0))
			: ((n.length -= e), (n.awaitDrain = 0)),
		0 === n.length && (!n.ended && (n.needReadable = !0), r !== e && n.ended && k(this)),
...
function D(e) {
	...
	i('emitReadable', t.needReadable, t.emittedReadable),
		(t.needReadable = !1),
		!t.emittedReadable && (i('emitReadable', t.flowing), (t.emittedReadable = !0), l.nextTick(L, e));
}
function L(e) {
	var t = e._readableState;
...
(O.prototype._read = function (e) {
	...
	(O.prototype.pipe = function (e, t) {
		...
		var c = (function (e) {
			return function () {
				...
				i('pipeOnDrain', t.awaitDrain),
					...
					0 === t.awaitDrain && u(e, 'data') && ((t.flowing = !0), x(e));
			};
		})(n);
		e.on('drain', c);
		var d = !1;
		function _(t) {
			...
			i('dest.write', a),
				!1 === a &&
					(((1 === r.pipesCount && r.pipes === e) || (r.pipesCount > 1 && -1 !== F(r.pipes, e))) &&
						!d &&
		...
		return (
			'data' === e
				...
				: 'readable' === e &&
					...
					r.length ? D(this) : !r.reading && l.nextTick(U, this)),
			n
		);
	}),
