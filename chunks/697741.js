...
function w(e) {
	...
	return (
		...
		(t = v.exec(n))
			...
			: (t = p.exec(n)) &&
				d.test(t[1]) &&
				((n = t[1]), h.test(n) ? (n += 'e') : I.test(n) ? (n = n.slice(0, -1)) : _.test(n) && (n += 'e')),
		(t = b.exec(n)) && d.test(t[1]) && (n = t[1] + 'i'),
		(t = C.exec(n)) && l.test(t[1]) && (n = t[1] + i[t[2]]),
		(t = T.exec(n)) && l.test(t[1]) && (n = t[1] + o[t[2]]),
		(t = R.exec(n)) ? u.test(t[1]) && (n = t[1]) : (t = f.exec(n)) && u.test(t[1]) && (n = t[1]),
		(t = m.exec(n)) && (u.test(t[1]) || (s.test(t[1]) && !_.test(t[1]))) && (n = t[1]),
