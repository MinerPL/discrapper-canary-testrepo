...
function N(e) {
	...
	let s =
			null !== (n = null === (t = u.Z.getThreadSettings(e)) || void 0 === t ? void 0 : t.appliedTags) && void 0 !== n
				? n
				: new Set(),
	...
	return null != o && o.isForumLikeChannel()
		? {
				...
				forum_channel_default_emoji_reaction_id:
					null === (t = o.defaultReactionEmoji) || void 0 === t ? void 0 : t.emojiId,
				forum_channel_default_emoji_reaction_name:
					null === (n = o.defaultReactionEmoji) || void 0 === n ? void 0 : n.emojiName,
				forum_channel_available_tag_ids:
					null !== (i = null === (r = o.availableTags) || void 0 === r ? void 0 : r.map((e) => e.id)) && void 0 !== i
						? i
						: [],
...
function C(e) {
	...
	return null != I && I.isForumLikeChannel()
		? {
				...
				thread_locked:
					null !== (c = null === (n = p.threadMetadata) || void 0 === n ? void 0 : n.locked) && void 0 !== c && c,
				thread_auto_archive_duration_minutes:
					null !== (d = null === (r = p.threadMetadata) || void 0 === r ? void 0 : r.autoArchiveDuration) &&
					void 0 !== d
						? d
						: 0,
				...
				forum_post_applied_tag_ids: (function (e) {
					...
					return null !== (n = null === (t = r.appliedTags) || void 0 === t ? void 0 : t.filter((e) => s.has(e))) &&
						void 0 !== n
						? n
						: [];
				})(p.id),
				...
				forum_post_is_unread:
					null === (u = h.Z.getReadStateSnapshotAnalytics(p.id)) || void 0 === u ? void 0 : u.hasUnreads,
