	...
	return (
		...
		(0, i.jsx)(r.ZP, {
			...
			onClick: (e) => {
				e.stopPropagation(),
					t(u.L.UNKNOWN),
					l.default.track(d.rMx.DM_SAFETY_COACHMARK_ACTION, { action: c.Rv.DISMISS });
			},
			onSecondaryClick: () => {
				(0, s.uL)(d.Z5c.SETTINGS('privacy-and-safety')),
					l.default.track(d.rMx.DM_SAFETY_COACHMARK_ACTION, { action: c.Rv.CHANGE_SETTING });
			},
			markAsDismissed: t,
