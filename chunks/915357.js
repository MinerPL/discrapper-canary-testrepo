...
class c extends s.Z {
	send(e) {
		var t;
		null === (t = this.onSendingToRPCClient) || void 0 === t || t.call(this, e, this.id),
			this.postMessageToRPCClient([a.Z.FRAME, e], this.origin);
	}
	close(e, t) {
		!this.closed &&
			this.postClose(
	...
	constructor({
		...
		if (
			...
			-1 === ['etf', 'json'].indexOf(s))
		)
			throw new i.Z({ closeCode: l.$VG.INVALID_ENCODING }, 'Invalid Encoding: '.concat(s));
