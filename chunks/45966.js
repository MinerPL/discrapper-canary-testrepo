...
function N(e) {
	...
	let { guildId: c, updates: d } = e,
		_ =
			null !==
				(a =
					null !== (i = d.onboardingPromptsSeen) && void 0 !== i
						? i
						: null === (t = m[c]) || void 0 === t
							? void 0
							: t.onboardingPromptsSeen) && void 0 !== a
				? a
				: {},
		E =
			null !==
				(o =
					null !== (s = d.onboardingResponsesSeen) && void 0 !== s
						? s
						: null === (n = m[c]) || void 0 === n
							? void 0
							: n.onboardingResponsesSeen) && void 0 !== o
				? o
				: {},
		f = A(
			null !==
				(u = null !== (l = d.prompts) && void 0 !== l ? l : null === (r = m[c]) || void 0 === r ? void 0 : r.prompts) &&
				void 0 !== u
				? u
				: [],
			_,
...
class y extends (r = u.ZP.Store) {
	...
	getOnboardingResponses(e) {
		var t, n, r;
		return d.Z.isFullServerPreview(e)
			? Array.from(null !== (n = d.Z.getOnboardingResponses(e)) && void 0 !== n ? n : R)
			: null !== (r = null === (t = m[e]) || void 0 === t ? void 0 : t.responses) && void 0 !== r
				? r
				: R;
	}
	...
	getEnabledOnboardingPrompts(e) {
		...
		let r = m[e];
		return d.Z.isFullServerPreview(e)
			? null !== (t = null == r ? void 0 : r.prompts) && void 0 !== t
				? t
				: O
			: null != r && r.enabled
				? null !== (n = r.prompts) && void 0 !== n
					? n
					: O
				: O;
	}
	...
	getEnabled(e) {
		...
		return d.Z.isFullServerPreview(e)
			? null != m[e]
			: null !== (n = null === (t = m[e]) || void 0 === t ? void 0 : t.enabled) && void 0 !== n && n;
	}
...
(s = 'GuildOnboardingPromptsStore'),
	...
	(t.Z = new y(c.Z, {
		...
		GUILD_ONBOARDING_SELECT_OPTION: function (e) {
			...
			return (
				!!d.Z.isFullServerPreview(t) ||
				(null != m[t] &&
					(null != i && i.length > 0 && l().pullAll(m[t].responses, i),
					r ? m[t].responses.push(n) : l().pull(m[t].responses, n),
					null == T[t] && (T[t] = {}),
					(T[t][n] = r),
					null != i && i.forEach((e) => (T[t][e] = !1)),
					(T[t] = { ...T[t] }),
					!0))
			);
		},
