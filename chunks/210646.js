...
e.default = class t {
	...
	start(t) {
		...
		if (
			...
			this.data.start &&
				this.data.end &&
				(0, u.toDate)(this.data.start).getTime() > (0, u.toDate)(this.data.end).getTime())
		) {
	...
	recurrenceId(t) {
		return void 0 === t
			...
			: null === t
				...
				: ((this.data.recurrenceId = (0, u.checkDate)(t, 'recurrenceId')), this);
	}
	timezone(t) {
		return void 0 === t && null !== this.data.timezone
			...
			: void 0 === t
				...
				: ((this.data.timezone = t ? t.toString() : null), this.data.timezone && (this.data.floating = !1), this);
	}
	stamp(t) {
	...
	description(t) {
		return void 0 === t
			...
			: null === t
				...
				: ('string' == typeof t ? (this.data.description = { plain: t }) : (this.data.description = t), this);
	}
	organizer(t) {
		return void 0 === t
			? this.data.organizer
			: null === t
				...
				: ((this.data.organizer = (0, u.checkNameAndMail)('organizer', t)), this);
	}
	createAttendee(t = {}) {
	...
	lastModified(t) {
		return void 0 === t
			...
			: null === t
				...
				: ((this.data.lastModified = (0, u.checkDate)(t, 'lastModified')), this);
	}
	x(t, e) {
		return void 0 === t
			? (0, u.addOrGetCustomAttributes)(this.data)
			: ('string' == typeof t && 'string' == typeof e && (0, u.addOrGetCustomAttributes)(this.data, t, e),
				'object' == typeof t && (0, u.addOrGetCustomAttributes)(this.data, t),
				this);
	}
	toJSON() {
		var t;
			...
			(0, u.isRRule)(this.data.repeating) || 'string' == typeof this.data.repeating
				...
				: this.data.repeating &&
					(e = Object.assign({}, this.data.repeating, {
						...
						exclude:
							null === (t = this.data.repeating.exclude) || void 0 === t ? void 0 : t.map((t) => (0, u.toJSON)(t))
					})),
	...
	toString() {
		...
		return (
			...
			this.data.allDay
				? ((n += 'DTSTART;VALUE=DATE:' + (0, u.formatDate)(this.calendar.timezone(), this.data.start, !0) + '\r\n'),
					this.data.end &&
						(n += 'DTEND;VALUE=DATE:' + (0, u.formatDate)(this.calendar.timezone(), this.data.end, !0) + '\r\n'),
			...
			(0, u.isRRule)(this.data.repeating) || 'string' == typeof this.data.repeating
				...
				: this.data.repeating &&
					...
					this.data.repeating.until &&
						(n += ';UNTIL=' + (0, u.formatDate)(this.calendar.timezone(), this.data.repeating.until)),
					...
					this.data.repeating.byMonthDay && (n += ';BYMONTHDAY=' + this.data.repeating.byMonthDay.join(',')),
					...
					this.data.repeating.exclude &&
						(this.data.allDay
							? (n +=
									'EXDATE;VALUE=DATE:' +
									this.data.repeating.exclude.map((t) => (0, u.formatDate)(this.calendar.timezone(), t, !0)).join(',') +
									'\r\n')
							: ((n += 'EXDATE'),
								this.timezone()
									? (n +=
											...
											this.timezone() +
											':' +
											this.data.repeating.exclude.map((t) => (0, u.formatDate)(this.timezone(), t, !1, !0)).join(',') +
											'\r\n')
									: (n +=
											':' +
											this.data.repeating.exclude.map((t) => (0, u.formatDate)(this.timezone(), t)).join(',') +
											'\r\n')))),
			this.data.recurrenceId &&
				(n += (0, u.formatDateTZ)(this.timezone(), 'RECURRENCE-ID', this.data.recurrenceId, this.data) + '\r\n'),
			(n += 'SUMMARY:' + (0, u.escape)(this.data.summary) + '\r\n'),
			this.data.transparency && (n += 'TRANSP:' + (0, u.escape)(this.data.transparency) + '\r\n'),
			(null === (t = this.data.location) || void 0 === t ? void 0 : t.title) &&
				((n +=
					'LOCATION:' +
					(0, u.escape)(
						this.data.location.title + (this.data.location.address ? '\n' + this.data.location.address : '')
					) +
					'\r\n'),
				this.data.location.radius &&
					...
					(n +=
						...
						(this.data.location.address ? 'X-ADDRESS=' + (0, u.escape)(this.data.location.address) + ';' : '') +
						'X-APPLE-RADIUS=' +
						(0, u.escape)(this.data.location.radius) +
						';X-TITLE=' +
						(0, u.escape)(this.data.location.title) +
						':geo:' +
						(0, u.escape)(null === (e = this.data.location.geo) || void 0 === e ? void 0 : e.lat) +
						',' +
				...
				this.data.location.geo &&
					(n +=
						'GEO:' +
						(0, u.escape)(null === (i = this.data.location.geo) || void 0 === i ? void 0 : i.lat) +
						';' +
						(0, u.escape)(null === (r = this.data.location.geo) || void 0 === r ? void 0 : r.lon) +
						'\r\n')),
			this.data.description &&
				((n += 'DESCRIPTION:' + (0, u.escape)(this.data.description.plain) + '\r\n'),
				this.data.description.html &&
					(n += 'X-ALT-DESC;FMTTYPE=text/html:' + (0, u.escape)(this.data.description.html) + '\r\n')),
			this.data.organizer &&
				((n += 'ORGANIZER;CN="' + (0, u.escape)(this.data.organizer.name) + '"'),
				this.data.organizer.email &&
					this.data.organizer.mailto &&
					(n += ';EMAIL=' + (0, u.escape)(this.data.organizer.email)),
				this.data.organizer.email &&
					(n += ':mailto:' + (0, u.escape)(this.data.organizer.mailto || this.data.organizer.email)),
				(n += '\r\n')),
			...
			this.data.lastModified &&
				(n += 'LAST-MODIFIED:' + (0, u.formatDate)(this.calendar.timezone(), this.data.lastModified) + '\r\n'),
			(n += 'END:VEVENT\r\n')
		);
	}
};
