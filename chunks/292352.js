	...
	[
		3,
		{
			...
			tooltipDescription: (e) =>
				e
					? F.Z.Messages.FAMILY_CENTER_ACTIVITY_USER_INTERACTION_TOOLTIP_PARENT
					: F.Z.Messages.FAMILY_CENTER_ACTIVITY_USER_INTERACTION_TOOLTIP_TEEN,
...
function H(e, E) {
	return e
		? E
			? F.Z.Messages.FAMILY_CENTER_ACTIVITY_GUILD_INTERACTION_TOOLTIP_PARENT_WITH_VC
			: F.Z.Messages.FAMILY_CENTER_ACTIVITY_GUILD_INTERACTION_TOOLTIP_PARENT
		: E
			? F.Z.Messages.FAMILY_CENTER_ACTIVITY_GUILD_INTERACTION_TOOLTIP_TEEN_WITH_VC
			: F.Z.Messages.FAMILY_CENTER_ACTIVITY_GUILD_INTERACTION_TOOLTIP_TEEN;
}
((Y = C || (C = {}))[(Y.CHECK = 0)] = 'CHECK'),
	(Y[(Y.X = 1)] = 'X'),
	((c = N || (N = {}))[(c.GENERIC_ERROR = 0)] = 'GENERIC_ERROR'),
	(c[(c.INELIGIBLE_FOR_FAMILY_CENTER = 1)] = 'INELIGIBLE_FOR_FAMILY_CENTER'),
