...
let d = 50,
	...
	h = 262144,
	p = 48;
((o = r || (r = {}))[(o.NonDiversityPerRow = 42)] = 'NonDiversityPerRow'),
	(o[(o.DiversityPerRow = 10)] = 'DiversityPerRow'),
	(o[(o.PickerPerRow = 11)] = 'PickerPerRow'),
	(o[(o.PickerCount = 50)] = 'PickerCount'),
	((l = i || (i = {}))[(l.DISALLOW_EXTERNAL = 0)] = 'DISALLOW_EXTERNAL'),
	(l[(l.GUILD_SUBSCRIPTION_UNAVAILABLE = 1)] = 'GUILD_SUBSCRIPTION_UNAVAILABLE'),
	...
	(l[(l.ROLE_SUBSCRIPTION_UNAVAILABLE = 5)] = 'ROLE_SUBSCRIPTION_UNAVAILABLE'),
	((u = a || (a = {}))[(u.REACTION = 0)] = 'REACTION'),
	(u[(u.STATUS = 1)] = 'STATUS'),
	(u[(u.COMMUNITY_CONTENT = 2)] = 'COMMUNITY_CONTENT'),
	(u[(u.CHAT = 3)] = 'CHAT'),
	(u[(u.GUILD_STICKER_RELATED_EMOJI = 4)] = 'GUILD_STICKER_RELATED_EMOJI'),
	(u[(u.GUILD_ROLE_BENEFIT_EMOJI = 5)] = 'GUILD_ROLE_BENEFIT_EMOJI'),
	(u[(u.SOUNDBOARD = 6)] = 'SOUNDBOARD'),
	(u[(u.VOICE_CHANNEL_TOPIC = 7)] = 'VOICE_CHANNEL_TOPIC'),
	(u[(u.GIFT = 8)] = 'GIFT'),
	(u[(u.AUTO_SUGGESTION = 9)] = 'AUTO_SUGGESTION'),
	(u[(u.POLLS = 10)] = 'POLLS'),
	(u[(u.PROFILE = 11)] = 'PROFILE');
let I = new Set([2, 4, 5, 6, 8]);
function m(e) {
	return !I.has(e);
}
((c = s || (s = {})).EmojiButtonMouseEntered = 'EMOJI_BUTTON_MOUSE_ENTERED'),
	...
	(c.MessageContextMenuMouseEntered = 'MESSAGE_CONTEXT_MENU_MOUSE_ENTERED'),
