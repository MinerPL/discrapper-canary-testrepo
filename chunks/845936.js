...
function c(e) {
	...
	if (
		E === u.bi.BUILT_IN ||
		(null === (t = f.result) || void 0 === t ? void 0 : t.sections[E]) != null ||
		(null === (n = h.result) || void 0 === n ? void 0 : n.sections[E]) != null
	)
	...
	let S = a.Z.getApplication(E),
		...
		N =
			null == S
				? void 0
				: null === (_ = S.integrationTypesConfig) || void 0 === _
					? void 0
					: null === (d = _[A]) || void 0 === d
						? void 0
						: null === (c = d.oauth2InstallParams) || void 0 === c
							? void 0
							: c.scopes;
