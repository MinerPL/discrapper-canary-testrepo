			...
			count: function (e) {
				...
				if (!this._count_set || e) {
					...
					for (r = this.r1; r <= this.r2; r++)
						for (i = this.g1; i <= this.g2; i++) for (a = this.b1; a <= this.b2; a++) s += t[n(r, i, a)] || 0;
									...
									if (o == i)
										for (l = r.r1; l <= r.r2; l++) {
											for (d = 0, u = r.g1; u <= r.g2; u++)
												for (c = r.b1; c <= r.b2; c++) d += e[(_ = n(l, u, c))] || 0;
											(E += d), (f[l] = E);
										}
									else if (o == a)
										for (l = r.g1; l <= r.g2; l++) {
											for (d = 0, u = r.r1; u <= r.r2; u++)
												for (c = r.b1; c <= r.b2; c++) d += e[(_ = n(u, l, c))] || 0;
											(E += d), (f[l] = E);
										}
									else
										for (l = r.b1; l <= r.b2; l++) {
											for (d = 0, u = r.r1; u <= r.r2; u++)
												for (c = r.g1; c <= r.g2; c++) d += e[(_ = n(u, c, l))] || 0;
											(E += d), (f[l] = E);
										}
									return (
										...
										if (f[l] > E / 2) {
											for (
												i = r.copy(),
													...
													t = l - r[o],
													s =
														t <= (n = r[u] - l) ? Math.min(r[u] - 1, ~~(l + n / 2)) : Math.max(r[o], ~~(l - 1 - t / 2));
												!f[s];
