				...
				children: (e, t) => {
					...
					return (0, r.jsxs)('div', {
						...
						onBlur: (e) => {
							...
							if (
								!(
									(null === (t = ev.current) || void 0 === t ? void 0 : t.contains(e.relatedTarget)) ||
									(null === (r = eN.current) || void 0 === r
										? void 0
										: null === (n = r.getScrollerNode()) || void 0 === n
											? void 0
										...
										children: (0, r.jsx)(ez, {
											...
											onFocus: () => {
												...
												null === (e = ef.current) ||
													...
													e.setSelectionRange(
														0,
														null !== (t = null == eT ? void 0 : eT.length) && void 0 !== t ? t : 0
													);
											},
											onChange: (e) => {
			...
			(t) => {
				...
				return (
					...
					(null === (r = e.current) || void 0 === r
						? void 0
						: null === (n = r.ownerDocument) || void 0 === n
							? void 0
							: n.activeElement)
				);
			},
