...
(e.exports = i),
	...
	(i.prototype._updateEncrypt = function (e) {
		...
		0 !== this.bufferOff &&
			((t += this._buffer(e, t)), this.bufferOff === this.buffer.length && (n += this._flushBuffer(r, n)));
	...
	(i.prototype._updateDecrypt = function (e) {
		for (
			var t = 0, n = 0, r = Math.ceil((this.bufferOff + e.length) / this.blockSize) - 1, i = Array(r * this.blockSize);
			r > 0;
			r--
		)
	...
	(i.prototype.final = function (e) {
		var t, n;
		return (e && (t = this.update(e)), (n = 'encrypt' === this.type ? this._finalEncrypt() : this._finalDecrypt()), t)
			? t.concat(n)
			: n;
	}),
