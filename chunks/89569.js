...
let d = "".concat("#").concat("itemSkuId", "="),
  ...
  C = e => {
    ...
    } = e, m = s.useRef(null), p = (0, l.useLocation)(), C = p.pathname === c.Routes.COLLECTIBLES_SHOP ? n.default.HOME_PAGE_SHOP_TAB : p.pathname === c.Routes.COLLECTIBLES_SHOP_FULLSCREEN ? n.default.COLLECTIBLES_SHOP_FULLSCREEN : n.default.COLLECTIBLES_SHOP, {
