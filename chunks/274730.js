...
let F = new L.Z('AuditLogUtils'),
	...
	b = () => ({
		...
		[H.zUn.SYSTEM_CHANNEL_ID]: eO(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_ID_DISABLE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_ID_CHANGE
		),
		[H.zUn.RULES_CHANNEL_ID]: eO(
		...
		[H.zUn.PUBLIC_UPDATES_CHANNEL_ID]: eO(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_UPDATES_CHANNEL_ID_CLEAR,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_UPDATES_CHANNEL_ID_CHANGE
		),
		[H.zUn.MFA_LEVEL]: {
		...
		[H.zUn.WIDGET_CHANNEL_ID]: eO(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_CHANNEL_ID_DELETE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_CHANNEL_ID_CHANGE
		),
		...
		[H.zUn.DEFAULT_MESSAGE_NOTIFICATIONS]: {
			[H.bL.ALL_MESSAGES]:
				v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DEFAULT_MESSAGE_NOTIFICATIONS_CHANGE_ALL_MESSAGES,
			[H.bL.ONLY_MENTIONS]:
				v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DEFAULT_MESSAGE_NOTIFICATIONS_CHANGE_ONLY_MENTIONS
		},
		[H.zUn.VANITY_URL_CODE]: eO(
		...
		[H.zUn.EXPLICIT_CONTENT_FILTER]: {
			...
			[H.lxg.MEMBERS_WITHOUT_ROLES]:
				v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_EXPLICIT_CONTENT_FILTER_MEMBERS_WITHOUT_ROLES,
		...
		[H.zUn.AUTO_MODERATION_TRIGGERED_RULE_NAME]:
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTO_MODERATION_TRIGGERED_RULE_NAME_CHANGE,
		[H.zUn.SYSTEM_CHANNEL_FLAG_JOIN_NOTIFICATIONS]:
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_JOIN_NOTIFICATIONS,
		[H.zUn.SYSTEM_CHANNEL_FLAG_PREMIUM_SUBSCRIPTIONS]:
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_PREMIUM_SUBSCRIPTIONS,
		[H.zUn.SYSTEM_CHANNEL_FLAG_REMINDER_NOTIFICATIONS]:
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_REMINDER_NOTIFICATIONS,
		[H.zUn.SYSTEM_CHANNEL_FLAG_JOIN_NOTIFICATION_REPLIES]:
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_JOIN_NOTIFICATION_REPLIES,
		...B()
	}),
	x = () => ({
		[H.zUn.NAME]: eG(
		...
		[H.zUn.RTC_REGION_OVERRIDE]: eo(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_CHANGE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_CREATE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_DELETE
		),
		[H.zUn.USER_LIMIT]: eG(
		...
		[H.zUn.RATE_LIMIT_PER_USER]: eG(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CREATE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CHANGE
		),
		...
		[H.zUn.VIDEO_QUALITY_MODE]: eG(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_VIDEO_QUALITY_MODE_CREATE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_VIDEO_QUALITY_MODE_CHANGE
		),
		[H.zUn.DEFAULT_AUTO_ARCHIVE_DURATION]: eG(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_DEFAULT_AUTO_ARCHIVE_DURATION_CREATE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_DEFAULT_AUTO_ARCHIVE_DURATION_CHANGE
		),
	...
	z = () => ({
		...
		[H.zUn.COMMUNICATION_DISABLED_UNTIL]: eo(
			...
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL_REMOVED
		),
	...
	Q = () => ({
		...
		[H.zUn.LOCATION]: eO(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_LOCATION_CLEAR,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_LOCATION
		),
		[H.zUn.IMAGE_HASH]: eO(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_IMAGE_HASH_REMOVE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_IMAGE_HASH_CHANGE
		),
		...B()
	}),
	$ = () => ({
		[H.zUn.SCHEDULED_START_TIME]: eO(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_START_TIME_REMOVED,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_START_TIME_CHANGE
		),
		[H.zUn.SCHEDULED_END_TIME]: eO(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_END_TIME_REMOVED,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_EXCEPTION_SCHEDULED_END_TIME_CHANGE
		),
		[H.zUn.IS_CANCELED]: (e) => {
	...
	ee = () => ({
		...
		[H.zUn.AUTO_ARCHIVE_DURATION]: eG(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_AUTO_ARCHIVE_DURATION_CREATE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_AUTO_ARCHIVE_DURATION_CHANGE
		),
		[H.zUn.RATE_LIMIT_PER_USER]: eG(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CREATE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CHANGE
				...
				e.forEach((e) => {
					e.newValue
						? e.newValue.permission
							? (_[e.key] = v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMAND_PERMISSION_GRANTED)
							: (_[e.key] = v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMAND_PERMISSION_DENIED)
						: (_[e.key] = v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMAND_PERMISSION_REMOVED);
				}),
			_
		);
	},
	eE = () => ({
		...
		[H.zUn.AUTO_MODERATION_ENABLED]: (e) => {
			var _;
			return !0 === (null !== (_ = e.newValue) && void 0 !== _ ? _ : e.oldValue)
				? v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_ENABLED_UPDATE
				: v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_DISABLED_UPDATE;
		},
		...
		[H.zUn.AUTO_MODERATION_TRIGGER_METADATA]:
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_TRIGGER_METADATA_UPDATE,
		...
		[H.zUn.AUTO_MODERATION_REMOVE_REGEX_PATTERNS]:
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_REMOVE_REGEX_PATTERNS,
	...
	es = () => ({
		[H.zUn.NAME]: eG(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_NAME_CREATE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_NAME_CHANGE
		),
		[H.zUn.VOLUME]: eG(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_VOLUME_CREATE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_VOLUME_CHANGE
		),
		[H.zUn.EMOJI_NAME]: eo(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_NAME_REPLACE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_NAME_CREATE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_NAME_REMOVE
		),
		[H.zUn.EMOJI_ID]: eo(
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_ID_REPLACE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_ID_CREATE,
			v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SOUNDBOARD_SOUND_EMOJI_ID_REMOVE
		),
		...B()
	}),
	eT = () => ({
...
function et(e) {
	switch (e.action) {
		...
		case H.rsA.AUTO_MODERATION_FLAG_TO_CHANNEL:
			var s;
			if (
				(null === (s = e.options) || void 0 === s ? void 0 : s.auto_moderation_rule_trigger_type) ===
				h.fX.USER_PROFILE.toString()
			)
					...
					switch (e.targetType) {
						...
						case H.KFR.STAGE_INSTANCE:
							return eD(
								...
								(e) => {
									var E;
									return null === (E = Object.values(o.Z.getStageInstancesByGuild(_.id))) || void 0 === E
										? void 0
										: E.find((_) => _.id === e);
								},
								(e) => e.topic
										...
										T =
											null == s
												...
												: s.guild_scheduled_event_exceptions.find(
														(_) => _.event_exception_id === e.options.event_exception_id
													);
									E.subtarget = (0, d.vc)(
										n()(
											P.default.extractTimestamp(
												null !== (_ = null == T ? void 0 : T.event_exception_id) && void 0 !== _ ? _ : '0'
											)
										),
										'LL'
									);
						...
						let I = (function (e, _, E) {
							...
							switch (e.key) {
								...
								case H.zUn.THEME_COLORS:
									return eS(e, (e) =>
										''.concat((0, a.Rf)(e[0]).toUpperCase(), ', ').concat((0, a.Rf)(e[1]).toUpperCase())
									);
								case H.zUn.MAX_AGE:
									return eS(e, (e) => {
								...
								case H.zUn.VIDEO_QUALITY_MODE:
									return eS(e, (e) =>
										e === H.Ucd.FULL ? v.Z.Messages.VIDEO_QUALITY_MODE_FULL : v.Z.Messages.VIDEO_QUALITY_MODE_AUTO
									);
									...
									if (_.targetType === H.KFR.AUTO_MODERATION_RULE)
										return eS(e, (e) => {
											if (null != e && 'object' == typeof e)
												return null != e.keyword_filter && Array.isArray(e.keyword_filter)
								...
								case H.zUn.AUTO_MODERATION_REMOVE_ALLOW_LIST:
									if (_.targetType === H.KFR.AUTO_MODERATION_RULE)
										return eS(e, (e) =>
											null != e && Array.isArray(e) ? e.map((e) => "'".concat(e, "'")).join(', ') : JSON.stringify(e)
										);
									break;
									...
									if (_.targetType === H.KFR.AUTO_MODERATION_RULE)
										return eS(
											...
											(e) =>
												null != e && e.length > 0
													? e.join(', ')
													: v.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTOMOD_RULE_NONE
										);
									break;
									...
									return (function (e) {
										...
										for (let e in I) {
											...
											if (
												...
												(null == E ? void 0 : E.emoji_id) !== _.emoji_id ||
												(null == E ? void 0 : E.emoji_name) !== _.emoji_name
											)
