...
var r = n(147018),
	...
	ec = function (e) {
		(this.entries = []),
			(this.url = null),
			void 0 !== e &&
				(S(e) ? this.parseObject(e) : this.parseQuery('string' == typeof e ? ('?' === K(e, 0) ? ee(e, 1) : e) : A(e)));
	};
ec.prototype = {
	type: b,
	bindURL: function (e) {
	...
	var eE = s(H.has),
		...
		eh = function (e) {
			if (S(e)) {
				...
				if (T(n) === b)
					return (
						!eE((t = e.headers ? new F(e.headers) : new F()), 'content-type') &&
							ef(t, 'content-type', 'application/x-www-form-urlencoded;charset=UTF-8'),
						N(e, {
							body: v(0, A(n)),
							headers: v(0, t)
						})
