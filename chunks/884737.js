...
let C = new a.Z('AuditLogUtils'),
	...
	f = () => ({
		...
		[u.zUn.SYSTEM_CHANNEL_ID]: eT(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_ID_DISABLE,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_ID_CHANGE
		),
		[u.zUn.RULES_CHANNEL_ID]: eT(
		...
		[u.zUn.PUBLIC_UPDATES_CHANNEL_ID]: eT(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_UPDATES_CHANNEL_ID_CLEAR,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_UPDATES_CHANNEL_ID_CHANGE
		),
		[u.zUn.MFA_LEVEL]: {
		...
		[u.zUn.WIDGET_CHANNEL_ID]: eT(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_CHANNEL_ID_DELETE,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_WIDGET_CHANNEL_ID_CHANGE
		),
		...
		[u.zUn.DEFAULT_MESSAGE_NOTIFICATIONS]: {
			[u.bL.ALL_MESSAGES]:
				c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DEFAULT_MESSAGE_NOTIFICATIONS_CHANGE_ALL_MESSAGES,
			[u.bL.ONLY_MENTIONS]:
				c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_DEFAULT_MESSAGE_NOTIFICATIONS_CHANGE_ONLY_MENTIONS
		},
		[u.zUn.VANITY_URL_CODE]: eT(
		...
		[u.zUn.EXPLICIT_CONTENT_FILTER]: {
			...
			[u.lxg.MEMBERS_WITHOUT_ROLES]:
				c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_EXPLICIT_CONTENT_FILTER_MEMBERS_WITHOUT_ROLES,
		...
		[u.zUn.AUTO_MODERATION_TRIGGERED_RULE_NAME]:
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_AUTO_MODERATION_TRIGGERED_RULE_NAME_CHANGE,
		[u.zUn.SYSTEM_CHANNEL_FLAG_JOIN_NOTIFICATIONS]:
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_JOIN_NOTIFICATIONS,
		[u.zUn.SYSTEM_CHANNEL_FLAG_PREMIUM_SUBSCRIPTIONS]:
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_PREMIUM_SUBSCRIPTIONS,
		[u.zUn.SYSTEM_CHANNEL_FLAG_REMINDER_NOTIFICATIONS]:
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_REMINDER_NOTIFICATIONS,
		[u.zUn.SYSTEM_CHANNEL_FLAG_JOIN_NOTIFICATION_REPLIES]:
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_GUILD_SYSTEM_CHANNEL_JOIN_NOTIFICATION_REPLIES,
		...g()
	}),
	Z = () => ({
		[u.zUn.NAME]: es(
		...
		[u.zUn.RTC_REGION_OVERRIDE]: eI(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_CHANGE,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_CREATE,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RTC_REGION_OVERRIDE_DELETE
		),
		[u.zUn.USER_LIMIT]: es(
		...
		[u.zUn.RATE_LIMIT_PER_USER]: es(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CREATE,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CHANGE
		),
		...
		[u.zUn.VIDEO_QUALITY_MODE]: es(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_VIDEO_QUALITY_MODE_CREATE,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_VIDEO_QUALITY_MODE_CHANGE
		),
		[u.zUn.DEFAULT_AUTO_ARCHIVE_DURATION]: es(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_DEFAULT_AUTO_ARCHIVE_DURATION_CREATE,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_DEFAULT_AUTO_ARCHIVE_DURATION_CHANGE
		)
	}),
	P = () => ({
		[u.zUn.NICK]: eI(
		...
		[u.zUn.COMMUNICATION_DISABLED_UNTIL]: eI(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMUNICATION_DISABLED_UNTIL_REMOVED
		),
	...
	B = () => ({
		...
		[u.zUn.LOCATION]: eT(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_LOCATION_CLEAR,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_LOCATION
		),
		[u.zUn.RECURRENCE_RULE]: eT(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_RECURRENCE_RULE_CLEAR,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_SCHEDULED_EVENT_RECURRENCE_RULE
		),
		...g()
	}),
	b = () => ({
		...
		[u.zUn.AUTO_ARCHIVE_DURATION]: es(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_AUTO_ARCHIVE_DURATION_CREATE,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_THREAD_AUTO_ARCHIVE_DURATION_CHANGE
		),
		[u.zUn.RATE_LIMIT_PER_USER]: es(
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CREATE,
			c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_CHANNEL_RATE_LIMIT_PER_USER_CHANGE
				...
				e.forEach((e) => {
					e.newValue
						? e.newValue.permission
							? (_[e.key] = c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMAND_PERMISSION_GRANTED)
							: (_[e.key] = c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMAND_PERMISSION_DENIED)
						: (_[e.key] = c.Z.Messages.GUILD_SETTINGS_AUDIT_LOG_COMMAND_PERMISSION_REMOVED);
				}),
			_
		);
	},
	...
	return (
		e.forEach((e) => {
					...
					switch (e.targetType) {
						...
						case u.KFR.STAGE_INSTANCE:
							return e_(
								...
								(e) => {
									var E;
									return null === (E = Object.values(L.Z.getStageInstancesByGuild(_.id))) || void 0 === E
										? void 0
										: E.find((_) => _.id === e);
								},
								(e) => e.topic
			...
			if (
				null != I &&
				(null != s ||
					e.action === u.rsA.MEMBER_PRUNE ||
					e.action === u.rsA.MEMBER_DISCONNECT ||
					e.action === u.rsA.MEMBER_MOVE ||
					e.action === u.rsA.CREATOR_MONETIZATION_REQUEST_CREATED ||
					e.action === u.rsA.CREATOR_MONETIZATION_TERMS_ACCEPTED)
			) {
				if (
					null !=
							...
							if (null != e.options) {
								...
								return (
									null != e.options.channel_id &&
										(s.channel = e_(e, '', (e) => U.Z.getChannel(e), void 0, e.options.channel_id)),
						...
						let I = (function (e, _, E) {
							...
							switch (e.key) {
								...
								case u.zUn.VIDEO_QUALITY_MODE:
									return ee(e, (e) =>
										e === u.Ucd.FULL ? c.Z.Messages.VIDEO_QUALITY_MODE_FULL : c.Z.Messages.VIDEO_QUALITY_MODE_AUTO
									);
...
function ee(e, _, E) {
	let s = e.newValue,
		T = e.oldValue;
	return (
		null != e.newValue && ((s = _(e.newValue)), null != E && null != s && (s = E(s))),
		null != e.oldValue && ((T = _(e.oldValue)), null != E && null != T && (T = E(T))),
		new D.ms(e.key, T || e.oldValue, s || e.newValue)
	);
}
