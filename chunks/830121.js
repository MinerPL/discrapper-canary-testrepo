...
function B(e) {
	...
	return null !==
		(i =
			null !==
				(r = null !== (n = null !== (t = k(L, e)) && void 0 !== t ? t : k(b, e)) && void 0 !== n ? n : k(M, e)) &&
			void 0 !== r
				? r
				: k(P, e)) && void 0 !== i
		? i
	...
	let s = k(y, a),
		...
		l =
			null !==
				(i =
					null !==
						(r = null !== (n = null !== (t = k(L, a)) && void 0 !== t ? t : k(b, a)) && void 0 !== n ? n : k(M, a)) &&
					void 0 !== r
						? r
						: k(P, a)) && void 0 !== i
				? i
...
function V(e) {
	...
	for (let e of r) {
		...
		null != u &&
			o(
				h.g.EVENT,
				''.concat(u.guildId, '-').concat(u.guildEventId) + (null != u.recurrenceId ? '-'.concat(u.recurrenceId) : '')
			);
