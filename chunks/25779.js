...
function u() {
	...
	n.S1({
		...
		release: 'discord_web-71528c8786e21bb4558b5986976eaaa303a9bc08',
			...
			return !(
				(null != (r = e).exception &&
					...
					r.exception.values.every(
						(e) => null == e.stacktrace || (null != e.stacktrace.frames && 1 === e.stacktrace.frames.length)
					) &&
		...
		i.YA('buildNumber', ((e = '318812'), '318812'));
	i.YA('builtAt', String('1723741635463'));
