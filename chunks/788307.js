...
t.Z = (e) => {
	...
	let {
		...
		U = (0, o.e7)([h.Z], () =>
			P ? h.Z.getHangStatusActivity() : null != n ? n.find((e) => e.type === v.IIU.HANG_STATUS) : null
		),
		w = (0, o.e7)([A.Z, T.Z], () => {
			var e;
			return null != U && null != L
				? T.Z.getChannel(null === (e = A.Z.getVoiceStateForUser(L.id)) || void 0 === e ? void 0 : e.channelId)
				: null;
		}),
