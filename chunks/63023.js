...
class a {
	_processQueue() {
		setTimeout(() => {
			if (this._queue.length > 0 && this._tokenCount > 0) {
				this._tokenCount--,
					null == this._intervalID && (this._intervalID = setInterval(() => this._iterate(), this._intervalPeriod));
	...
	constructor(e, t) {
		i(this, '_capacity', void 0),
			i(this, '_tokenCount', void 0),
			i(this, '_queue', void 0),
			i(this, '_intervalPeriod', void 0),
			i(this, '_intervalID', void 0),
			(this._capacity = e),
			(this._tokenCount = e),
			(this._queue = []),
