...
function y(e) {
	...
	let {
		...
		[eT, eI] = (0, O.Z)(e_),
		{ paymentError: ed, paymentAuthenticationState: eR } = (0, f.Z)(),
		{ purchaseError: eC, purchaseErrorBlockRef: eN, setPurchaseError: eM } = (0, L.Z)(),
		eP = (0, l.Z)(() => {
		...
		{ selectedSkuId: eU, selectedPlan: ef, setSelectedSkuId: eL, setSelectedPlanId: eO } = (0, N.Z)(),
		[eh, ep] = (0, E.Wu)([A.Z], () => [A.Z.purchaseTokenAuthState, A.Z.purchaseTokenHash]),
		[em, eZ] = (0, E.Wu)([G.Z], () => [G.Z.browserCheckoutState, G.Z.loadId]),
		[eG, eD] = i.useState(null),
		[eF, eB] = i.useState(null),
		[eK, eH] = i.useState(null),
		[ey, eg] = i.useState(null),
		[ev, ew] = i.useState(null),
		[eY, eb] = i.useState(void 0),
		[eW, eV] = i.useState([]),
		ek = i.useMemo(() => null == ef || (0, R.PV)(ef.id), [ef]),
		ex = i.useRef(null != H ? H.planId : null);
	i.useEffect(() => {
	...
	let {
		...
		e$ = (0, s.IX)(V),
		e0 =
			(0, d.yE)(null !== (t = null == e$ ? void 0 : e$.flags) && void 0 !== t ? t : 0, D.udG.EMBEDDED) &&
			(0, d.yE)(null !== (n = null == e$ ? void 0 : e$.flags) && void 0 !== n ? n : 0, D.udG.EMBEDDED_IAP),
		e1 = (0, E.e7)([a.ZP], () =>
		...
		e7 = (0, _.Z)(e1),
		e4 = (0, E.e7)([T.Z], () => (null != eU ? T.Z.getForSKU(eU) : null), [eU]),
		e2 = eX[null != eU ? eU : ''],
		[e5, e8] = i.useState(null),
		e9 = null !== (I = null == H ? void 0 : H.inReverseTrial) && void 0 !== I && I && !w;
