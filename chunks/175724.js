...
let p = {
	...
	action(e) {
		...
		let n = h.Z.getGuildId(),
			...
			u =
				(null == r ? void 0 : r.type) === _.tI.VIEW_THREAD || (null == r ? void 0 : r.type) === _.tI.VIEW_CHANNEL
					? r.channelId
					: null;
...
function Z(e) {
	...
	let n = !1;
	return (
		N.Z.getMessages(e).hasMoreAfter && (o.Z.jumpToPresent(e, f.AQB), (n = !0)),
		L.ZP.hasUnread(e) && ((0, r.In)(e), (n = !0)),
		(0, r.iV)(e),
		n
	);
}
