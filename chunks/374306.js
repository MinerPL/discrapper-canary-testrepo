...
function _(e) {
	...
	let N =
		...
		t
			? n
				? p.Z.Messages.MEDIA_CHANNEL_ADMIN_EDUCATION_SHOW
				: p.Z.Messages.FORUM_CHANNEL_ONBOARDING_SHOW
			: n
				? p.Z.Messages.MEDIA_CHANNEL_ADMIN_EDUCATION_HIDE
				: p.Z.Messages.FORUM_CHANNEL_ONBOARDING_HIDE);
	return (0, i.jsx)(m.JO, {
		tooltip: N,
