			...
			if (!ev.isText(n)) {
				...
				for (
					var i =
							!$.isEditor(n) &&
							W.isElement(n) &&
							(e.isInline(n) || 0 === n.children.length || ev.isText(n.children[0]) || e.isInline(n.children[0])),
						a = 0,
						s = 0;
					s < n.children.length;
					s++, a++
...
var D =
	...
	k = (e, t) => {
		var n = i.Any;
		return (
			-1 !== e.search(D) && (n |= i.Extend),
			8205 === t && (n |= i.ZWJ),
			t >= 127462 && t <= 127487 && (n |= i.RI),
			-1 !== e.search(L) && (n |= i.Prepend),
			-1 !== e.search(b) && (n |= i.SpacingMark),
			-1 !== e.search(M) && (n |= i.L),
			-1 !== e.search(P) && (n |= i.V),
			-1 !== e.search(U) && (n |= i.T),
			-1 !== e.search(w) && (n |= i.LV),
			-1 !== e.search(x) && (n |= i.LVT),
			-1 !== e.search(G) && (n |= i.ExtPict),
			n
		);
	};
function B(e, t) {
	...
	$ = {
		...
		*nodes(e) {
		...
		path(e, t) {
			...
			return (
				eh.isRange(t) &&
					(t = 'start' === i ? eh.start(t) : 'end' === i ? eh.end(t) : eo.common(t.anchor.path, t.focus.path)),
			...
			if (!!n) {
				...
				for (var [h, p] of $.nodes(e, {
					...
					if (ev.isText(h)) {
						...
						for (
							g
								? ((E = i ? u.offset : h.text.length - u.offset), (f = u.offset))
								: ((E = h.text.length), (f = i ? E : 0)),
								(g || c || 'offset' === r) &&
									(yield {
										path: p,
										offset: f
	...
	er = {
		...
		*levels(e, t) {
		...
		matches: (e, t) =>
			...
			(ev.isText(e) && ev.isTextProps(t) && ev.matches(e, t)),
		*nodes(e) {
			for (
				var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
					...
					o = [],
					l = e;
				!(a && (r ? eo.isBefore(o, a) : eo.isAfter(o, a)));

			) {
				if (
					(!s.has(l) && (yield [l, o]),
					!s.has(l) && !ev.isText(l) && 0 !== l.children.length && (null == n || !1 === n([l, o])))
				) {
					s.add(l);
			...
			switch (e.type) {
				...
				case 'set_selection':
					return (
						...
						((0, a.P)(e.properties) && (0, a.P)(e.newProperties))
					);
				case 'split_node':
		...
		transform(e, t) {
			...
			switch (t.type) {
				...
				case 'merge_node':
					...
					eo.equals(o, r) || eo.endsBefore(o, r)
						? (r[o.length - 1] -= 1)
						: eo.isAncestor(o, r) && ((r[o.length - 1] -= 1), (r[o.length] += l));
					break;
				case 'split_node':
					...
					if (eo.equals(u, r)) {
						...
						eo.endsBefore(u, r)
							? (r[u.length - 1] += 1)
							: eo.isAncestor(u, r) && e[u.length] >= c && ((r[u.length - 1] += 1), (r[u.length] -= c));
					break;
				case 'move_node':
					...
					case 'split_node':
						if (eo.equals(t.path, i)) {
							...
							(t.position < a || (t.position === a && 'forward' === r)) &&
								((e.offset -= t.position), (e.path = eo.transform(i, t, ec(ec({}, n), {}, { affinity: 'forward' }))));
...
var eh = {
		...
		includes(e, t) {
			...
			return (
				ed.isPoint(t)
					? ((l = ed.compare(t, s) >= 0), (u = 0 >= ed.compare(t, o)))
					: ((l = eo.compare(t, s.path) >= 0), (u = 0 >= eo.compare(t, o.path))),
				l && u
			);
		},
		intersection(e, t) {
		...
		switch (n.type) {
				...
				if (ev.isText(m) && ev.isText(g)) g.text += m.text;
					...
					throw Error(
						'Cannot apply a "merge_node" operation at path ['
							.concat(I, '] to nodes of different interfaces: ')
							.concat(em.stringify(m), ' ')
			...
			case 'move_node':
				...
				if (eo.isAncestor(O, R))
					throw Error(
						'Cannot move a path ['.concat(O, '] to new path [').concat(R, '] because the destination is inside itself.')
					);
				var C = er.get(e, O),
					y = er.parent(e, O),
					D = O[O.length - 1];
					...
					for (var [G, k] of eh.points(t)) {
						...
						if (null != t && null != B) t[k] = B;
							...
							F &&
								...
								(Y = eo.equals(V[1], w)
									? !eo.hasPrevious(V[1])
									: eo.common(F[1], w).length < eo.common(V[1], w).length),
								F && !Y
									? ((G.path = F[1]), (G.offset = F[0].text.length))
									: V
										? ((G.path = V[1]), (G.offset = 0))
										: (t = null);
						}
					}
				break;
			...
			case 'split_node':
				...
				if (0 === eE.length)
					throw Error(
						'Cannot apply a "split_node" operation at path ['.concat(eE, '] because the root node cannot be split.')
					);
				var eI = er.get(e, eE),
					eT = er.parent(e, eE),
					eg = eE[eE.length - 1];
				...
				{},
				{
					transform(e, t) {
						...
						try {
							...
							(e.children = (0, s._x)(e.children)),
								n ? (e.selection = (0, s.mv)(n) ? (0, s._x)(n) : n) : (e.selection = null);
						}
					}
				}
			),
			{
						...
						if (ed.isPoint(s)) {
							null == o &&
								(o = ev.isText(u)
									? (e) => ev.isText(e)
									: e.isInline(u)
										? (t) => ev.isText(t) || $.isInline(e, t)
										: (t) => W.isElement(t) && $.isBlock(e, t));
							var [_] = $.nodes(e, {
								at: s.path,
								match: o,
								mode: a,
				...
				setNodes(e, t) {
					...
					$.withoutNormalizing(e, () => {
						...
						if (!!i) {
							if (
								(null == r && (r = eo.isPath(i) ? eU(e, i) : (t) => W.isElement(t) && $.isBlock(e, t)),
								!o && eh.isRange(i) && (i = $.unhangRange(e, i, { voids: c })),
								u && eh.isRange(i))
							) {
									...
									for (var A in t) {
										if ('children' !== A && 'text' !== A)
											a(t[A], I[A]) &&
												...
												s ? null != t[A] && (g[A] = s(I[A], t[A])) : null != t[A] && (g[A] = t[A]));
									}
									S &&
										e.apply({
											type: 'set_node',
				...
				splitNodes(e) {
					...
					$.withoutNormalizing(e, () => {
						...
						if (
							(null == s && (s = (t) => W.isElement(t) && $.isBlock(e, t)),
							eh.isRange(o) && (o = eP(e, o)),
							eo.isPath(o))
						) {
							var c = o,
								d = $.point(e, c),
				...
				unwrapNodes(e) {
					...
					$.withoutNormalizing(e, () => {
						var { mode: n = 'lowest', split: r = !1, voids: i = !1 } = t,
							{ at: a = e.selection, match: s } = t;
						if (!!a) {
							null == s && (s = eo.isPath(a) ? eU(e, a) : (t) => W.isElement(t) && $.isBlock(e, t)),
							...
							if (
								(null == s &&
									(s = eo.isPath(o)
										? eU(e, o)
										: e.isInline(t)
											? (t) => (W.isElement(t) && $.isInline(e, t)) || ev.isText(t)
											: (t) => W.isElement(t) && $.isBlock(e, t)),
								i && eh.isRange(o))
							) {
								var [l, u] = eh.edges(o),
		...
		),
		{
			...
			move(e) {
				var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
					...
					{ edge: s = null } = t;
				if (!!n) {
					'start' === s && (s = eh.isBackward(n) ? 'focus' : 'anchor'),
						'end' === s && (s = eh.isBackward(n) ? 'anchor' : 'focus');
				...
				if (!eh.isCollapsed(o)) {
					...
					for (var C of $.nodes(e, {
						...
						if (!n || 0 !== eo.compare(D, n))
							((!s && W.isElement(y) && $.isVoid(e, y)) || (!eo.isCommon(D, p.path) && !eo.isCommon(D, I.path))) &&
								(R.push(C), (n = D));
					}
					...
					!S &&
						...
						u &&
							...
							P.length > 1 &&
							P.match(/[\u0E00-\u0E7F]+/) &&
							eB.insertText(e, P.slice(0, P.length - a));
					var Y = b.unref(),
						j = M.unref(),
						K = r ? Y || j : j || Y;
			...
			$.withoutNormalizing(e, () => {
				...
				if (!(!a && $.void(e, { at: s }))) {
					...
					var [, d] = $.above(e, {
						...
						g = (t) => {
							...
							return (
								...
								(!!f ||
									(!(
										(h && eo.isAncestor(r, I) && W.isElement(n) && !e.isVoid(n) && !e.isInline(n)) ||
										(p && eo.isAncestor(r, m) && W.isElement(n) && !e.isVoid(n) && !e.isInline(n))
									) &&
										!0))
							);
						};
					...
					if (
						...
						!n.at &&
							(v.length > 0 && P.current
								? (r = eo.previous(P.current))
								: N.length > 0 && M.current
									? (r = eo.previous(M.current))
									: U.current && (r = eo.previous(U.current)),
							r))
					) {
						var w = $.end(e, r);
						eB.select(e, w);
