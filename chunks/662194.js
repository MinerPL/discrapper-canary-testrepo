...
t.Z = {
	...
	[u.Etm.SET_VOICE_SETTINGS]: {
		...
		handler(e) {
			...
			if (
				(t &&
					(null != t.device_id && a.Z.setInputDevice(t.device_id), null != t.volume && a.Z.setInputVolume(t.volume)),
				n &&
					(null != n.device_id && a.Z.setOutputDevice(n.device_id), null != n.volume && a.Z.setOutputVolume(n.volume)),
				i)
			) {
				let e = s.Z.getMode(),
			...
			if (
				(null != r && a.Z.setAutomaticGainControl(r),
				null != l && a.Z.setEchoCancellation(l),
				null != o && a.Z.setNoiseSuppression(o),
				null != d && a.Z.setQoS(d),
				null != u && a.Z.setSilenceWarning(u),
				null != _)
			) {
