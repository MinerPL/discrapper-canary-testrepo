		...
		window.navigator.mediaDevices
			...
			.then((e) => {
				let t = c.Z.getOutputDevices(),
					...
					a = i[n];
				null != r && (null == a || a.label !== r.name) && (a = i.find((e) => e.label === r.name)),
					(f = null != a ? a.deviceId : E);
			})
			.catch(() => {
				f = E;
			});
				...
				null !== (e = this._audio) && void 0 !== e
					...
					: new Promise((e, t) => {
							...
							(r.src = n(451343)('./'.concat(this.name, '.mp3'))),
								(r.onloadeddata = () => {
									(r.volume = Math.min((c.Z.getOutputVolume() / 100) * this._volume, 1)),
										d.isPlatformEmbedded && r.setSinkId(f),
										e(r);
								}),
...
class S {
	...
	constructor(e, t, n) {
		_(this, 'name', void 0),
			_(this, '_volume', void 0),
			_(this, '_audioContext', void 0),
			_(this, '_buffer', void 0),
			_(this, '_source', void 0),
			_(this, '_gain', void 0),
			_(this, '_state', void 0),
			_(this, '_ensureAudioPromise', void 0),
			(this.name = e),
			(this._volume = n),
