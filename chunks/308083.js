...
((o = r || (r = {}))[(o.GAMES = 0)] = 'GAMES'),
	(o[(o.PLAYSTYLE = 1)] = 'PLAYSTYLE'),
	(o[(o.UTILITY_TRAITS = 2)] = 'UTILITY_TRAITS'),
	(o[(o.INTERESTS = 3)] = 'INTERESTS'),
	(o[(o.DESCRIPTION = 4)] = 'DESCRIPTION'),
	(o[(o.CUSTOMIZE_TAG_BADGE = 5)] = 'CUSTOMIZE_TAG_BADGE'),
	(o[(o.CUSTOMIZE_BANNER = 6)] = 'CUSTOMIZE_BANNER'),
	(o[(o.MEMBER_APPLICATION = 7)] = 'MEMBER_APPLICATION');
...
function F(e, t) {
	...
	return _().sortBy(
		...
		(e) => {
			var t;
			return -(
				(((null == n ? void 0 : n.includes(e)) ? 1 : 0) << 4) |
				((((t = e), k.has(t) || V.has(t) || B.has(t)) ? 0 : 1) << 3) |
				((w.has(e) ? 1 : 0) << 2) |
				((x.includes(e) ? 1 : 0) << 1) |
				((G.includes(e) ? 1 : 0) << 0)
			);
...
((l = i || (i = {}))[(l.NIGHT_SKY = 0)] = 'NIGHT_SKY'),
	(l[(l.CASTLE = 1)] = 'CASTLE'),
	(l[(l.WORLD_MAP = 2)] = 'WORLD_MAP'),
	(l[(l.SEA_FOAM = 3)] = 'SEA_FOAM'),
	(l[(l.WARP_TUNNEL = 4)] = 'WARP_TUNNEL'),
	(l[(l.HOUSE = 5)] = 'HOUSE'),
	(l[(l.HEIGHTMAP = 6)] = 'HEIGHTMAP'),
	(l[(l.MESH = 7)] = 'MESH'),
	(l[(l.SPATTER = 8)] = 'SPATTER'),
	((u = a || (a = {})).BOULDER = 'Boulder'),
	(u.CASCADE = 'Cascade'),
	(u.THUNDER = 'Thunder'),
	(u.SOUL = 'Soul'),
	(u.MARSH = 'Marsh'),
...
let X = {
	...
	$ = new Map(
		[
			...
			'512699108809637890',
			'653432003798106122'
		].map((e, t, n) => [e, n.length - t])
	);
((c = s || (s = {}))[(c.SIZE_12 = 12)] = 'SIZE_12'),
	(c[(c.SIZE_16 = 16)] = 'SIZE_16'),
	(c[(c.SIZE_24 = 24)] = 'SIZE_24'),
	(c[(c.SIZE_32 = 32)] = 'SIZE_32'),
	(c[(c.SIZE_36 = 36)] = 'SIZE_36');
