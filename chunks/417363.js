...
let O = {},
	...
	U = !1;
function w(e) {
	return e.type === N.vxO.INSTALLING || e.type === N.vxO.UPDATING || e.type === N.vxO.REPAIRING
		? e.networkProgress
		: null;
}
function x(e) {
...
(o = 'DispatchApplicationStore'),
	...
	(t.Z = new H(d.Z, {
		...
		DISPATCH_APPLICATION_STATE_UPDATE: function (e) {
				...
				for (let t in r[e]) {
					...
					if (
						...
						if ((o > 0 && B((L += o)), i === t)) {
							...
							if (
								!0 !== e.paused &&
								(e.type === N.vxO.UNINSTALLING || e.type === N.vxO.INSTALLING || e.type === N.vxO.UPDATING)
							)
								switch (e.stage) {
									case N.f07.PATCHING:
			...
			!a && 'dispatch_application_progress' === E.Z.taskID && E.Z.clearProgress('dispatch_application_progress'),
				(O = n),
				(U = !0);
		}
	}));
