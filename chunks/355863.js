				...
				a.forEach((e) => {
					...
					if (
						(n.widgets.find((e) => {
							...
							return (
								null != n &&
								(null == a && n[1].type === I.Odu.VOICE && (a = n[0]),
								null == r && n[1].type === I.Odu.TEXT && (r = n[1].pinned),
		...
		LAYOUT_CREATE: function (e) {
			...
			n.forEach((e, t) => {
				...
				'' === o.id && (o.id = (0, c.Z)()),
					null != n &&
						((o.pinned = n.pinned),
						-1 !== n.anchor.left && (o.anchor = (0, p.jL)(n.anchor, a)),
						-1 !== n.size.width && (o.size = (0, p.Ox)(n.size, a))),
					(i = {
						...i,
						[o.id]: new h.Z(o)
					}),
