...
function I(e, t, n) {
	if (
		...
		(function (e, t) {
			return 0 === t
				? f.Z.can(h.Plq.MANAGE_CHANNELS, e) || f.Z.can(h.Plq.MANAGE_MESSAGES, e)
				: f.Z.can(h.Plq.MANAGE_THREADS, e);
		})(e, t) || n <= 0)
	)
		return;
	let r = n + Date.now();
				...
				for (let r of t) {
					...
					if (null != t && t.rateLimitPerUser !== i)
						I(
							r,
							e,
							Math.min(null !== (n = null == t ? void 0 : t.cooldownMs) && void 0 !== n ? n : 0, i * _.Z.Millis.SECOND)
						);
				}
			});
		},
