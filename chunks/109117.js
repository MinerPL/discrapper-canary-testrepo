		...
		l = (function (e, t, n) {
			...
			let O = {
				...
				renderer_crash_exit_code:
					null !== (d = null == n ? void 0 : n.rendererCrashExitCode) && void 0 !== d ? d : null,
				...
				last_memory_usage_kb:
					null !==
						(_ =
							null == n ? void 0 : null === (i = n.lastMemoryInformation) || void 0 === i ? void 0 : i.memoryUsageKB) &&
					void 0 !== _
						? _
						: null,
				last_used_js_heap_size_kb:
					null !==
						(E =
							null == n
								? void 0
								: null === (a = n.lastMemoryInformation) || void 0 === a
									? void 0
									: a.usedJSHeapSizeKB) && void 0 !== E
						? E
						: null,
				last_memory_usage_uptime:
					null !==
						(f =
							null == n ? void 0 : null === (s = n.lastMemoryInformation) || void 0 === s ? void 0 : s.uptimeSeconds) &&
					void 0 !== f
						? f
						: null,
				highest_memory_usage_kb:
					null !==
						(h =
							null == n
								? void 0
								: null === (o = n.highestMemoryInformation) || void 0 === o
									? void 0
									: o.memoryUsageKB) && void 0 !== h
						? h
						: null,
				highest_used_js_heap_size_kb:
					null !==
						(p =
							null == n
								? void 0
								: null === (l = n.highestMemoryInformation) || void 0 === l
									? void 0
									: l.usedJSHeapSizeKB) && void 0 !== p
						? p
						: null,
				highest_memory_usage_uptime:
					null !==
						(I =
							null == n
								? void 0
								: null === (u = n.highestMemoryInformation) || void 0 === u
									? void 0
									: u.uptimeSeconds) && void 0 !== I
						? I
						: null
			};
			if (!e || null == n)
			...
			return {
				...
				minidump_exception_module_name:
					null !== (T = null == R ? void 0 : R.exceptionModuleName) && void 0 !== T ? T : null,
				minidump_relative_crash_address:
					null !== (g = null == R ? void 0 : R.relativeCrashAddress) && void 0 !== g ? g : null,
				minidump_exception_module_version:
					null !== (S = null == R ? void 0 : R.exceptionModuleVersion) && void 0 !== S ? S : null,
				minidump_exception_module_code_id:
					null !== (A = null == R ? void 0 : R.exceptionModuleCodeId) && void 0 !== A ? A : null,
				...O
			};
		})(a, s, n);
	o.default.track(u.rMx.APP_NATIVE_CRASH, l),
		i.K.set(d, { lastId: null == n ? void 0 : n.id }),
		s && setTimeout(async () => await E(), 10000);
}
async function E() {
	var e, t;
	if (
		null !== (t = null === (e = s.default.getCurrentUser()) || void 0 === e ? void 0 : e.isStaff()) &&
		void 0 !== t &&
		t
	)
		try {
			await a.Z.getMediaEngine().writeAudioDebugState(),
				await (0, l.E)(u.GU0.RTC),
