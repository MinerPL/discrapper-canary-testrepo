...
let i = (e) => {
	...
	return (
		s.append('tf_12275088515223', 'field_value_dc_category_report_an_app_bot'),
		...
		s.append('tf_subject', 'App Directory Report '.concat(n, ' ').concat(t)),
		''.concat(a, '?').concat(s.toString())
	);
};
