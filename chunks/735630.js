		...
		(r = 4),
		{
			...
			debug: function (e, t) {
				void 0 === console.debug && (console.debug = console.log),
					1 >= r && console.debug('[' + i.getDurationString(new Date() - n, 1000) + ']', '[' + e + ']', t);
			},
			log: function (e, t) {
				this.debug(e.msg);
			},
...
(i.getDurationString = function (e, t) {
	...
	var r,
		...
		o = 1000 * (i -= 60 * s);
	return (
		(o -= 1000 * (i = Math.floor(i))),
		(o = Math.floor(o)),
		(r ? '-' : '') + a + ':' + n(s, 2) + ':' + n(i, 2) + '.' + n(o, 3)
	);
}),
...
var s = function (e, t, n) {
	(this._byteOffset = t || 0),
		...
		(this.position = 0),
		(this.endianness = null == n ? s.LITTLE_ENDIAN : n);
};
(s.prototype = {}),
	...
	(s.prototype.readInt32Array = function (e, t) {
		...
		return (
			s.memcpy(n.buffer, 0, this.buffer, this.byteOffset + this.position, e * n.BYTES_PER_ELEMENT),
			s.arrayToNative(n, null == t ? this.endianness : t),
	...
	(s.prototype.readInt8Array = function (e) {
		...
		return (
			s.memcpy(t.buffer, 0, this.buffer, this.byteOffset + this.position, e * t.BYTES_PER_ELEMENT),
	...
	(s.flipArrayEndianness = function (e) {
		for (
			var t = new Uint8Array(e.buffer, e.byteOffset, e.byteLength), n = 0;
			n < e.byteLength;
...
(t.DataStream = s),
	...
	(s.prototype.writeFloat64Array = function (e, t) {
		if (
			...
			e instanceof Float64Array && this.byteOffset + (this.position % e.BYTES_PER_ELEMENT) === 0)
		)
			s.memcpy(this._buffer, this.byteOffset + this.position, e.buffer, 0, e.byteLength),
	...
	(s.prototype.writeFloat32Array = function (e, t) {
		if (
			(this._realloc(4 * e.length),
			e instanceof Float32Array && this.byteOffset + (this.position % e.BYTES_PER_ELEMENT) === 0)
		)
			s.memcpy(this._buffer, this.byteOffset + this.position, e.buffer, 0, e.byteLength),
	...
	(s.prototype.writeType = function (e, t, n) {
		...
		switch (
			...
			'string' == typeof e && /,/.test(e) && ((e = (r = e.split(','))[0]), (a = parseInt(r[1]))),
			e)
		) {
			case 'uint8':
				this.writeUint8(t);
...
(o.prototype = new s(new ArrayBuffer(), 0, s.BIG_ENDIAN)),
	(o.prototype.initialized = function () {
		...
		return 0 === (e = this.buffers[0]).fileStart
			? ((this.buffer = e), (this.bufferIndex = 0), i.debug('MultiBufferStream', 'Stream ready for parsing'), !0)
			: (i.warn('MultiBufferStream', 'The first buffer should have a fileStart of 0'), this.logBufferLevel(), !1);
	}),
	...
	(o.prototype.reduceBuffer = function (e, t, n) {
		var r;
		return (
			(r = new Uint8Array(n)).set(new Uint8Array(e, t, n)),
		...
		for (var t = !0, n = 0; n < this.buffers.length; n++) {
			...
			if (e.fileStart <= r.fileStart) {
				if (e.fileStart === r.fileStart) {
					...
					i.warn(
						'MultiBufferStream',
						'Buffer (fileStart: ' + e.fileStart + ' - Length: ' + e.byteLength + ') already appended, ignoring'
					);
				} else
					e.fileStart + e.byteLength <= r.fileStart || (e = this.reduceBuffer(e, 0, r.fileStart - e.fileStart)),
						i.debug(
							'MultiBufferStream',
	...
	(o.prototype.logBufferLevel = function (e) {
			...
			(n = this.buffers[t]),
				0 === t
					? ((s = {}),
						o.push(s),
						(s.start = n.fileStart),
						(s.end = n.fileStart + n.byteLength),
						(l += '[' + s.start + '-'))
					: s.end === n.fileStart
						? (s.end = n.fileStart + n.byteLength)
						: (((s = {}).start = n.fileStart),
							(l += o[o.length - 1].end - 1 + '], [' + s.start + '-'),
							(s.end = n.fileStart + n.byteLength),
							o.push(s)),
				(r += n.usedBytes),
				(a += n.byteLength);
		...
		u(
			...
			0 === this.buffers.length
				...
				: '' + this.buffers.length + ' stored buffer(s) (' + r + '/' + a + ' bytes), continuous ranges: ' + l
		);
	}),
	(o.prototype.cleanBuffers = function () {
		...
		for (e = 0; e < this.buffers.length; e++)
			(t = this.buffers[e]).usedBytes === t.byteLength &&
				(i.debug('MultiBufferStream', 'Removing buffer #' + e), this.buffers.splice(e, 1), e--);
	}),
	(o.prototype.mergeNextBuffer = function () {
		...
		return (
			...
			i.debug('ISOFile', 'Concatenating buffer for box parsing (length: ' + t + '->' + this.buffer.byteLength + ')'),
			!0
		);
	}),
	(o.prototype.findPosition = function (e, t, n) {
		...
		for (r = !0 === e ? 0 : this.bufferIndex; r < this.buffers.length && (a = this.buffers[r]).fileStart <= t; ) {
			(s = r),
				n &&
					(a.fileStart + a.byteLength <= t ? (a.usedBytes = a.byteLength) : (a.usedBytes = t - a.fileStart),
					this.logBufferLevel());
			r++;
		}
		return -1 === s
			? -1
			: (a = this.buffers[s]).fileStart + a.byteLength >= t
				? (i.debug('MultiBufferStream', 'Found position in existing buffer #' + s), s)
				: -1;
	}),
	...
	(o.prototype.seek = function (e, t, n) {
		var r;
		return -1 !== (r = this.findPosition(t, e, n))
			? ((this.buffer = this.buffers[r]),
				(this.bufferIndex = r),
				(this.position = e - this.buffer.fileStart),
				i.debug('MultiBufferStream', 'Repositioning parser at buffer position: ' + this.position),
				!0)
			: (i.debug('MultiBufferStream', 'Position ' + e + ' not found in buffered data'), !1);
	}),
		...
		(this.parseOneDescriptor = function (t) {
			...
			return (
				...
				i.debug(
					...
					'Found ' + (e[r] || 'Descriptor ' + r) + ', size ' + l + ' at position ' + t.getPosition()
				),
				(a = e[r] ? new n[e[r]](l) : new n.Descriptor(l)).parse(t),
				a
			);
		}),
	...
	createUUIDBox: function (e, t, n, r) {
		u.UUIDs.push(e),
			(u.UUIDBoxes[e] = function (r) {
				t
					? u.FullBox.call(this, 'uuid', r, e)
					: n
						? u.ContainerBox.call(this, 'uuid', r, e)
						: u.Box.call(this, 'uuid', r, e);
			}),
...
(t.BoxParser = u),
	...
	(u.parseOneBox = function (e, t, n) {
		...
		if (e.getEndPosition() - o < 8)
			return (
				i.debug('BoxParser', 'Not enough data in stream to parse the type and size of the box'),
				{ code: u.ERR_NOT_ENOUGH_DATA }
			);
		if (n && n < 8)
			return (
				i.debug('BoxParser', 'Not enough bytes left in the parent box to parse a new box'),
				{ code: u.ERR_NOT_ENOUGH_DATA }
			);
		var c = e.readUint32(),
			d = e.readString(4),
			_ = d;
		if (
			(i.debug('BoxParser', "Found box of type '" + d + "' and size " + c + ' at position ' + o), (l = 8), 'uuid' == d)
		) {
			if (e.getEndPosition() - e.getPosition() < 16 || n - l < 16)
				return (
					e.seek(o),
					i.debug('BoxParser', 'Not enough bytes left in the parent box to parse a UUID box'),
					{ code: u.ERR_NOT_ENOUGH_DATA }
				);
		...
		if (1 == c) {
			if (e.getEndPosition() - e.getPosition() < 8 || (n && n - l < 8))
				return (
					e.seek(o),
					i.warn('BoxParser', 'Not enough data in stream to parse the extended size of the "' + d + '" box'),
					{ code: u.ERR_NOT_ENOUGH_DATA }
				);
			(c = e.readUint64()), (l += 8);
		} else if (0 === c) {
				...
				: 0 !== c && o + c > e.getEndPosition()
					...
					: t
						...
						: (u[d + 'Box']
								? (r = new u[d + 'Box'](c))
								: 'uuid' !== d
									? (i.warn('BoxParser', "Unknown box type: '" + d + "'"),
										((r = new u.Box(d, c)).has_unparsed_data = !0))
									: u.UUIDBoxes[s]
										? (r = new u.UUIDBoxes[s](c))
										: (i.warn('BoxParser', "Unknown uuid type: '" + s + "'"),
											((r = new u.Box(d, c)).uuid = s),
							...
							r.write === u.Box.prototype.write &&
								...
								(i.info(
									'BoxParser',
									"'" + _ + "' box writing not yet implemented, keeping unparsed data in memory for later write"
								),
								r.parseDataAndRewind(e)),
							r.parse(e),
							(a = e.getPosition() - (r.start + r.size)) < 0
								? (i.warn(
										'BoxParser',
										"Parsing of box '" +
											_ +
	...
	u.createBoxCtor('colr', function (e) {
		if (((this.colour_type = e.readString(4)), 'nclx' === this.colour_type)) {
			...
			'rICC' === this.colour_type
				...
				: 'prof' === this.colour_type && (this.ICC_profile = e.readUint8Array(this.size - 4));
	}),
		...
		if (((t = e.readUint32()), (this.sample_counts = []), (this.sample_offsets = []), 0 === this.version))
			for (n = 0; n < t; n++) {
				...
				var t,
					n,
					r = e.readInt32();
				r < 0 && i.warn('BoxParser', 'ctts box uses negative values without using version 1'),
	...
	u.createBoxCtor('dac3', function (e) {
		...
		(this.fscod = t >> 6),
			(this.bsid = (t >> 1) & 31),
			(this.bsmod = ((1 & t) << 2) | ((n >> 6) & 3)),
			(this.acmod = (n >> 3) & 7),
			(this.lfeon = (n >> 2) & 1),
			(this.bit_rate_code = (3 & n) | ((r >> 5) & 7));
	}),
	u.createBoxCtor('dec3', function (e) {
		...
		for (var n = 0; n < this.num_ind_sub + 1; n++) {
			...
			(r.fscod = i >> 6),
				(r.bsid = (i >> 1) & 31),
				(r.bsmod = ((1 & i) << 4) | ((a >> 4) & 15)),
				(r.acmod = (a >> 1) & 7),
				(r.lfeon = 1 & a),
				(r.num_dep_sub = (s >> 1) & 15),
				r.num_dep_sub > 0 && (r.chan_loc = ((1 & s) << 8) | e.readUint8());
		}
	}),
		...
		for (this.parseFullHeader(e); ; ) {
			...
			if (
				(i
					...
					: (e.readUint8Array(13), (this.samplerate = e.readUint32() >> 12), e.readUint8Array(20)),
				t.push(n[i]),
				128 & r)
			)
				break;
	...
	u.createFullBoxCtor('elst', function (e) {
		...
		for (var t = e.readUint32(), n = 0; n < t; n++) {
			...
			this.entries.push(r),
				1 === this.version
					? ((r.segment_duration = e.readUint64()), (r.media_time = e.readInt64()))
					: ((r.segment_duration = e.readUint32()), (r.media_time = e.readInt32())),
	...
	u.createFullBoxCtor('iinf', function (e) {
		var t;
		0 === this.version ? (this.entry_count = e.readUint16()) : (this.entry_count = e.readUint32()),
			(this.item_infos = []);
		for (var n = 0; n < this.entry_count; n++) {
			if ((t = u.parseOneBox(e, !1, this.size - (e.getPosition() - this.start))).code !== u.OK) return;
			'infe' !== t.box.type && i.error('BoxParser', "Expected 'infe' box, got " + t.box.type),
				(this.item_infos[n] = t.box);
		}
	}),
		...
		for (var r = 0; r < n; r++) {
			...
			switch (
				(1 === this.version || 2 === this.version
					? (i.construction_method = 15 & e.readUint16())
					: (i.construction_method = 0),
				(i.data_reference_index = e.readUint16()),
	...
	u.createFullBoxCtor('infe', function (e) {
		if (
			...
			(this.extension_type = e.readString(4)),
				i.warn('BoxParser', 'Cannot parse extension type'),
				e.seek(this.start + this.size);
			return;
		}
		this.version >= 2 &&
		...
		for (t = 0, entry_count = e.readUint32(), this.associations = []; t < entry_count; t++) {
			...
			for (n = 0, r.props = []; n < i; n++) {
				var a = e.readUint8(),
					s = {};
				r.props.push(s),
					(s.essential = (128 & a) >> 7 == 1),
					1 & this.flags ? (s.property_index = ((127 & a) << 8) | e.readUint8()) : (s.property_index = 127 & a);
			}
		}
	}),
	u.createFullBoxCtor('iref', function (e) {
		...
		for (this.references = []; e.getPosition() < this.start + this.size; ) {
			...
			(n =
				0 === this.version
					? new u.SingleItemTypeReferenceBox(t.type, t.size, t.hdr_size, t.start)
					: new u.SingleItemTypeReferenceBoxLarge(t.type, t.size, t.hdr_size, t.start)).write ===
				u.Box.prototype.write &&
				'mdat' !== n.type &&
				(i.warn(
					'BoxParser',
					n.type + ' box writing not yet implemented, keeping unparsed data in memory for later write'
				),
	...
	u.createFullBoxCtor('mehd', function (e) {
		1 & this.flags &&
			(i.warn('BoxParser', 'mehd box incorrectly uses flags set to 1, converting version to 1'), (this.version = 1)),
	...
	u.createSampleGroupCtor('avss', function (e) {
		...
		for (var n = e.readUint8(), r = 0; r < n; r++) {
			var i = {};
			this.dependency.push(i),
				(i.subSeqDirectionFlag = e.readUint8()),
				(i.layerNumber = e.readUint8()),
				(i.subSequenceIdentifier = e.readUint16());
		}
	}),
	...
	u.createSampleGroupCtor('rash', function (e) {
		if (
			...
			i.warn('BoxParser', 'Mismatch in ' + this.grouping_type + ' sample group length'),
	...
	(u.SampleGroupEntry.prototype.parse = function (e) {
		i.warn('BoxParser', 'Unknown Sample Group type: ' + this.grouping_type),
	...
	u.createFullBoxCtor('sgpd', function (e) {
		(this.grouping_type = e.readString(4)),
			i.debug('BoxParser', 'Found Sample Groups of type ' + this.grouping_type),
		...
		for (var t, n = e.readUint32(), r = 0; r < n; r++)
			(t = u[this.grouping_type + 'SampleGroupEntry']
				...
				1 === this.version && 0 === this.default_length
					? (t.description_length = e.readUint32())
					: (t.description_length = this.default_length),
				t.write === u.SampleGroupEntry.prototype.write &&
					(i.info(
						'BoxParser',
					...
					(t.data = e.readUint8Array(t.description_length)),
					(e.position -= t.description_length)),
				t.parse(e);
	}),
	u.createFullBoxCtor('sidx', function (e) {
		...
		for (var t = e.readUint16(), n = 0; n < t; n++) {
			...
			var i = e.readUint32();
			(r.reference_type = (i >> 31) & 1),
				(r.referenced_size = 2147483647 & i),
				(r.subsegment_duration = e.readUint32()),
				(i = e.readUint32()),
				(r.starts_with_SAP = (i >> 31) & 1),
				(r.SAP_type = (i >> 28) & 7),
				(r.SAP_delta_time = 268435455 & i);
		}
	}),
	...
	u.createFullBoxCtor('stsd', function (e) {
		...
		for (t = 1, this.entries = [], r = e.readUint32(); t <= r; t++) {
			...
			u[n.type + 'SampleEntry']
				? (((a = new u[n.type + 'SampleEntry'](n.size)).hdr_size = n.hdr_size), (a.start = n.start))
				: (i.warn('BoxParser', 'Unknown sample entry type: ' + n.type),
					(a = new u.SampleEntry(n.type, n.size, n.hdr_size, n.start))),
				a.write === u.SampleEntry.prototype.write &&
					(i.info(
						'BoxParser',
						'SampleEntry ' +
							a.type +
	...
	u.createFullBoxCtor('stsh', function (e) {
		var t, n;
		if (
			((t = e.readUint32()), (this.shadowed_sample_numbers = []), (this.sync_sample_numbers = []), 0 === this.version)
		)
			for (n = 0; n < t; n++)
	...
	u.createFullBoxCtor('stts', function (e) {
		...
		if (((t = e.readUint32()), (this.sample_counts = []), (this.sample_deltas = []), 0 === this.version))
			for (n = 0; n < t; n++)
				this.sample_counts.push(e.readUint32()),
					(r = e.readInt32()) < 0 &&
						(i.warn('BoxParser', 'File uses negative stts sample delta, using value 1 instead, sync may be lost!'),
						(r = 1)),
		...
		for (t = 0, r = e.readUint32(), this.entries = []; t < r; t++) {
			...
			if (((this.entries[t] = a), (a.sample_delta = e.readUint32()), (a.subsamples = []), (i = e.readUint16()) > 0))
				for (n = 0; n < i; n++) {
					var s = {};
					a.subsamples.push(s),
						1 == this.version ? (s.size = e.readUint32()) : (s.size = e.readUint16()),
						(s.priority = e.readUint8()),
						(s.discardable = e.readUint8()),
						(s.codec_specific_parameters = e.readUint32());
				}
		}
	}),
	u.createFullBoxCtor('tenc', function (e) {
		...
		(this.default_isProtected = e.readUint8()),
			...
			(this.default_KID = u.parseHex16(e)),
	...
	u.createFullBoxCtor('tfhd', function (e) {
		...
		(this.track_id = e.readUint32()),
			this.size - this.hdr_size > t && this.flags & u.TFHD_FLAG_BASE_DATA_OFFSET
				? ((this.base_data_offset = e.readUint64()), (t += 8))
				: (this.base_data_offset = 0),
			this.size - this.hdr_size > t && this.flags & u.TFHD_FLAG_SAMPLE_DESC
				? ((this.default_sample_description_index = e.readUint32()), (t += 4))
				: (this.default_sample_description_index = 0),
			this.size - this.hdr_size > t && this.flags & u.TFHD_FLAG_SAMPLE_DUR
				? ((this.default_sample_duration = e.readUint32()), (t += 4))
				: (this.default_sample_duration = 0),
			this.size - this.hdr_size > t && this.flags & u.TFHD_FLAG_SAMPLE_SIZE
				? ((this.default_sample_size = e.readUint32()), (t += 4))
				: (this.default_sample_size = 0),
			this.size - this.hdr_size > t && this.flags & u.TFHD_FLAG_SAMPLE_FLAGS
	...
	(u.trefBox.prototype.parse = function (e) {
		for (var t, n; e.getPosition() < this.start + this.size; ) {
			if ((t = u.parseOneBox(e, !0, this.size - (e.getPosition() - this.start))).code !== u.OK) return;
			(n = new u.TrackReferenceTypeBox(t.type, t.size, t.hdr_size, t.start)).write === u.Box.prototype.write &&
				'mdat' !== n.type &&
				(i.info(
					'BoxParser',
					'TrackReference ' +
	...
	u.createFullBoxCtor('trun', function (e) {
		...
		if (
			...
			(t += 4),
			this.size - this.hdr_size > t && this.flags & u.TRUN_FLAGS_DATA_OFFSET
				? ((this.data_offset = e.readInt32()), (t += 4))
				: (this.data_offset = 0),
			this.size - this.hdr_size > t && this.flags & u.TRUN_FLAGS_FIRST_FLAG
			...
			for (var n = 0; n < this.sample_count; n++)
				this.flags & u.TRUN_FLAGS_DURATION && (this.sample_duration[n] = e.readUint32()),
					this.flags & u.TRUN_FLAGS_SIZE && (this.sample_size[n] = e.readUint32()),
					this.flags & u.TRUN_FLAGS_FLAGS && (this.sample_flags[n] = e.readUint32()),
	...
	u.createUUIDBox('d4807ef2ca3946958e5426cb9e46a79f', !0, !1, function (e) {
		...
		for (var t = 0; t < this.fragment_count; t++) {
			var n = {},
				r = 0,
				i = 0;
			1 === this.version ? ((r = e.readUint64()), (i = e.readUint64())) : ((r = e.readUint32()), (i = e.readUint32())),
				(n.absolute_time = r),
				(n.absolute_duration = i),
				this.entries.push(n);
		}
	}),
	...
	(u.hev1SampleEntry.prototype.getCodec = u.hvc1SampleEntry.prototype.getCodec =
		function () {
			...
			if (this.hvcC) {
				...
				(t += u.decimalToHex(r, 0) + '.'),
					0 === this.hvcC.general_tier_flag ? (t += 'L') : (t += 'H'),
					(t += this.hvcC.general_level_idc);
				var i = !1,
					a = '';
				for (e = 5; e >= 0; e--)
					(this.hvcC.general_constraint_indicator[e] || i) &&
						((a = '.' + u.decimalToHex(this.hvcC.general_constraint_indicator[e], 0) + a), (i = !0));
				t += a;
			}
			return t;
		}),
			...
			if (this.vvcC) {
				...
				if (this.vvcC.general_constraint_info) {
					var n,
						...
						a = [];
					for (
						r = 0, n = 0 | (this.vvcC.ptl_frame_only_constraint << 7) | (this.vvcC.ptl_multilayer_enabled << 6);
						r < this.vvcC.general_constraint_info.length;
						++r
					)
						(n |= (this.vvcC.general_constraint_info[r] >> 2) & 63),
							a.push(n),
							n && (i = r),
							(n = (this.vvcC.general_constraint_info[r] >> 2) & 3);
					if (void 0 === i) t = '.CA';
					else {
						t = '.C';
						var s = 'ABCDEFGHIJKLMNOPQRSTUVWXYZ234567',
							...
							l = 0;
						for (r = 0; r <= i; ++r)
							for (o = (o << 8) | a[r], l += 8; l >= 5; ) (t += s[(o >> (l - 5)) & 31]), (l -= 5), (o &= (1 << l) - 1);
						l && ((o <<= 5 - l), (t += s[31 & o]));
					}
				}
				e += t;
	...
	(u.av01SampleEntry.prototype.getCodec = function () {
		...
		return (
			...
			t + '.' + this.av1C.seq_profile + '.' + n + (this.av1C.seq_tier_0 ? 'H' : 'M') + '.' + e
		);
	}),
	(u.Box.prototype.writeHeader = function (e, t) {
		(this.size += 8),
			...
			i.debug(
				'BoxWriter',
				'Writing box ' + this.type + ' of size: ' + this.size + ' at position ' + e.getPosition() + (t || '')
			),
			this.size > 4294967296 ? e.writeUint32(1) : ((this.sizePosition = e.getPosition()), e.writeUint32(this.size)),
			e.writeString(this.type, null, 4),
			'uuid' === this.type && e.writeUint8Array(this.uuid),
			this.size > 4294967296 && e.writeUint64(this.size);
	}),
	(u.FullBox.prototype.writeHeader = function (e) {
		(this.size += 4),
			u.Box.prototype.writeHeader.call(this, e, ' v=' + this.version + ' f=' + this.flags),
	...
	(u.ContainerBox.prototype.write = function (e) {
		...
		i.debug('BoxWriter', 'Adjusting box ' + this.type + ' with new size ' + this.size),
	...
	(u.cttsBox.prototype.write = function (e) {
		...
		for (
			...
			e.writeUint32(this.sample_counts[t]),
				1 === this.version ? e.writeInt32(this.sample_offsets[t]) : e.writeUint32(this.sample_offsets[t]);
	}),
	...
	(u.SampleEntry.prototype.writeHeader = function (e) {
		(this.size = 8),
			u.Box.prototype.writeHeader.call(this, e),
			e.writeUint8(0),
			e.writeUint8(0),
			e.writeUint8(0),
			e.writeUint8(0),
	...
	(u.sgpdBox.prototype.write = function (e) {
		...
		for (t = 0, this.flags = 0, this.size = 12; t < this.entries.length; t++)
			(n = this.entries[t]),
				1 === this.version && (0 === this.default_length && (this.size += 4), (this.size += n.data.length));
		for (
			this.writeHeader(e),
				e.writeString(this.grouping_type, null, 4),
			...
			(n = this.entries[t]),
				1 === this.version && 0 === this.default_length && e.writeUint32(n.description_length),
				n.write(e);
	}),
	(u.sidxBox.prototype.write = function (e) {
		...
		for (var t = 0; t < this.references.length; t++) {
			...
			e.writeUint32((n.reference_type << 31) | n.referenced_size),
				...
				e.writeUint32((n.starts_with_SAP << 31) | (n.SAP_type << 28) | n.SAP_delta_time);
		}
	}),
	...
	(u.tfhdBox.prototype.write = function (e) {
		(this.version = 0),
			...
			this.flags & u.TFHD_FLAG_BASE_DATA_OFFSET && e.writeUint64(this.base_data_offset),
			this.flags & u.TFHD_FLAG_SAMPLE_DESC && e.writeUint32(this.default_sample_description_index),
			this.flags & u.TFHD_FLAG_SAMPLE_DUR && e.writeUint32(this.default_sample_duration),
			this.flags & u.TFHD_FLAG_SAMPLE_SIZE && e.writeUint32(this.default_sample_size),
			this.flags & u.TFHD_FLAG_SAMPLE_FLAGS && e.writeUint32(this.default_sample_flags);
	}),
	...
	(u.trunBox.prototype.write = function (e) {
		(this.version = 0),
			...
			this.flags & u.TRUN_FLAGS_FIRST_FLAG && e.writeUint32(this.first_sample_flags);
		for (var t = 0; t < this.sample_count; t++)
			this.flags & u.TRUN_FLAGS_DURATION && e.writeUint32(this.sample_duration[t]),
				this.flags & u.TRUN_FLAGS_SIZE && e.writeUint32(this.sample_size[t]),
				this.flags & u.TRUN_FLAGS_FLAGS && e.writeUint32(this.sample_flags[t]),
				this.flags & u.TRUN_FLAGS_CTS_OFFSET &&
					(0 === this.version
			...
			if (!(u.DIFF_BOXES_PROP_NAMES.indexOf(n) > -1))
				if (e[n] instanceof u.Box || t[n] instanceof u.Box) continue;
					...
					if (
						...
						(t.subBoxNames && t.subBoxNames.indexOf(n.slice(0, 4)) > -1)
					)
						continue;
...
d.prototype.parseSample = function (e) {
	...
	return (
		'undefined' != typeof DOMParser &&
			(n.document = new DOMParser().parseFromString(n.documentString, 'application/xml')),
		n
	);
};
var _ = function () {};
...
(E.prototype.setSegmentOptions = function (e, t, n) {
	...
	if (r) {
		...
		this.fragmentedTracks.push(i),
			...
			(i.nb_samples = 1000),
			(i.rapAlignement = !0),
			n && (n.nbSamples && (i.nb_samples = n.nbSamples), n.rapAlignement && (i.rapAlignement = n.rapAlignement));
	}
}),
	...
	(E.prototype.setExtractionOptions = function (e, t, n) {
		...
		if (r) {
			...
			this.extractedTracks.push(i),
				...
				(i.nb_samples = 1000),
				(i.samples = []),
				n && n.nbSamples && (i.nb_samples = n.nbSamples);
		}
	}),
		...
		if (!this.restoreParsePosition || !!this.restoreParsePosition())
			for (;;) {
				...
				if (
					...
					(e = u.parseOneBox(this.stream, !1)).code === u.ERR_NOT_ENOUGH_DATA)
				) {
				...
				switch (((n = 'uuid' !== (t = e.box).type ? t.type : t.uuid), this.boxes.push(t), n)) {
					...
					default:
						void 0 !== this[n] && i.warn('ISOFile', 'Duplicate Box of type: ' + n + ', overriding previous occurrence'),
							(this[n] = t);
				}
	...
	(E.prototype.checkBuffer = function (e) {
		...
		return 0 === e.byteLength
			? (i.warn('ISOFile', 'Ignoring empty buffer (fileStart: ' + e.fileStart + ')'), this.stream.logBufferLevel(), !1)
			: (i.info('ISOFile', 'Processing buffer (fileStart: ' + e.fileStart + ')'),
				(e.usedBytes = 0),
				this.stream.insertBuffer(e),
				this.stream.logBufferLevel(),
				!!this.stream.initialized() || (i.warn('ISOFile', 'Not ready to start parsing'), !1));
	}),
		...
		if (!!this.checkBuffer(e))
			return (
				...
				this.moov
					? (!this.sampleListBuilt && (this.buildSampleLists(), (this.sampleListBuilt = !0)),
						...
						this.nextSeekPosition
							? ((n = this.nextSeekPosition), (this.nextSeekPosition = void 0))
							: (n = this.nextParsePosition),
						this.stream.getEndFilePositionAfter && (n = this.stream.getEndFilePositionAfter(n)))
					: (n = this.nextParsePosition ? this.nextParsePosition : 0),
				...
				this.stream.cleanBuffers &&
					...
					i.info('ISOFile', 'Sample data size in memory: ' + this.getAllocatedSampleDataSize())),
				n
			);
	}),
		...
		if (this.moov)
			for (
				s.hasMoov = !0,
					...
					s.isFragmented = null != this.moov.mvex,
					s.isFragmented && this.moov.mvex.mehd && (s.fragment_duration = this.moov.mvex.mehd.fragment_duration),
					s.isProgressive = this.isProgressive,
					s.hasIOD = null != this.moov.iods,
					s.brands = [],
					s.brands.push(this.ftyp.major_brand),
					s.brands = s.brands.concat(this.ftyp.compatible_brands),
					s.created = new Date(o + 1000 * this.moov.mvhd.creation_time),
					s.modified = new Date(o + 1000 * this.moov.mvhd.modification_time),
					s.tracks = [],
					s.audioTracks = [],
					s.videoTracks = [],
					s.subtitleTracks = [],
				...
				if (
					((a = (n = this.moov.traks[e]).mdia.minf.stbl.stsd.entries[0]),
					(r = {}),
					s.tracks.push(r),
					(r.id = n.tkhd.track_id),
				...
				n.edts && (r.edits = n.edts.elst.entries),
					...
					a.isAudio()
						...
						: a.isVideo()
							? ((r.type = 'video'),
								s.videoTracks.push(r),
								(r.video = {}),
								(r.video.width = a.getWidth()),
								(r.video.height = a.getHeight()))
							: a.isSubtitle()
								? ((r.type = 'subtitles'), s.subtitleTracks.push(r))
								: a.isHint()
									? ((r.type = 'metadata'), s.hintTracks.push(r))
									: a.isMetadata()
										? ((r.type = 'metadata'), s.metadataTracks.push(r))
										: ((r.type = 'metadata'), s.otherTracks.push(r));
			}
		else s.hasMoov = !1;
			...
			if (this.isFragmentationInitialized && null !== this.onSegment)
				for (t = 0; t < this.fragmentedTracks.length; t++) {
					...
					for (n = r.trak; n.nextSample < n.samples.length && this.sampleProcessingStarted; ) {
						...
						if (
							(n.nextSample % r.nb_samples == 0 || e || n.nextSample >= n.samples.length) &&
							(i.info(
								'ISOFile',
								'Sending fragmented data on track #' +
									r.id +
									' for samples [' +
									Math.max(0, n.nextSample - r.nb_samples) +
									',' +
									(n.nextSample - 1) +
									']'
							),
			...
			if (null !== this.onSamples)
				for (t = 0; t < this.extractedTracks.length; t++) {
					...
					for (n = s.trak; n.nextSample < n.samples.length && this.sampleProcessingStarted; ) {
						...
						if (
							(n.nextSample % s.nb_samples == 0 || n.nextSample >= n.samples.length) &&
							(i.debug('ISOFile', 'Sending samples on track #' + s.id + ' for sample ' + n.nextSample),
	...
	(E.prototype.flush = function () {
		i.info('ISOFile', 'Flushing remaining samples'),
			this.updateSampleLists(),
	...
	(E.prototype.seekTrack = function (e, t, n) {
		...
		for (
			t && (u = l), e = n.samples[u].cts, n.nextSample = u;
			n.samples[u].alreadyRead === n.samples[u].size && n.samples[u + 1];
	...
	(E.prototype.seek = function (e, t) {
		...
		if (this.moov) {
			for (a = 0; a < s.traks.length; a++)
				(n = s.traks[a]),
					(r = this.seekTrack(e, t, n)).offset < o.offset && (o.offset = r.offset),
					r.time < o.time && (o.time = r.time);
			return (
				i.info(
					'ISOFile',
					'Seeking at time ' +
						i.getDurationString(o.time, 1) +
...
(t.ISOFile = E),
	...
	(E.prototype.processIncompleteBox = function (e) {
		var t;
		if ('mdat' === e.type)
			return ((t = new u[e.type + 'Box'](e.size)),
			(this.parsingMdat = t),
			this.boxes.push(t),
			this.mdats.push(t),
			(t.start = e.start),
			...
			this.stream.seek(t.start + t.size, !1, this.discardMdatData))
				...
				: (this.moovStartFound
					...
					!1);
		return ('moov' === e.type && ((this.moovStartFound = !0), 0 === this.mdats.length && (this.isProgressive = !0)),
	...
	(E.prototype.processIncompleteMdat = function () {
		var e;
		return ((e = this.parsingMdat), this.stream.seek(e.start + e.size, !1, this.discardMdatData))
			? (i.debug('ISOFile', "Found 'mdat' end in buffered data"), (this.parsingMdat = null), !0)
	...
	(E.prototype.addSample = function (e, t, n) {
		...
		if (null !== a) {
			(i.number = a.samples.length),
				(i.track_id = a.tkhd.track_id),
				(i.timescale = a.mdia.mdhd.timescale),
				(i.description_index = r.sample_description_index ? r.sample_description_index - 1 : 0),
				(i.description = a.mdia.minf.stbl.stsd.entries[i.description_index]),
				(i.data = t),
				(i.size = t.byteLength),
				...
				a.samples.push(i),
				(a.samples_size += i.size),
				(a.samples_duration += i.duration),
				!a.first_dts && (a.first_dts = r.dts),
				this.processSamples();
			var s = this.createSingleSampleMoof(i);
			return (
				this.addBox(s),
				s.computeSize(),
				(s.trafs[0].truns[0].data_offset = s.size + 8),
	...
	(E.prototype.resetTables = function () {
		for (
			e = 0, this.initial_duration = this.moov.mvhd.duration, this.moov.mvhd.duration = 0;
			e < this.moov.traks.length;
			e++
		) {
			((t = this.moov.traks[e]).tkhd.duration = 0),
				...
				((n = t.mdia.minf.stbl.stsc).first_chunk = []),
				(n.samples_per_chunk = []),
	...
	(E.initSampleGroups = function (e, t, n, r, i) {
		...
		for (
			t && (t.sample_groups_info = []), !e.sample_groups_info && (e.sample_groups_info = []), s = 0;
			s < n.length;
			s++
		) {
			for (
				l = n[s].grouping_type + '/' + n[s].grouping_type_parameter,
					o = new u(n[s].grouping_type, n[s].grouping_type_parameter, n[s]),
			...
			if (i)
				for (a = 0; a < i.length; a++)
					i[a].grouping_type === n[s].grouping_type &&
						((o.fragment_description = i[a]), (o.fragment_description.used = !0), (o.is_fragment = !0));
		}
		if (t) {
			if (i)
				for (s = 0; s < i.length; s++)
					!i[s].used &&
						i[s].version >= 2 &&
						((l = i[s].grouping_type + '/0'),
						((o = new u(i[s].grouping_type, 0)).is_fragment = !0),
						!t.sample_groups_info[l] && (t.sample_groups_info[l] = o));
		} else
			for (s = 0; s < r.length; s++)
				!r[s].used &&
					r[s].version >= 2 &&
					((l = r[s].grouping_type + '/0'),
					(o = new u(r[s].grouping_type, 0)),
					!e.sample_groups_info[l] && (e.sample_groups_info[l] = o));
	}),
	(E.setSampleGroupProperties = function (e, t, n, r) {
		...
		for (i in ((t.sample_groups = []), r))
			(t.sample_groups[i] = {}),
				(t.sample_groups[i].grouping_type = r[i].grouping_type),
				(t.sample_groups[i].grouping_type_parameter = r[i].grouping_type_parameter),
				n >= r[i].last_sample_in_run &&
					(r[i].last_sample_in_run < 0 && (r[i].last_sample_in_run = 0),
					r[i].entry_index++,
					r[i].entry_index <= r[i].sbgp.entries.length - 1 &&
						(r[i].last_sample_in_run += r[i].sbgp.entries[r[i].entry_index].sample_count)),
				r[i].entry_index <= r[i].sbgp.entries.length - 1
					? (t.sample_groups[i].group_description_index = r[i].sbgp.entries[r[i].entry_index].group_description_index)
					: (t.sample_groups[i].group_description_index = -1),
				0 !== t.sample_groups[i].group_description_index &&
					((s = r[i].fragment_description ? r[i].fragment_description : r[i].description),
					t.sample_groups[i].group_description_index > 0
						? ((a =
								t.sample_groups[i].group_description_index > 65535
									? (t.sample_groups[i].group_description_index >> 16) - 1
									: t.sample_groups[i].group_description_index - 1),
							s && a >= 0 && (t.sample_groups[i].description = s.entries[a]))
						: s &&
							s.version >= 2 &&
							s.default_group_description_index > 0 &&
							(t.sample_groups[i].description = s.entries[s.default_group_description_index - 1]));
	}),
	(E.process_sdtp = function (e, t, n) {
		if (!!t)
			e
				? ((t.is_leading = e.is_leading[n]),
					(t.depends_on = e.sample_depends_on[n]),
					(t.is_depended_on = e.sample_is_depended_on[n]),
					(t.has_redundancy = e.sample_has_redundancy[n]))
		...
		if (
			...
			for (t = 0; t < i.sample_sizes.length; t++) {
				var t,
					...
					R = {};
				(R.number = t),
					(R.track_id = e.tkhd.track_id),
					(R.timescale = e.mdia.mdhd.timescale),
					(R.alreadyRead = 0),
					(e.samples[t] = R),
					(R.size = i.sample_sizes[t]),
					(e.samples_size += R.size),
					0 === t
						? ((h = 1),
							(f = 0),
							(R.chunk_index = h),
							(R.chunk_run_index = f),
							(m = r.samples_per_chunk[f]),
							(I = 0),
							(p = f + 1 < r.first_chunk.length ? r.first_chunk[f + 1] - 1 : 1 / 0))
						: t < m
							? ((R.chunk_index = h), (R.chunk_run_index = f))
							: (h++,
								(R.chunk_index = h),
								(I = 0),
								h <= p || (p = ++f + 1 < r.first_chunk.length ? r.first_chunk[f + 1] - 1 : 1 / 0),
								(R.chunk_run_index = f),
								(m += r.samples_per_chunk[f])),
					(R.description_index = r.sample_description_index[R.chunk_run_index] - 1),
					(R.description = l.entries[R.description_index]),
					(R.offset = n.chunk_offsets[R.chunk_index - 1] + I),
					(I += R.size),
					t > T && (g++, T < 0 && (T = 0), (T += a.sample_counts[g])),
					t > 0
						? ((e.samples[t - 1].duration = a.sample_deltas[g]),
							(e.samples_duration += e.samples[t - 1].duration),
							(R.dts = e.samples[t - 1].dts + e.samples[t - 1].duration))
						: (R.dts = 0),
					s
						? (t >= S && (A++, S < 0 && (S = 0), (S += s.sample_counts[A])),
							(R.cts = e.samples[t].dts + s.sample_offsets[A]))
						: (R.cts = R.dts),
					o
						? (t == o.sample_numbers[N] - 1
								? ((R.is_sync = !0), N++)
								: ((R.is_sync = !1), (R.degradation_priority = 0)),
							u &&
								u.entries[v].sample_delta + O == t + 1 &&
								((R.subsamples = u.entries[v].subsamples), (O += u.entries[v].sample_delta), v++))
						: (R.is_sync = !0),
					E.process_sdtp(e.mdia.minf.stbl.sdtp, R, R.number),
					_ ? (R.degradation_priority = _.priority[t]) : (R.degradation_priority = 0),
					u &&
						u.entries[v].sample_delta + O == t &&
						((R.subsamples = u.entries[v].subsamples), (O += u.entries[v].sample_delta)),
					(c.length > 0 || d.length > 0) && E.setSampleGroupProperties(e, R, t, e.sample_groups_info);
			}
			t > 0 &&
			...
			for (; this.lastMoofIndex < this.moofs.length; )
				if (((l = this.moofs[this.lastMoofIndex]), this.lastMoofIndex++, 'moof' == l.type))
					for (e = 0; e < l.trafs.length; e++) {
						for (
							c = l.trafs[e],
								d = this.getTrackById(c.tfhd.track_id),
								_ = this.getTrexById(c.tfhd.track_id),
								r =
									c.tfhd.flags & u.TFHD_FLAG_SAMPLE_DESC
										? c.tfhd.default_sample_description_index
										: _
											? _.default_sample_description_index
											: 1,
								i =
									c.tfhd.flags & u.TFHD_FLAG_SAMPLE_DUR
										? c.tfhd.default_sample_duration
										: _
											? _.default_sample_duration
											: 0,
								a = c.tfhd.flags & u.TFHD_FLAG_SAMPLE_SIZE ? c.tfhd.default_sample_size : _ ? _.default_sample_size : 0,
								s =
									c.tfhd.flags & u.TFHD_FLAG_SAMPLE_FLAGS
										? c.tfhd.default_sample_flags
										: _
											? _.default_sample_flags
											: 0,
								c.sample_number = 0,
								c.sbgps.length > 0 && E.initSampleGroups(d, c, c.sbgps, d.mdia.minf.stbl.sgpds, c.sgpds),
								t = 0;
							t < c.truns.length;
							t++
						) {
							...
							for (n = 0; n < p.sample_count; n++) {
								((f = {}).moof_number = this.lastMoofIndex),
									(f.number_in_traf = c.sample_number),
									c.sample_number++,
									(f.number = d.samples.length),
									(c.first_sample_index = d.samples.length),
									d.samples.push(f),
									(f.track_id = d.tkhd.track_id),
									(f.timescale = d.mdia.mdhd.timescale),
									(f.description_index = r - 1),
									(f.description = d.mdia.minf.stbl.stsd.entries[f.description_index]),
									(f.size = a),
									p.flags & u.TRUN_FLAGS_SIZE && (f.size = p.sample_size[n]),
									(d.samples_size += f.size),
									(f.duration = i),
									p.flags & u.TRUN_FLAGS_DURATION && (f.duration = p.sample_duration[n]),
									(d.samples_duration += f.duration),
									d.first_traf_merged || n > 0
										? (f.dts = d.samples[d.samples.length - 2].dts + d.samples[d.samples.length - 2].duration)
										: (c.tfdt ? (f.dts = c.tfdt.baseMediaDecodeTime) : (f.dts = 0), (d.first_traf_merged = !0)),
									(f.cts = f.dts),
									p.flags & u.TRUN_FLAGS_CTS_OFFSET && (f.cts = f.dts + p.sample_composition_time_offset[n]),
									(h = s),
									p.flags & u.TRUN_FLAGS_FLAGS
										? (h = p.sample_flags[n])
										: 0 === n && p.flags & u.TRUN_FLAGS_FIRST_FLAG && (h = p.first_sample_flags),
									(f.is_sync = !((h >> 16) & 1)),
									(f.is_leading = (h >> 26) & 3),
									(f.depends_on = (h >> 24) & 3),
									(f.is_depended_on = (h >> 22) & 3),
									(f.has_redundancy = (h >> 20) & 3),
									(f.degradation_priority = 65535 & h);
								var I = !!(c.tfhd.flags & u.TFHD_FLAG_BASE_DATA_OFFSET),
									...
									g = 0;
								(g = I ? c.tfhd.base_data_offset : m ? l.start : 0 === t ? l.start : o),
									0 === t && 0 === n ? (T ? (f.offset = g + p.data_offset) : (f.offset = g)) : (f.offset = o),
									(o = f.offset + f.size),
									(c.sbgps.length > 0 ||
										c.sgpds.length > 0 ||
										d.mdia.minf.stbl.sbgps.length > 0 ||
										d.mdia.minf.stbl.sgpds.length > 0) &&
										E.setSampleGroupProperties(d, f, f.number_in_traf, c.sample_groups_info);
							}
						}
						if (c.subs) {
							...
							for (t = 0; t < c.subs.entries.length; t++)
								(S += c.subs.entries[t].sample_delta),
									((f = d.samples[S - 1]).subsamples = c.subs.entries[t].subsamples);
						}
					}
		}
	}),
	(E.prototype.getSample = function (e, t) {
		...
		for (;;) {
				...
				return (
					i.debug(
						...
						'Getting sample #' +
							...
							r.alreadyRead +
							' offset: ' +
							(r.offset + r.alreadyRead - n.fileStart) +
							' read size: ' +
					...
					s.memcpy(r.data.buffer, r.alreadyRead, n, r.offset + r.alreadyRead - n.fileStart, r.size - r.alreadyRead),
					(n.usedBytes += r.size - r.alreadyRead),
					this.stream.logBufferLevel(),
			...
			i.debug(
				...
				s.memcpy(r.data.buffer, r.alreadyRead, n, r.offset + r.alreadyRead - n.fileStart, o),
				(r.alreadyRead += o),
				(n.usedBytes += o),
				this.stream.logBufferLevel();
		}
		...
		if (null != a && void 0 !== a.hdlr) {
			if (void 0 !== a.iinf) {
				for (e = 0; e < a.iinf.item_infos.length; e++)
					((n = {}).id = a.iinf.item_infos[e].item_ID),
						(r[n.id] = n),
						(n.ref_to = []),
						(n.name = a.iinf.item_infos[e].item_name),
						a.iinf.item_infos[e].protection_index > 0 &&
							(n.protection = a.ipro.protections[a.iinf.item_infos[e].protection_index - 1]),
						a.iinf.item_infos[e].item_type ? (n.type = a.iinf.item_infos[e].item_type) : (n.type = 'mime'),
						(n.content_type = a.iinf.item_infos[e].content_type),
						(n.content_encoding = a.iinf.item_infos[e].content_encoding);
				if (a.iloc)
					for (e = 0; e < a.iloc.items.length; e++) {
						var s = a.iloc.items[e];
						switch (
							((n = r[s.item_ID]),
							0 !== s.data_reference_index &&
								(i.warn('Item storage with reference to other files: not supported'),
								(n.source = a.dinf.boxes[s.data_reference_index - 1])),
							s.construction_method)
						) {
							case 0:
								break;
							case 1:
						...
						for (t = 0, n.extents = [], n.size = 0; t < s.extents.length; t++)
							(n.extents[t] = {}),
								(n.extents[t].offset = s.extents[t].extent_offset + s.base_offset),
								(n.extents[t].length = s.extents[t].extent_length),
								(n.extents[t].alreadyRead = 0),
								(n.size += n.extents[t].length);
					}
				...
				if (a.iprp)
					for (var l = 0; l < a.iprp.ipmas.length; l++) {
						...
						for (e = 0; e < u.associations.length; e++) {
							...
							for (
								void 0 === (n = r[c.id]).properties && ((n.properties = {}), (n.properties.boxes = [])), t = 0;
								t < c.props.length;
								t++
							) {
								var d = c.props[t];
	...
	(E.prototype.getItem = function (e) {
		...
		if (!(n = this.items[e]).data && n.size)
			(n.data = new Uint8Array(n.size)),
				...
				i.debug('ISOFile', 'Allocating item #' + e + ' of size ' + n.size + ' (total: ' + this.itemsDataSize + ')');
		...
		for (var t, n, r = 0; r < n.extents.length; r++) {
			...
			if (a.alreadyRead !== a.length) {
					...
					return (
						i.debug(
							...
							'Getting item #' +
								...
								a.alreadyRead +
								' offset: ' +
								(a.offset + a.alreadyRead - t.fileStart) +
								' read size: ' +
								l +
								' full extent size: ' +
								a.length +
						...
						s.memcpy(n.data.buffer, n.alreadyRead, t, a.offset + a.alreadyRead - t.fileStart, l),
						(a.alreadyRead += l),
						(n.alreadyRead += l),
						(t.usedBytes += l),
						this.stream.logBufferLevel(),
				...
				i.debug(
					...
					s.memcpy(n.data.buffer, n.alreadyRead, t, a.offset + a.alreadyRead - t.fileStart, a.length - a.alreadyRead),
					(t.usedBytes += a.length - a.alreadyRead),
					this.stream.logBufferLevel(),
					(n.alreadyRead += a.length - a.alreadyRead),
	...
	(E.prototype.createFragment = function (e, t, n) {
		...
		if (null == a)
			return (
				(a = r.samples[t]),
				this.nextSeekPosition
					? (this.nextSeekPosition = Math.min(a.offset + a.alreadyRead, this.nextSeekPosition))
					: (this.nextSeekPosition = r.samples[t].offset + a.alreadyRead),
				null
			);
		var o = n || new s();
		...
		l.write(o),
			(l.trafs[0].truns[0].data_offset = l.size + 8),
			i.debug('MP4Box', 'Adjusting data_offset with new value ' + l.trafs[0].truns[0].data_offset),
			o.adjustUint32(l.trafs[0].truns[0].data_offset_position, l.trafs[0].truns[0].data_offset);
		var c = new u.mdatBox();
	...
	(E.writeInitializationSegment = function (e, t, n, r) {
		...
		for (n && l.add('mehd').set('fragment_duration', n), a = 0; a < t.traks.length; a++)
			l.add('trex')
				.set('track_id', t.traks[a].tkhd.track_id)
	...
	(E.prototype.initializeSegmentation = function () {
		for (
			null === this.onSegment && i.warn('MP4Box', 'No segmentation callback set!'),
			...
			(a.mvhd = this.moov.mvhd),
				...
				(r.buffer = E.writeInitializationSegment(
					this.ftyp,
					a,
	...
	(u.FullBox.prototype.printHeader = function (e) {
		(this.size += 4),
			u.Box.prototype.printHeader.call(this, e),
	...
	(u.mvhdBox.prototype.print = function (e) {
		u.FullBox.prototype.printHeader.call(this, e),
