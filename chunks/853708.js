...
var r = n(67867),
	...
	ed = function (e) {
		(this.entries = []),
			(this.url = null),
			void 0 !== e &&
				(k(e) ? this.parseObject(e) : this.parseQuery('string' == typeof e ? ('?' === Y(e, 0) ? et(e, 1) : e) : C(e)));
	};
ed.prototype = {
	type: O,
	bindURL: function (e) {
	...
	var ef = i(q.has),
		...
		ey = function (e) {
			if (k(e)) {
				...
				if (b(n) === O)
					return (
						!ef((t = e.headers ? new j(e.headers) : new j()), 'content-type') &&
							em(t, 'content-type', 'application/x-www-form-urlencoded;charset=UTF-8'),
						Z(e, {
							body: w(0, C(n)),
							headers: w(0, t)
						})
