	...
	s = (function () {
		function t(t, e) {
			(this.messageKeys = t),
				...
				(this.fallbackMessage = new a.InternalIntlMessage('THIS MESSAGE FAILED TO LOAD', 'en-US'));
		}
		return (
			(t.prototype.get = function (t, e) {
				...
				throw Error(
					'Requested message '.concat(t, ' does not have a value in the requested locale nor the default locale')
				);
			}),
					...
					return i(this, function (e) {
						switch (e.label) {
							case 0:
								...
								return (
									performance.now(),
									(r = this.localeImportMap[t]()),
									(this._localeLoadingPromises[t] = r),
									(n = this.messages),
									(o = t),
									[4, r]
								);
