!(function (t) {
	...
	function E(e, t) {
		...
		if (((u = e.d), (c = t.d), (o = e.e), (a = t.e), (u = u.slice()), (s = o - a))) {
			for (
				s < 0 ? ((r = u), (s = -s), (l = c.length)) : ((r = c), (a = o), (l = u.length)),
					s > (l = (o = Math.ceil(_ / 7)) > l ? o + 1 : l + 1) && ((s = l), (r.length = 1)),
					r.reverse();
				s--;
	...
	(_.absoluteValue = _.abs =
					...
					e = m(this),
						...
						0 == (s = Math.sqrt(+this)) || s == 1 / 0
							? (((t = h(this.d)).length + e) % 2 == 0 && (t += '0'),
								(s = Math.sqrt(t)),
								(e = l((e + 1) / 2) - (e < 0 || e % 2)),
								(r = new c((t = s == 1 / 0 ? '1e' + e : (t = s.toExponential()).slice(0, t.indexOf('e') + 1) + e))))
							: (r = new c(s.toString())),
						s = u = (n = c.precision) + 3;
					;
			...
			function (e) {
				...
				for (
					e.s *= this.s,
						n = this.e + e.e,
						u = _.length,
						u < (c = E.length) && ((s = _), (_ = E), (E = s), (o = u), (u = c), (c = o)),
						s = [],
						r = o = u + c;
					r--;
		...
		(_.toDecimalPlaces = _.todp =
			function (e, t) {
				...
				return ((n = new r(n)), void 0 === e)
					? n
					: (f(e, 0, 1000000000), void 0 === t ? (t = r.rounding) : f(t, 0, 8), N(n, e + m(n) + 1, t));
			}),
		(_.toExponential = function (e, t) {
			...
			return (
				void 0 === e
					? (n = O(r, !0))
					: (f(e, 0, 1000000000),
						void 0 === t ? (t = i.rounding) : f(t, 0, 8),
						(n = O((r = N(new i(r), e + 1, t)), !0, e + 1))),
				n
			);
		}),
		(_.toFixed = function (e, t) {
			...
			return void 0 === e
				...
				: (f(e, 0, 1000000000),
					void 0 === t ? (t = i.rounding) : f(t, 0, 8),
					(n = O((r = N(new i(this), e + m(this) + 1, t)).abs(), !1, e + m(r) + 1)),
			...
			function (e) {
				...
				if (((t = e.e), (c = t >= (r = e.d.length - 1)), (u = d.s), c)) {
					if ((r = E < 0 ? -E : E) <= 9007199254740991) {
						for (
							o = new _(n), t = Math.ceil(s / 7 + 4), i = !1;
							r % 2 && R((o = o.times(d)).d, t), 0 !== (r = l(r / 2));
		...
		(_.toPrecision = function (e, t) {
			...
			return (
				void 0 === e
					? ((n = m(i)), (r = O(i, n <= a.toExpNeg || n >= a.toExpPos)))
					: (f(e, 1, 1000000000),
						void 0 === t ? (t = a.rounding) : f(t, 0, 8),
						(n = m((i = N(new a(i), e, t)))),
						(r = O(i, e <= n || n <= a.toExpNeg, e))),
				r
			);
		}),
			...
			function (e, t) {
				...
				return (
					void 0 === e
						...
						: (f(e, 1, 1000000000), void 0 === t ? (t = n.rounding) : f(t, 0, 8)),
					N(new n(this), e, t)
				);
			}),
		(_.toString =
	...
	var p = (function () {
		...
		return function (r, i, s, o) {
			...
			if (((g = (g / 7 + 2) | 0), (c = 0), 1 == R))
				...
				for (
					(d = (10000000 / (b[0] + 1)) | 0) > 1 && ((b = e(b, d)), (L = e(L, d)), (R = b.length), (v = L.length)),
						A = R,
						I = (p = L.slice(0, R)).length;
					I < R;
				...
				do
					(d = 0),
						(l = t(b, p, R, I)) < 0
							? ((T = p[0]),
								R != I && (T = 10000000 * T + (p[1] || 0)),
								(d = (T / O) | 0) > 1
									? (d >= 10000000 && (d = 10000000 - 1),
										(E = (_ = e(b, d)).length),
										(I = p.length),
										1 == (l = t(_, p, E, I)) && (d--, n(_, R < E ? C : b, E)))
									: (0 == d && (l = d = 1), (_ = b.slice())),
								(E = _.length) < I && _.unshift(0),
								n(p, _, I),
								-1 == l && ((I = p.length), (l = t(b, p, R, I)) < 1 && (d++, n(p, R < I ? C : b, I))),
								(I = p.length))
							: 0 === l && (d++, (p = [0])),
						(h[c++] = d),
						l && p[0] ? (p[I++] = L[A] || 0) : ((p = [L[A]]), (I = 1));
	...
	function I(e, t) {
		...
		for (c += ((Math.log(u(2, _)) / Math.LN10) * 2 + 5) | 0, r = a = s = new E(n), E.precision = c; ; ) {
			if (
				((a = N(a.times(e), c)), (r = r.times(++d)), h((l = s.plus(p(a, r, c))).d).slice(0, c) === h(s.d).slice(0, c))
			) {
	...
	function S(e, t) {
		...
		if (((_ += 10), (A.precision = _), (s = (r = h(g)).charAt(0)), !(1500000000000000 > Math.abs((l = m(I))))))
			return (
				(d = T(A, _ + 2, v).times(l + '')),
				(I = S(new A(s + '.' + r.slice(1)), _ - 10).plus(d)),
				(A.precision = v),
				null == t ? ((i = !0), N(I, v)) : I
			);
		...
		for (c = u = I = p(I.minus(n), I.plus(n), _), E = N(I.times(I), _), o = 3; ; ) {
			if (((u = N(u.times(E), _)), h((d = c.plus(p(u, new A(o), _))).d).slice(0, _) === h(c.d).slice(0, _)))
				return (
					(c = c.times(2)),
					0 !== l && (c = c.plus(T(A, _ + 2, v).times(l + ''))),
					(c = p(c, new A(f), _)),
					(A.precision = v),
					null == t ? ((i = !0), N(c, v)) : c
				);
	...
	function N(e, t, n) {
		...
		if (
			(void 0 !== n &&
				((_ = (f / (s = u(10, c - a - 1))) % 10 | 0),
				(E = t < 0 || void 0 !== p[h + 1] || f % s),
				(E =
					n < 4
						? (_ || E) && (0 == n || n == (e.s < 0 ? 3 : 2))
						: _ > 5 ||
							(5 == _ &&
								(4 == n ||
									E ||
									(6 == n && (r > 0 ? (a > 0 ? f / u(10, c - a) : 0) : p[h - 1]) % 10 & 1) ||
									n == (e.s < 0 ? 8 : 7))))),
			t < 1 || !p[0])
		)
			return (
				E
					? ((s = m(e)), (p.length = 1), (t = t - s - 1), (p[0] = u(10, (7 - (t % 7)) % 7)), (e.e = l(-t / 7) || 0))
		...
		if (
			(0 == r
				? ((p.length = h), (s = 1), h--)
				: ((p.length = h + 1), (s = u(10, 7 - r)), (p[h] = a > 0 ? ((f / u(10, c - a)) % u(10, a) | 0) * s : 0)),
			E)
		)
			for (;;) {
				if (0 == h) {
	...
	function v(e, t) {
		...
		if (((u = e.d), (_ = t.d), (r = t.e), (c = e.e), (u = u.slice()), (o = c - r))) {
			for (
				(d = o < 0) ? ((n = u), (o = -o), (l = _.length)) : ((n = _), (r = c), (l = u.length)),
					o > (a = Math.max(Math.ceil(f / 7), l) + 2) && ((o = a), (n.length = 1)),
					n.reverse(),
					a = o;
				a--;
	...
	function O(e, t, n) {
		...
		return (
			t
				? (n && (r = n - s) > 0
						? (a = a.charAt(0) + '.' + a.slice(1) + g(r))
						: s > 1 && (a = a.charAt(0) + '.' + a.slice(1)),
					(a = a + (i < 0 ? 'e' : 'e+') + i))
				: i < 0
					? ((a = '0.' + g(-i - 1) + a), n && (r = n - s) > 0 && (a += g(r)))
					: i >= s
						? ((a += g(i + 1 - s)), n && (r = n - i - 1) > 0 && (a = a + '.' + g(r)))
						: ((r = i + 1) < s && (a = a.slice(0, r) + '.' + a.slice(r)),
							n && (r = n - s) > 0 && (i + 1 === s && (a += '.'), (a += g(r)))),
			e.s < 0 ? '-' + a : a
		);
	}
	function R(e, t) {
