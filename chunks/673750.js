...
__OVERLAY__ && (O = n(237997).Z),
	((a = r || (r = {})).OVERLAY_UNLOCKED = 'overlay_unlocked'),
	(a.OVERLAY_UNLOCKED_PINNED = 'overlay_unlocked_pinned'),
	(a.OVERLAY_LOCKED_ACTIVATED = 'overlay_locked_activated'),
	((s = i || (i = {}))[(s.SEND = 0)] = 'SEND'),
	(s[(s.EDIT = 1)] = 'EDIT'),
	(s[(s.COMMAND = 2)] = 'COMMAND');
let R = (e) => 0 === e.type,
	C = (e) => 1 === e.type,
...
class L extends g.Z {
	...
	createResponseHandler(e, t) {
		return (n) => {
			...
			null != n.body &&
			(n.body.code === N.evJ.SLOWMODE_RATE_LIMITED || n.body.code === N.evJ.CHANNEL_FOLLOWING_EDIT_RATE_LIMITED)
				? t(null, n)
				: 429 === n.status
					? t({ retryAfter: n.body.retry_after * m.Z.Millis.SECOND })
					: t(null, n);
		};
	}
	handleSend(e, t) {
		...
		null != O &&
			(O.isInstanceUILocked()
				? (n = { location: 'overlay_locked_activated' })
				: !O.isInstanceUILocked() &&
					(n = O.isPinned(N.Odu.TEXT) ? { location: 'overlay_unlocked_pinned' } : { location: 'overlay_unlocked' }));
	...
	handleCommand(e, t) {
		...
		if (null != u) {
			...
			h.data.attachments = u.map(
				(e, t) => (
					l()(e.status === A.m.COMPLETED, 'Uploads must be staged before trying to send a message'), (0, S.B)(e, t)
				)
			);
		}
	...
	constructor(e = 5) {
		super(new E.Z('MessageQueue')),
			v(this, 'maxSize', void 0),
			v(this, 'requests', void 0),
			v(this, 'analyticsTimeouts', void 0),
			(this.maxSize = e),
