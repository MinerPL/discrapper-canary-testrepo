...
function X(e, t, n) {
	...
	let s = (e) => {
		...
		a &&
			...
			(!a.contains(n) || !n.closest('button, [role="button"]')) &&
			t.selectFocusedDate();
	};
	return (
...
function J(e, t, n) {
	...
	let d = t.isCellUnavailable(r),
		...
		E =
			...
			('highlightedRange' in t
				? !t.anchorDate &&
					t.highlightedRange &&
					r.compare(t.highlightedRange.start) >= 0 &&
					0 >= r.compare(t.highlightedRange.end)
				: t.value && (0, V.KC)(t.value, r));
		...
		p = (0, F.useMemo)(() => {
			...
			return (
				'highlightedRange' in t &&
					t.value &&
					!t.anchorDate &&
					((0, V.KC)(r, t.value.start) || (0, V.KC)(r, t.value.end)) &&
					(e = s + ', '),
				(e += l.format(f)),
				h
					? (e = o.format(u ? 'todayDateSelected' : 'todayDate', { date: e }))
					: u && (e = o.format('dateSelected', { date: e })),
				t.minValue && (0, V.KC)(r, t.minValue)
					? (e += ', ' + o.format('minimumDate'))
					: t.maxValue && (0, V.KC)(r, t.maxValue) && (e += ', ' + o.format('maximumDate')),
				e
			);
		}, [l, f, o, u, h, r, t, s]),
		I = '';
	'anchorDate' in t &&
		...
		!t.isReadOnly &&
		_ &&
		(I = t.anchorDate ? o.format('finishRangeSelectionPrompt') : o.format('startRangeSelectionPrompt'));
	let m = (0, k.PK)(I),
		T = (0, F.useRef)(!1),
		g = (0, F.useRef)(!1),
		S = (0, F.useRef)(null),
		{ pressProps: A, isPressed: N } = (0, H.r7)({
			...
			onPressUp(e) {
				if (
					!t.isReadOnly &&
					('anchorDate' in t && S.current && (t.selectDate(r), t.setFocusedDate(r)), 'anchorDate' in t)
				) {
		...
		(0, F.useEffect)(() => {
			c &&
				...
				'pointer' !== (0, H.Jz)() &&
					...
					(0, k.Gt)(n.current, { containingElement: (0, k.rP)(n.current) }));
		}, [c, n]);
	let O = (0, B.aQ)({
			day: 'numeric',
			timeZone: t.timeZone,
