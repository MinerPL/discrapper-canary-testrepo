...
class u {
		...
		if (!this.disabled) {
			if (!this.streamDisabledUsers.has(e)) {
				...
				this.perUserFpsWindow[e].length > this.windowLength && this.perUserFpsWindow[e].shift(),
					this.perUserFpsWindow[e].filter((e) => e < this.fpsThreshold).length >= this.fpsWindowBorderlineCount
						? (this.logger.info(''.concat(e, ': detected poor network quality, turning off video')),
							this.streamDisabledUsers.add(e),
							(this.currentVideoAutoToggleState[e] = o.ZUi.DISABLED),
							(0, a.Z)(e, o.ZUi.DISABLED),
							this.startReenableBackoffTimer(e))
						: this.currentVideoAutoToggleState[e] === o.ZUi.AUTO_PROBING &&
							((this.currentVideoAutoToggleState[e] = o.ZUi.AUTO_ENABLED),
							this.logger.info('acceptable conditions reached, will reset and send a AUTO_ENABLED for user '.concat(e)),
							(0, a.Z)(e, o.ZUi.AUTO_ENABLED)),
	...
	reenableVideo(e) {
		return (
			...
			(this.logger.info('reenableVideo called for user '.concat(e, ' - time = ').concat((0, i.zO)())),
			this.stateCleanupBeforeEnable(e),
			(this.currentVideoAutoToggleState[e] = o.ZUi.AUTO_PROBING),
			(this.probingUserId = e),
			(0, a.Z)(e, o.ZUi.AUTO_PROBING),
			!0)
		);
	}
	elapsedSeconds(e, t) {
	...
	constructor(e, t, n, i) {
		l(this, 'logger', new r.Y('VideoHealthManager')),
			l(this, 'windowLength', void 0),
			l(this, 'fpsThreshold', void 0),
			l(this, 'fpsWindowBorderlineCount', void 0),
			l(this, 'backoffTimeSec', void 0),
			l(this, 'disabled', !1),
			l(this, 'perUserFpsWindow', {}),
			l(this, 'prevFramesCodec', {}),
			l(this, 'prevTimestamp', {}),
			l(this, 'streamDisabledUsers', new Set()),
			l(this, 'retryBackoffCache', {}),
			l(this, 'timeoutIdCache', {}),
			l(this, 'currentVideoAutoToggleState', {}),
			l(this, 'probingUserId', void 0),
			l(this, 'enableQueue', []),
			(this.windowLength = e),
			(this.fpsThreshold = n),
			...
			this.logger.info(
				'constructor with windowLength = '
					...
					.concat(this.fpsWindowBorderlineCount, ',\n      fpsThreshold = ')
