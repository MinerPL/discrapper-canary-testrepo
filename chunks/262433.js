...
function E(e) {
	...
	let Z = c.Z.getEmojiImage(
			null !== (n = null !== (t = E.emojiId) && void 0 !== t ? t : E.emojiName) && void 0 !== n ? n : ''
		),
		A = (0, d.np)(E.x, C),
		M = (0, d.np)(E.y, I),
	...
	if (
					...
					(0, r.j)(() => {
						_.setState(
							(e) => (
								...
								0 === Object.keys(e.particles[t.id]).length && delete e.particles[t.id],
								e
							)
						);
					}))
		...
		E.state === u.f.STOP &&
			((i = E), !(Object.keys(null !== (l = _.getState().particles[i.id]) && void 0 !== l ? l : {}).length > 0)))
	)
		S.push(E);
	g.restore();
}
