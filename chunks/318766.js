...
t.Z = function (e) {
	...
	let {
		...
		[A, N] = i.useState(50),
		v = g || p,
		O = (0, c.l)(E, 'emojiButton', v ? 'Hovered' : 'Normal');
	let R =
			((t = A),
			{
				...
				: (0, r.jsx)(l.Spring, {
						...
						children: (e) => {
							...
							return (0, r.jsxs)(o.animated.div, {
								...
								children: [
									(0, r.jsx)('div', { className: s()(E.sprite, E.spriteColored, v ? E.active : E.inactive) }),
									(0, r.jsx)('div', { className: s()(E.sprite, E.spriteGreyscale, v ? E.inactive : E.active) })
								]
							});
						}
					})
