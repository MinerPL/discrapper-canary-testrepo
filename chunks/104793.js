...
function m(e, t, n) {
	...
	if (
		null == b ||
		l.e$(m, I.Plq.ADMINISTRATOR) ||
		(y && (null === (r = e.integration_types) || void 0 === r ? void 0 : r.includes(o.Y.USER_INSTALL)))
	)
		return 0;
		...
		: (function (e) {
			...
			: (function (e) {
				  ...
				  (null != e.defaultMemberPermissions &&
						!(!l.fS(e.defaultMemberPermissions, f.BO) && l.e$(m, e.defaultMemberPermissions)))
				? 7
				: 0;
}
function T(e) {
