	...
	return {
		makeDetectable: function (e, l, d) {
			...
			function C() {
				var e = i(l).container;
				if (!e) {
					((e = document.createElement('div')).className = o),
						(e.style.cssText = u([
							'visibility: hidden',
							'display: inline',
							'width: 0px',
						...
						(i(l).container = e),
						(t = e),
						(t.className += ' ' + o + '_animation_active'),
						l.appendChild(e);
					var t,
						n = function () {
			...
			function y() {
				...
				(A.dir = 'ltr'),
					...
					c(v, 'scroll', D),
					c(R, 'scroll', L),
					(i(l).onExpandScroll = D),
					(i(l).onShrinkScroll = L);
			}
			function D() {
				function s(t, n, r) {
					var i = _(t).childNodes[0],
						a = n + 10 + A(),
						s = r + 10 + N();
					i.style.setProperty('width', a + 'px', e.important ? 'important' : ''),
						i.style.setProperty('height', s + 'px', e.important ? 'important' : '');
				}
				function o(r) {
					var o = l.offsetWidth,
						c = l.offsetHeight,
				...
				(i(l).onRendered = function () {
					...
					(0 === e.scrollLeft || 0 === e.scrollTop || 0 === t.scrollLeft || 0 === t.scrollTop) &&
						(I('Scrollbars out of sync. Updating detector elements...'), o(c));
				}),
					(i(l).onExpand = d),
					(i(l).onShrink = d);
				var f = i(l).style;
			...
			if (
				(I('Making detectable...'),
				((p = (h = f = l).getRootNode && h.getRootNode().contains(h)),
				(h === h.ownerDocument.body || h.ownerDocument.body.contains(h) || p) && null !== window.getComputedStyle(f))
					? 1
					: 0)
			)
				M();
		...
		uninstall: function (e) {
			var t = i(e);
			if (!!t)
				t.onExpandScroll && d(_(e), 'scroll', t.onExpandScroll),
					t.onShrinkScroll && d(E(e), 'scroll', t.onShrinkScroll),
