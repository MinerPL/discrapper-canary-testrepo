	...
	(t.toByteArray = function (e) {
		...
		for (s = 0; s < E; s += 4)
			(a =
				...
				(d[_++] = 255 & a);
		return (
			2 === c && ((a = (r[e.charCodeAt(s)] << 2) | (r[e.charCodeAt(s + 1)] >> 4)), (d[_++] = 255 & a)),
			1 === c &&
				((a = (r[e.charCodeAt(s)] << 10) | (r[e.charCodeAt(s + 1)] << 4) | (r[e.charCodeAt(s + 2)] >> 2)),
				(d[_++] = (a >> 8) & 255),
				(d[_++] = 255 & a)),
			d
		);
	...
	(t.fromByteArray = function (e) {
				...
				(function (e, t, r) {
					for (var i, a, s = [], o = t; o < r; o += 3) {
						(a = ((e[o] << 16) & 16711680) + ((e[o + 1] << 8) & 65280) + (255 & e[o + 2])),
							s.push(n[((i = a) >> 18) & 63] + n[(i >> 12) & 63] + n[(i >> 6) & 63] + n[63 & i]);
					}
					return s.join('');
		...
		return (
			1 === i
				...
				: 2 === i && ((t = (e[r - 2] << 8) + e[r - 1]), a.push(n[t >> 10] + n[(t >> 4) & 63] + n[(t << 2) & 63] + '=')),
			a.join('')
		);
	});
for (
