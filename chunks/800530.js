...
((i = u || (u = {})).SETTINGS = 'SETTINGS'),
	(i.ACCOUNT_STANDING = 'ACCOUNT_STANDING'),
	(i.GUILD_SETTINGS = 'GUILD_SETTINGS'),
	(i.ENCRYPTION = 'ENCRYPTION');
class f {}
N(f, 'TOS_LINK', 'https://discord.com/terms'),
	N(f, 'COMMUNITY_GUIDELINES', 'https://discord.com/guidelines'),
	N(f, 'APPEALS_LINK', 'https://support.discord.com/hc/requests/new?ticket_form_id=360000029731'),
	N(f, 'WARNING_SYSTEM_HELPCENTER_LINK', 'https://support.discord.com/hc/articles/18210965981847'),
	N(f, 'AGE_VERIFICATION_LINK', 'https://support.discord.com/hc/requests/new?ticket_form_id=360000029731'),
	N(
		f,
		'SPAM_LINK',
...
class C {}
N(C, 'CLASSIFICATION_ID', 'classification_id'),
	N(C, 'INCIDENT_TIMESTAMP', 'incident_time'),
	((a = d || (d = {})).POLICY_VIOLATION_DETAIL = 'policy_violation_detail'),
...
((c = T || (T = {}))[(c.USER = 1)] = 'USER'),
	(c[(c.GUILD_OWNER = 2)] = 'GUILD_OWNER'),
	(c[(c.GUILD_MEMBER = 3)] = 'GUILD_MEMBER');
