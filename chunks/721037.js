...
t.Z = a.ZP.connectStores([E.Z, o.ZP, T.Z, f.Z, p.Z, m.Z, I.Z, d.Z], (e) => {
	...
	let a,
		...
		R =
			null != _ &&
			(null === (t = d.Z.getSelectedParticipant(_.channelId)) || void 0 === t ? void 0 : t.type) === N.fO.ACTIVITY,
		C = T.Z.windowSize();
	if (s) {
	...
	a =
		s && h
			...
			: s || !c || h
				? null != _ && O
					? null !== (n = I.Z.pipActivityWindow) && void 0 !== n
						? n
						: I.Z.pipVideoWindow
					: null !== (r = I.Z.pipVideoWindow) && void 0 !== r
						? r
