...
async function eD(e) {
	...
	for (let n = 0; n < 3; n++)
		try {
			...
			if (
				(eu.error('', e),
				n + 1 < 3 && (await (0, f.GR)((n + 1) * 2000), await V.Z.awaitOnline(), t !== Z.default.getId()))
			)
...
function eL(e) {
	...
	if (
		(null != I.ZP.getConnectedActivityChannelId() &&
			I.ZP.getActivityPanelMode() === ei.Ez.PANEL &&
			I.ZP.getFocusedLayout() === ei.MI.NO_CHAT) ||
		q.Z.isIdle() ||
		!e.canTrackUnreads()
	)
		return !1;
	...
	if (
		...
		(null == t ? void 0 : t.isForumLikeChannel()) === !0 ||
		(!(n && !e._isJoinedThread) && !W.Z.isAtBottom(e.channelId))
	)
		return !1;
...
class eb {
	...
	static get(e) {
		...
		return (
			null == r &&
				((r = new eb(e, n)), null == eb._readStates[n] && (eb._readStates[n] = {}), (eb._readStates[n][e] = r)),
			r
		);
	}
	...
	static clear(e) {
		...
		let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : eo.W.CHANNEL;
		return (
			(null === (t = eb._readStates[n]) || void 0 === t ? void 0 : t[e]) != null &&
			(delete eb._readStates[n][e], eb._mentionChannels.delete(e), !0)
		);
	}
	static clearAll() {
	...
	deserializeForOverlay(e) {
		...
		(this.channelId = t),
			(this.type = null != n ? n : eo.W.CHANNEL),
			(this._guildId = r),
			...
			(this.oldestUnreadMessageIdStale = null != m && m),
			(this.estimated = null != T && T),
			(this._unreadCount = null != g ? g : 0),
			(this._mentionCount = S),
			(this.flags = A),
			(this.lastViewed = N),
			eb._mentionChannels.delete(this.channelId),
			this._mentionCount > 0 && this.canHaveMentions() && eb._mentionChannels.add(this.channelId);
	}
	...
	rebuildChannelState(e) {
		...
		if (
			((this.ackMessageId =
				null !== (t = null != e ? e : this._ackMessageId) && void 0 !== t ? t : this.guessAckMessageId()),
			...
			o.forAll((n) => {
				...
				H.default.extractTimestamp(n.id) > t
	...
	canTrackUnreads() {
		...
		return (
			...
			('basicPermissions' in e
				? G.Z.has(e.basicPermissions, er.S7T.VIEW_CHANNEL)
				: !g.Z.isChannelGated(this.guildId, this.channelId) || X.Z.can(er.Plq.VIEW_CHANNEL, e))
		);
	}
	canBeUnread() {
		return (
			!(
				...
				(0, R.h3)(this.channelId, [O.Z, C.Z]) ||
				(!this._isThread &&
					(0, L.r1)(this._guildId) &&
					(this._lastMessageTimestamp < eS ||
						(!ee.ZP.isChannelOrParentOptedIn(this._guildId, this.channelId) &&
	...
	canHaveMentions() {
		return (
			!(
				...
				(this._isThread && !this._isJoinedThread) ||
				(0, R.h3)(this.channelId, [O.Z, C.Z]) ||
				((0, L.r1)(this._guildId) && this._lastMessageTimestamp < eS)
			) && this.canTrackUnreads()
		);
	}
	getGuildChannelUnreadState(e, t, n, r, i) {
		if (
			t &&
			(this._lastMessageTimestamp < eS ||
				(!ee.ZP.isChannelRecordOrParentOptedIn(e) && !this.hasRecentlyVisitedAndRead() && this.mentionCount <= 0))
		)
			return {
				mentionCount: 0,
				unread: !1
	...
	ack(e) {
		let {
			...
			location: s = { section: er.jXE.CHANNEL },
			trackAnalytics: o = !0
		} = e;
		...
		return (
			...
			(null != t || null != (t = this.lastMessageId)) &&
				...
				(function (e) {
					...
					let r = n.parent_id,
						i = eb.get(r);
					M.Z.hasLoaded(n.guild_id) &&
						H.default
							.keys(M.Z.getThreadsForParent(n.guild_id, r))
							.every((e) => e0.hasOpenedThread(e) || 0 > H.default.compare(e, i.ackMessageId)) &&
						i.ack({});
				})(this.channelId),
				n
					? (this.oldestUnreadMessageId = null)
					: (null == this.outgoingAck &&
							(this.outgoingAckTimer = setTimeout(
								() => {
									this.type === eo.W.CHANNEL ? this._ack(s, o) : this._nonChannelAck(),
	...
	_shouldAck(e, t, n) {
		...
		return (
			...
			!!(
				!this.isManualAck &&
				(this.type !== eo.W.CHANNEL ||
					this.loadedMessages ||
					(null === (r = j.Z.getChannel(this.channelId)) || void 0 === r ? void 0 : r.isForumLikeChannel()))
			) ||
			!1
		);
	}
			...
			return !(function (e) {
				switch (e.type) {
					...
					case eo.W.NOTIFICATION_CENTER:
						var t;
						return (
							H.default.cast(null === (t = et.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) === e.channelId
						);
					default:
						return !0;
				}
	...
	constructor(e, t = eo.W.CHANNEL) {
		el(this, 'channelId', void 0),
			el(this, 'type', eo.W.CHANNEL),
			el(this, '_guildId', void 0),
			el(this, '_isThread', void 0),
			el(this, '_isActiveThread', void 0),
			el(this, '_isJoinedThread', void 0),
			el(this, '_isResourceChannel', void 0),
			el(this, '_persisted', void 0),
			el(this, 'loadedMessages', void 0),
			el(this, '_lastMessageId', void 0),
			el(this, '_lastMessageTimestamp', void 0),
			el(this, '_ackMessageId', void 0),
			el(this, '_ackMessageTimestamp', void 0),
			el(this, 'isManualAck', void 0),
			el(this, 'ackPinTimestamp', void 0),
			el(this, 'lastPinTimestamp', void 0),
			el(this, '_oldestUnreadMessageId', void 0),
			el(this, 'oldestUnreadMessageIdStale', void 0),
			el(this, 'estimated', void 0),
			el(this, '_unreadCount', void 0),
			el(this, '_mentionCount', void 0),
			el(this, 'flags', void 0),
			el(this, 'lastViewed', void 0),
			el(this, 'outgoingAck', void 0),
			el(this, 'outgoingAckTimer', null),
			el(this, 'ackMessageIdAtChannelSelect', null),
			el(this, 'ackedWhileCached', void 0),
			el(this, 'snapshot', void 0),
			(this.channelId = e),
			(this.type = t),
			(this._guildId = null),
			(this._isThread = !1),
	...
	e.forEach((e) => {
		if ((0, x.Em)(e.type)) {
			...
			(t._guildId = e.guild_id),
				...
				(t._isResourceChannel = e.hasFlag(ea.zZ.IS_GUILD_RESOURCE_CHANNEL)),
	...
	e.forEach((e) => {
		if ((0, x.Em)(e.type)) {
			...
			(n.lastMessageId = e.last_message_id),
				(n.lastPinTimestamp = eO(e.last_pin_timestamp)),
				(n._isResourceChannel = (0, B.yE)(
					null !== (t = e.flags) && void 0 !== t ? t : 0,
					ea.zZ.IS_GUILD_RESOURCE_CHANNEL
				)),
...
function eU(e) {
	(function (e) {
		...
		null === (t = e.threads) ||
			...
			t.forEach((t) => {
				...
				(n.lastMessageId = t.lastMessageId),
					...
					null == n.ackMessageId && (n.ackMessageId = H.default.fromTimestamp(ew(e.id, t.id))),
		...
		(function (e) {
			var t, n;
			if (
				(null === (t = e.guild_scheduled_events) || void 0 === t ? void 0 : t.length) === 0 &&
				null == eb.getIfExists(e.id, eo.W.GUILD_EVENT)
			)
				return;
		...
		(function (e) {
			eb.get(e.id, eo.W.GUILD_HOME).lastMessageId = H.default.fromTimestamp(
...
function ew(e, t) {
	...
	let a = j.Z.getChannel(t),
		...
		l =
			(null !== (i = null === (n = P.Z.joinTimestamp(t)) || void 0 === n ? void 0 : n.getTime()) && void 0 !== i
				? i
				: 0) - 5000;
	isNaN(l) && (l = -5000);
	...
	let d = Math.max(l, c);
	return (
		d <= 0 && (d = H.default.extractTimestamp(t) - 1), (isNaN(d) || d <= 0) && (d = 0), isNaN(o) ? d : Math.max(o, d)
	);
}
function ex(e) {
...
function e$(e, t, n, r) {
	...
	return (
		...
		((n =
			null !== (i = null != n ? n : a.lastMessageId) && void 0 !== i
				? i
				: H.default.fromTimestamp(a.getAckTimestamp())),
		a.ack({
			messageId: n,
			local: null == r || r
		}))
...
class eJ extends (a = _.ZP.Store) {
	...
	isNewForumThread(e, t, n) {
		let r = eb.get(t);
		if (
			!0 === eb.get(e)._persisted ||
			null == r.ackMessageIdAtChannelSelect ||
			0 >= H.default.compare(e, r.ackMessageIdAtChannelSelect)
		)
			return !1;
		let i = ex(n);
		...
		return (
			eb.forEach((n) => {
				switch (n.type) {
					...
					case eo.W.MESSAGE_REQUESTS:
						var r;
						H.default.cast(null === (r = et.default.getCurrentUser()) || void 0 === r ? void 0 : r.id) ===
...
let e0 = new eJ(p.Z, {
	BACKGROUND_SYNC_CHANNEL_MESSAGES: function (e) {
		...
		for (let e in t) {
			...
			let i = t[e],
				a = eb.getIfExists(e);
			if (null != a)
				for (let e of [null === (n = i.new_messages) || void 0 === n ? void 0 : n[0]]
					.concat(null !== (r = i.modified_messages) && void 0 !== r ? r : [])
					.filter(F.lm))
	...
	CONNECTION_OPEN: function (e) {
		...
		ev(),
			...
			s.entries.forEach((e) => {
				...
				let a = eb.get(e.id, i);
				(a._persisted = !0),
					(a._mentionCount = null !== (n = e.mention_count) && void 0 !== n ? n : 0),
					(a.flags = e.flags),
					(a.lastViewed = e.last_viewed);
				let s = j.Z.getBasicChannel(e.id);
				null != s && (0, x.Q5)(s.type) && (null == e.last_message_id || 0 === e.last_message_id)
					? (a.ackMessageId = H.default.fromTimestamp(ew(s.guild_id, s.id)))
					: a.ackedWhileCached
						? -1 === H.default.compare(a.ackMessageId, e.last_message_id) && (a.ackMessageId = e.last_message_id)
						: (a.ackMessageId = e.last_message_id),
					(a.ackedWhileCached = void 0),
					(a.ackPinTimestamp = eO(e.last_pin_timestamp)),
					eb._mentionChannels.delete(a.channelId),
					a._mentionCount > 0 && a.canHaveMentions() && eb._mentionChannels.add(a.channelId);
			}),
			eb.resetGuildSentinels();
		let o = null === (t = et.default.getCurrentUser()) || void 0 === t ? void 0 : t.id;
		for (let e of (null != o &&
			(eb.get(o, eo.W.NOTIFICATION_CENTER).lastMessageId = H.default.fromTimestamp(Date.now())),
		(function (e) {
			let t = et.default.getCurrentUser();
			if (null == t) return 0;
	...
	CACHE_LOADED: function (e) {
		...
		(ef = !0),
			...
			t.forEach((e) => {
				...
				(e.type = n),
					null == eb._readStates[n] && (eb._readStates[n] = {}),
					(eb._readStates[n][e.channelId] = (0, h.gh)(e, eb));
			});
	},
	...
	LOAD_MESSAGES_SUCCESS: function (e) {
		...
		null != a &&
			(r.length > 0 && 1 === H.default.compare(r[0].id, i.ackMessageId) && 0 === i.unreadCount
				? i.rebuildChannelState()
				: a.hasPresent() || a.jumpTargetId === i.ackMessageId
					? i.rebuildChannelState()
					: n &&
						null != i.ackMessageId &&
	...
	MESSAGE_CREATE: function (e) {
		...
		if (
			(_ && eL(o) && !s) ||
			(null != r && r.isInstanceFocused() && _ && r.isInstanceUILocked() && r.isPinned(er.Odu.TEXT))
		)
			return o.ack({ messageId: a.id });
		(null == o.oldestUnreadMessageId || o.oldestUnreadMessageIdStale) && (o.oldestUnreadMessageId = a.id),
			o.unreadCount++,
			!(
				$.Z.isBlockedForMessage(a) ||
				(a.type === er.uaV.RECIPIENT_REMOVE && (null == u ? void 0 : u.type) === er.d4z.GROUP_DM)
			) &&
				(function (e, t, n) {
					if (
						null != t &&
					...
					return (
						!!eC(r) ||
						(!!ee.ZP.mentionOnAllMessages &&
							null != r &&
							!r.isVocal() &&
							!ee.ZP.isChannelMuted(r.guild_id, r.id) &&
							ee.ZP.resolvedMessageNotifications(r) === er.bL.ALL_MESSAGES) ||
						!1
					);
				})(a, l, o) &&
				o.mentionCount++;
	...
	CHANNEL_SELECT: function (e) {
		...
		if (null != r) {
			...
			(e.ackMessageIdAtChannelSelect =
				null !== (i = e.ackMessageId) && void 0 !== i ? i : H.default.fromTimestamp(e.getAckTimestamp())),
				e.recordLastViewedTime();
		}
		ez(ed), ez(e_);
		let a = !1;
		return (
			ed !== t && ((a = eq(ed) || a), (a = eq(e_) || a)),
			(ed === t || ((null == r ? void 0 : r.type) != null && er.TPd.GUILD_THREADS_ONLY.has(r.type))) &&
				(a = ek(t) || a),
			ed === t && (a = ek(n) || a),
			(ed = t),
			(e_ = n),
	...
	ENABLE_AUTOMATIC_ACK: function (e) {
		...
		return (
			em[t] !== n &&
			(l()(void 0 === em[t], 'handleEnableAutomaticAck: channel already visible in another window'), (em[t] = n), ek(t))
		);
	},
	...
	RELATIONSHIP_ADD: function (e) {
		...
		if (
			...
			(e.relationship.type !== er.OGo.PENDING_INCOMING && e.relationship.type !== er.OGo.FRIEND)
		)
			return !1;
		let n = eb.get(t.id, eo.W.NOTIFICATION_CENTER),
		...
		a < i &&
			((n.lastMessageId = H.default.fromTimestamp(i)),
			(0, D.Z.active) ? e$(t.id, eo.W.NOTIFICATION_CENTER, void 0, !1) : r ? n.mentionCount-- : n.mentionCount++);
	},
