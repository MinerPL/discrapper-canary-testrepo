...
class c {
	...
	addNode(e) {
		...
		return (
			...
			s()(null == this.nodes[e.id], '[GUILDS TREE] Tried adding a node that already exists ('.concat(e.id, ')')),
			(this.nodes[e.id] = e),
			this.version++,
			this.moveInto(e, t, n)
		);
	...
	replaceNode(e, t) {
		s()(e !== this.root, '[GUILDS TREE] Tried replacing the root node of the tree'),
			...
			s()('root' !== t.type, '[GUILDS TREE] Tried adding another root node into the tree');
